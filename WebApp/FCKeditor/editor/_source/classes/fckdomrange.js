...
FCKDomRange.prototype =
{
	...
	CreateBookmark : function()
	{
		...
		var oBookmark = 
		{
			StartId	: 'fck_dom_range_start_' + (GetServerDate()).valueOf() + '_' + Math.floor(Math.random()*1000),
			EndId	: 'fck_dom_range_end_' + (GetServerDate()).valueOf() + '_' + Math.floor(Math.random()*1000)
		} ;
