...
FCKConfig.ToolbarSets["SummaryReport"] = [
	['Preview'],
...
FCKConfig.ToolbarSets["Attune"] = [
['Print', 'Cut', 'Copy', 'Paste', 'Bold', 'Italic', 'Underline',
    'StrikeThrough', '-', 'Subscript', 'Superscript'],
    ['JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyFull'],
    ['FontName', 'FontSize']
//	['Cut', 'Copy', 'Paste', 'PasteText', 'PasteWord', '-', 'Print'],	['Undo', 'Redo', '-', 'Find', 'Replace', '-', 'SelectAll', 'RemoveFormat'],
//	'/',
//	['Bold', 'Italic', 'Underline', 'StrikeThrough', '-', 'Subscript', 'Superscript'],
//	['OrderedList', 'UnorderedList', '-', 'Outdent', 'Indent'],
//	['JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyFull'],
...
FCKConfig.ToolbarSets["Interpretation"] = [
	['Bold', 'Italic', 'Underline', 'StrikeThrough', '-', 'Subscript', 'Superscript']
];

FCKConfig.ToolbarSets["Biospy"] = [
[]
//	['Cut', 'Copy', 'Paste', 'PasteText', 'PasteWord', '-', 'Print'],	['Undo', 'Redo', '-', 'Find', 'Replace', '-', 'SelectAll', 'RemoveFormat'],
//	'/',
//	['Bold', 'Italic', 'Underline', 'StrikeThrough', '-', 'Subscript', 'Superscript'],
