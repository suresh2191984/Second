...
public partial class Physician_DiadetesEMROPCaseSheet :BasePage
{
    ...
    protected void btnOk_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (InvDrugData == "Y")
            {
                ...
                if (ptaskID > 0 && ptaskStatus == "PENDING" || ptaskStatus =="")
                    if (drugCount > 0)
                    {
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Response.Redirect("../Physician/DisplayPatientComplaint.aspx?vid=" + visitID + "&pid=" + patientID + "&tid=" + taskID + "&pvid=" + previousVID + "&id=" + complaintID , true);
            }
            else if (lstPatientComplaintDetail.Count == 1)
            {
                ...
                {
                    Response.Redirect(@"../Physician/PatientDiagnose.aspx?vid=" + visitID + "&pid=" + patientID + "&id=" + lstPatientComplaintDetail[0].ComplaintID + "&pvid=" + visitID + "&tid=" + taskID , true);
                }
                ...
                {
                    Response.Redirect(@"../Physician/diabetesEMR.aspx?vid=" + visitID + "&pid=" + patientID + "&id=" + lstPatientComplaintDetail[0].ComplaintID + "&pvid=" + visitID + "&tid=" + taskID , true);
                }
            }
