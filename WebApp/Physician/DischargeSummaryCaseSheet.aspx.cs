...
public partial class Physician_DischargeSummaryCaseSheet : BasePage
{

    public Physician_DischargeSummaryCaseSheet()
        : base("Physician\\DischargeSummaryCaseSheet.aspx")
    {
    }
    ...
    private void GetPatientHistory()
    {
        ...
        catch (Exception ex)
        {
            ErrorDisplay1.ShowError = true;
            ErrorDisplay1.Status = "There was a problem in page load. Please contact system administrator";
            CLogger.LogError("Error on Loading DischargeSummarySheet in DischargeSummaryCaseSheet.aspx", ex);
        }
    }         
                ...
                if (lstDischargeSummary.Count > 0)
                {
                    ...
                    if (NeedDateOfDischarge.Count() == 0)
                    {
                        ...
                        else
                        {
                            ...
                            lblDOD.Text = lstDischargeSummary[0].DateOfDischarge.ToString("dd/MM/yyyy hh:mm tt");
                        }
                    }
