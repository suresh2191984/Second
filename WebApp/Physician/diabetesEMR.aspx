<%@ Page Language="C#" AutoEventWireup="true" CodeFile="diabetesEMR.aspx.cs" Inherits="Physician_unfoundDiagnosisnew" meta:resourcekey="PageResource1" %>
...
<%@ Register Src="../CommonControls/ComplaintICDCode.ascx" TagName="ComplaintICDCode"
    TagPrefix="uc5" %>
    <%@ Register Src="../CommonControls/DiagnoseWithICD.ascx" TagName="Patiendiagose" TagPrefix="uc12" %>
                    ...
                    <div class="contentdata" id="dMain">
                        ...
                        <table width ="100%">
                         <tr>
                                ...
                                <td align ="right">
                                     <asp:Button ID ="btnviewEdit" Text ="View/Edit WorkUp Notes" runat ="server" CssClass="btn"   
                                     onmouseover="this.className='btn btnhov'" onmouseout="this.className='btn'" 
                                         OnClick ="btnviewEdit_Click" meta:resourcekey="btnviewEditResource1"/> 
                                </tr>
                                </table>
                        <asp:Panel ID="pnlVitals" runat="server" CssClass="defaultfontcolor" 
                                    ...
                                    <td class="colorforcontent" width="35%" height="23" align="left">
                                        <div style="display: none;" id="ACX2plusMVitals">
                                            ...
                                            <span class="dataheader1txt" style="cursor: pointer" onclick="showResponses('ACX2plusMVitals','ACX2minusMVitals','ACX2responsesMVitals',1);">
                                                <asp:Label ID="Rs_CollectVitals" Text="Collect Vitals" runat="server" 
                                                meta:resourcekey="Rs_CollectVitalsResource1" ></asp:Label></span>
                                        </div>
                                        <div style="display: block; height: 18px;" id="ACX2minusMVitals">
                                            ...
                                            <span class="dataheader1txt" style="cursor: pointer" onclick="showResponses('ACX2plusMVitals','ACX2minusMVitals','ACX2responsesMVitals',0);">
                                                <asp:Label ID="Rs_CollectVitals1" Text="Collect Vitals" runat="server" 
                                                meta:resourcekey="Rs_CollectVitals1Resource1" ></asp:Label></span>
                                        </div>
                                    </td>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                ...
                                                <tr id="ACX2responses1" style="display: block;">
                                                    <td colspan="2" width="100%">
                                                        <asp:Button ID="btnhidden" runat="server" CssClass="btn" Text="btnhidden" Visible="False" 
                             ...
                             <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td class="colorforcontent" width="50%" height="23" align="left" valign="top">
                                                        <div style="display: none" id="ACX2plusOne2" >
                                                            &nbsp;<img src="../Images/showBids.gif" alt="Show" width="15" height="15" align="top"
                                                            ...
                                                            <span class="dataheader1txt" style="cursor: pointer" onclick="showResponses('ACX2plusOne1','ACX2minusOne1','ACX2responsesOne1',1);">
                                                                &nbsp;<asp:Label ID="lblcomments" Text="Doctor Comments" runat="server" 
                                                                meta:resourcekey="lblcommentsResource1" ></asp:Label></span>
                                                        </div>
                                                        <div style="display: block" id="ACX2minusOne2" >
                                                            &nbsp;<img src="../Images/hideBids.gif" alt="hide" width="15" height="15" align="top"
                                                            ...
                                                            <span class="dataheader1txt" style="cursor: pointer" onclick="showResponses('ACX2plusOne1','ACX2minusOne1','ACX2responsesOne1',0);">
                                                                &nbsp;<asp:Label ID="lblcomments1" Text="Doctor Comments" runat="server" 
                                                                meta:resourcekey="lblcomments1Resource1" ></asp:Label></span>
                                                        </div>
                                                    </td>
                                                </tr>
                                               <tr id="Tr1" style="display: block" class="tablerow">
                                                    <td colspan="2" width="75%">
                                                        <FCKeditorV2:FCKeditor ID="fckPhysicianComments" runat="server" Width="200%" Height="200px">
                                ...
                                <tr class="tablerow" id="ACX2responsesM" style="display: block">
                                    <td colspan="2">
                                        <div class="dataheader2">
                                            ...
                                            <br />
                                            <asp:CheckBox ID="chkAdditionalPayments" runat="server" Visible="False" Text="Check here to capture additional charges"
                                            ...
                                            <asp:DropDownList ID="ddlNos" runat="server" CssClass="ddl" meta:resourcekey="ddlNosResource1">
                                                <asp:ListItem Value="0" meta:resourcekey="ListItemResource0">0</asp:ListItem>
                                                ...
                                                <table width="100%">
                                                    ...
                                                    <tr>
                                                        <td style="width: 25%">
                                                            ...
                                                            <asp:Button ID="btnSaveContinue" runat="server" CssClass="btn" 
                                                                OnClientClick="return chkNextReview();" OnClick="btnSaveContinue_Click"
                                                                onmouseout="this.className='btn'" 
                                                                onmouseover="this.className='btn btnhov'" Text="Save &amp; Continue"
                                                                meta:resourcekey="btnSaveContinueResource1" Visible ="False" />
