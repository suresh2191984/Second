...
public partial class Physician_CaseSheetPrintView : BasePage
{
   // string strCS = "";
   // long patientID = -1;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
        //    //TODO: Get patientID from QueryString and patientVisitID from Session
...
//        strCS = @"<B><I>{0}</I></B>, {1} yrs old {2} presented with {3} <br> was found to have {4}.
//                  <br><br> Investigations revealed the following: <br><br> {5} <br>
...
//            lblCS.Text = string.Format(strCS, str0, str1, str2, str3, str4, str5, str0, str6);
