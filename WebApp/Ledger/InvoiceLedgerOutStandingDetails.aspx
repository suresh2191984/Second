<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvoiceLedgerOutStandingDetails.aspx.cs"
    Inherits="Ledger_InvoiceLedgerOutStandingDetails" EnableEventValidation="false" %>
                                            ...
                                            <div class="w-100p">
                                                <table class="w-80p a-center ">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <asp:Label ID="lblClientName" Font-Bold="true" Font-Size="Large" Text="ClientName :"
                            ...
                            <asp:UpdatePanel ID="updatePanel1" runat="server">
                                <ContentTemplate>
                                    ...
                                    <table class="w-80p display" cellpadding="0px">
                                        <tr>
                                            <td align="center">
                                                <asp:Button ID="btnhome" CssClass="btn" runat="server" Text="Back" OnClientClick="javascript:return FunHome();" />
                                            </td>
                                        </tr>
                                    </table>
                                </ContentTemplate>
...
<script>
    ...
    function GetData() {
        try {
            document.getElementById('hdnclientType').value = '';
            var ClientID = GetQueryStringParams('CID');
            var ClientCode = '';
            ClientCode = GetQueryStringParams('CODE');
            var MID = '';
            MID = GetQueryStringParams('MID');
            document.getElementById('hdnclientType').value = MID;
            ...
            $.ajax({
                type: "POST",
                url: "../WebService.asmx/GetInvoiceOutstandingDetails",
                contentType: "application/json;charset=utf-8",
                data: "{'ClientID':" + ClientID + ",'MonthID':'" + MID + "','OrgID':" + OrgID + "}",
                dataType: "json",
                async: false,
        ...
        try {
            ...
            if (result != "[]") {
                oTable = $('#tblOutstanding').dataTable({
                    ...
                    "aoColumns": [
               { "mData": "InvoiceNumber", sClass: "w-15p a-left", "mRender": function(data, type, full) 
               {
                   return '<a href="../Ledger/InvoiceLedgerOutStandingBills.aspx?CID=' + full.ClientId + '&INVOICEID=' + full.InvoiceId + '&CODE=' + document.getElementById('lblClientName1').innerHTML + '&MID=' + document.getElementById('hdnclientType').value + '" onclick="javascript:return IsBilldata(' + full.InvoiceId + ');">' + data + '</a>';
               }
               },
               { "mData": "BillNumber", sClass: "w-10p a-center" },
               { "mData": "FromDate", sClass: "w-8p a-center" },
               { "mData": "ToDate", sClass: "w-8p a-center" },
               { "mData": "CreditLimit", sClass: "w-10p a-right" },
               { "mData": "TotalAmt", sClass: "w-10p a-right" },
               { "mData": "NetValue", sClass: "w-10p a-right" },
               { "mData": "ActualAmount", sClass: "w-10p a-right" }
