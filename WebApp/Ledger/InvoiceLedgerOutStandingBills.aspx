<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvoiceLedgerOutStandingBills.aspx.cs"
    Inherits="Ledger_InvoiceLedgerOutStandingBills" EnableEventValidation="false" %>
...
<%@ Register Src="~/CommonControls/Attune_Footer.ascx" TagName="Attunefooter"
    TagPrefix="Attune" %>
<%--<%@ Register Src="../CommonControls_NewUI/HospitalBillSearch.ascx" TagName="BillSearch" TagPrefix="uc2" %>--%>
...
<head id="Head1" runat="server">
    <title>Invoice OutStanding Bills</title>
    <style type="text/css">
        .message-text
        {
            display: block;
                                ...
                                <table class="w-100p searchPanel">
                                    <tr class="panelHeader">
                                        <td class="colorforcontent w-100p" height="23" align="center">
                                            <asp:Label ID="Rs_FilterResult2" runat="server" Text="Invoice OutStanding Bills" meta:resourcekey="Rs_FilterResult2Resource1"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
...
<script type="text/javascript">
                    ...
                    { "mDataProp": "Amount", sClass: "w-1p a-right" },
                       ...
                       {"mData": "Status", sClass: "w-1p a-center", "mRender": function(data, type, full) {
                           if (full.Status == 'Approved') {
                               ...
                               return '<span id="spnMethodName1' + full.ClientId + '" style="font-weight: bold;color: Black;">' + data + '</span>'
                           }
    ...
    function FunHome() {
        ...
        window.location.replace("../Ledger/InvoiceLedgerOutStandingDetails.aspx?CID=" + id + "&CODE=" + code + "&MID=" + document.getElementById('hdnclientType').value + "");
