<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreditDebitApproval.aspx.cs"
    Inherits="Ledger_CreditDebitApproval" EnableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <title>Client Credit Debit Approval</title>
...
<body oncontextmenu="return false;">
    ...
    <div class="contentdata">
        ...
        <cc1:ModalPopupExtender ID="modalpopup" runat="server" CancelControlID="btnCancel"
            OkControlID="btnOkay" TargetControlID="btnshow" PopupControlID="Panel2" PopupDragHandleControlID="PopupHeader"
            Drag="true" BackgroundCssClass="ModalPopupBG">
        </cc1:ModalPopupExtender>
        <asp:UpdatePanel ID="updpopop" runat="server">
            <ContentTemplate>
                <asp:Panel ID="Panel2" Style="display: none" Width="800px" runat="server">
