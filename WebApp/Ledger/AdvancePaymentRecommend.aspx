<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdvancePaymentRecommend.aspx.cs"
    Inherits="Ledger_AdvancePaymentRecommend" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
    <title>Advance Recommend</title>
    <%@ register src="../CommonControls/Attune_OrgHeader.ascx" tagname="Attuneheader"
        tagprefix="Attune" %>
    <%@ register src="~/CommonControls/Attune_Footer.ascx" tagname="Attunefooter"
        tagprefix="Attune" %>
    <%--<%@ Register Src="../CommonControls/HospitalBillSearch.ascx" TagName="BillSearch" TagPrefix="uc2" %>--%>
                        ...
                        <table class="w-100p searchPanel">
                            <tr class="panelHeader">
                                <td class="colorforcontent w-100p bold" height="23" align="center">
                                    <asp:Label ID="Rs_FilterResult2" runat="server" Text="Advance Recommend" meta:resourcekey="Rs_FilterResult2Resource1"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
