<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreditDebitRecommend.aspx.cs"
    Inherits="Ledger_CreditDebitRecommend" EnableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <title>Client Credit Debit Recommend</title>
...
<body oncontextmenu="return false;">
    ...
    <div class="contentdata">
                                    ...
                                    <tr align="center">
                                        <td>
                                            <asp:Panel runat="server">
                                                ...
                                                <img align="middle" alt="" src="../Images/starbutton.png" />
                                                <asp:DropDownList ID="ddlType" runat="server" CssClass="small" onchange="Javascript:return GetData();">
        ...
        <table cellpadding="0" border="0" cellspacing="0" class="w-100p">
            <tr>
                <td class="a-center" id="trbuttons" style="display: none;" runat="server">
                    ...
                    &nbsp;
                    <asp:Button ID="btnReset" runat="server" OnClientClick="javascript:return Reloadpage();"
                        TabIndex="4" Text="Reset" CssClass="btn" meta:resourcekey="btnChangeResource2" />
                </td>
            </tr>
        </table>
        <asp:Button ID="btnshow" CssClass="hide" runat="server" Text="" />
        <cc1:ModalPopupExtender ID="modalpopup" CancelControlID="btnCancel" runat="server"
                ...
                <asp:Panel ID="Panel1" Style="display: none" Width="800px" runat="server">
                    ...
                    <table class="gridView w-100p">
                        <tr class="gridHeader">
                            ...
                            <td align="center">
                                <asp:Label ID="lblhdrNarration1" Text="Narration" runat="server"></asp:Label>
                            </td>
                            <td align="center">
...
<script type="text/javascript">
    ...
    function GetData() {
        try {
            ...
            Type = TypeId.options[TypeId.selectedIndex].value;
            ...
            $.ajax({
                type: "POST",
                url: "../WebService.asmx/GetTSPCreditDebitRecommend",
                contentType: "application/json;charset=utf-8",
                data: "{'OrgID':" + OrgID + ",'Status':'" + Status + "','Type':'" + Type + "','ClientCode':'" + ClientCode + "'}",
                dataType: "json",
                async: false,
            ...
            if (result != "[]") {
                oTable = $('#example').dataTable({
                    ...
                    //{ "mDataProp": "ClientCode", "bVisible": false },
                          ...
                          { "mDataProp": "Narration", sClass: "a-left" },
    ...
    function AjaxGetSuccessSelectedClientDetails(result) {
        try {
            ...
            if (result.d != "") {
                ...
                document.getElementById('lblrstTSP').innerHTML = Clientdata[0];
                document.getElementById('lblrstClientName1').innerHTML = Clientdata[0];
    ...
    function RecommendData(Status) {
        ...
        if (document.getElementById('hdnCDId').value != "") {
            if (!jQuery("#chkApprove1").is(":checked")) {
                alert("Please Select Credit/Debit Note....!");
                return false;
            }
            else {
                Selected = "Y";
        ...
        if (Selected == "Y") {
            var ClientRecommend = JSON.stringify(lstClientCredit);
            $.ajax({
                type: "POST",
                url: "../WebService.asmx/SaveCreditDebitRecommentation",
                contentType: "application/json;charset=utf-8",
                data: "{lstClientCredit:'" + ClientRecommend + "'}",
                dataType: "json",
                async: false,
                success: function() {
                    alert('Credit/Debit ' + Status + ' Successfully!');
                    document.getElementById('txtClientName').value = "";
                    document.getElementById('hdnClientID').value = "";
                    document.getElementById('hdnCDId').value = "";
                    $find('modalpopup').hide();
            ...
            alert("Please Select at least one Credit/Debit Note....!");
            return false;
        }
    }
</script>
