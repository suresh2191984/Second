<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReceiptRecommend.aspx.cs"
    Inherits="Ledger_ReceiptRecommend" EnableEventValidation="false" %>
                        ...
                        <table class="w-100p searchPanel">
                            <tr class="panelHeader">
                                <td class="colorforcontent w-100p bold" height="23" align="center">
                                    <asp:Label ID="Rs_FilterResult2" runat="server" Text="Receipt Recommend" meta:resourcekey="Rs_FilterResult2Resource1"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
        ...
        <table cellpadding="0" border="0" cellspacing="0" class="w-100p">
            <tr>
                <td class="a-center" id="trbuttons" runat="server">
                    <asp:Button ID="btnSubmit" runat="server" TabIndex="4" Text="Recommend" CssClass="btn"
                        OnClientClick="javascript:return RecommendData('Recommended');" meta:resourcekey="btnChangeResource2" />
                    &nbsp;
                ...
                <asp:Panel ID="Panel1" Style="display: none" Width="800px" runat="server">
                    <table class="gridView w-100p">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <asp:Label ID="lblhdrPaymentMode" Text="PaymentMode" runat="server"></asp:Label>
                            </td>
                            <td>
                                <asp:Label ID="lblrstPaymentMode" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                    ...
                    <table class="gridView w-100p">
                        <tr class="gridHeader">
                            ...
                            <td align="center">
                                <asp:Label ID="lblhdrPaymentMode1" Text="PaymentMode" runat="server"></asp:Label>
                            </td>
                            <td align="center">
                            ...
                            <td align="center">
                                <asp:Label ID="lblAchck" Text="Recommend" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                            ...
                            <td>
                                <asp:Label ID="lblrstPaymentMode1" Text="" runat="server"></asp:Label>
                            </td>
                            <td>
                        ...
                        <table class="gridView w-100p">
                            <tr class="gridHeader">
                                <td align="center">
                                    ...
                                    <asp:Button ID="btnadd" class="btn" Text="Recommend" OnClientClick="javascript:return RecommendData('Recommended');"
                                        runat="server" />
                                    <asp:Button ID="btnrej" class="btn" Text="Reject" OnClientClick="javascript:return RecommendData('Rejected');"
                                        runat="server" />
                                    <asp:Button ID="btnCancel" class="btn" Text="Cancel" OnClientClick="javascript:return ClearPopupBoxvalues();"
                                        runat="server" />
                                </td>
                            </tr>
                        </table>
...
<script type="text/javascript">
    ...
    function AjaxGetFieldDataSucceeded(result) {
        try {
            ...
            alert('Exception while binding Receipt Pending Deatails');
        }
        return false;
    }
    function selectClient(data) {
        ...
        try {
            ...
            alert('Exception while Loading Selected Client Receipt Note details for Recommentation');
        }
        return false;
    }
    function AjaxGetSuccessSelectedClientDetails(result) {
        try {
            ...
            if (result.d != "") {
                ...
                document.getElementById('lblrstPaymentMode').innerHTML = result.d[0].State;
                document.getElementById('lblrstPaymentMode1').innerHTML = result.d[0].State;
                document.getElementById('hdnCDId').value = result.d[0].Id;
                document.getElementById('hdnPaymentMode').value = result.d[0].State;
            ...
            alert('Exception while Loading Selected client Receipt Note details in Receipt Recommentation');
        }
    }
    function Reloadpage() {
    ...
    function ClearPopupBoxvalues() {
        ...
        document.getElementById('lblrstPaymentMode').innerHTML = '';
        document.getElementById('lblrstPaymentMode1').innerHTML = '';
        document.getElementById('hdnPaymentMode').value = '';
        return true;
    }
                ...
                if (jQuery("#chkApprove1").is(":checked")) {
                    ...
                    lstClientReceipt.push
                                ({
                                    ...
                                    Type: Type,
                                    Mode: document.getElementById('hdnPaymentMode').value
                                });
                }
            }
        }
