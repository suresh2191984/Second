<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DaywiseCollectionRevenueReport.aspx.cs"
    Inherits="ReportsLims_DaywiseCollectionRevenueReport" meta:resourcekey="PageResource1" %>
...
<head id="Head1" runat="server">
    <title>Daywise Collection Revenue Report</title>
                    ...
                    <tr align="center">
                        <td align="left">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtClientName" runat="server" autocomplete="off" Width="130px" CssClass="AutoCompletesearchBox"
                                                TabIndex="3" meta:resourcekey="txtClientNameResource1"></asp:TextBox>
                            ...
                            <table cellpadding="0" class="defaultfontcolor" width="100%" style="color: Black;
                                ...
                                <tr>
                                    <td>
                                        <div id="divOPDWCR" runat="server" style="display: block; width:1350px; height:500px; overflow:auto;">
                                            <div id="prnReport" style="font-family: Arial; text-decoration: none; font-size: 10px;">
                                                <asp:GridView ID="grdResult" runat="server" AutoGenerateColumns="False" Width="100%"
                                                    CellPadding="1" CssClass="mytable1" EmptyDataText="Collection Details Not Available"
                                                    Font-Names="verdana" OnRowDataBound="grdResult_RowDataBound" meta:resourcekey="grdResultResource1">
                                                    <HeaderStyle CssClass="dataheader1" />
                                                    <RowStyle HorizontalAlign="Left" Font-Size="10px" />
                                                    <Columns>
                                                        <asp:BoundField DataField="Data" HeaderText="Data" meta:resourcekey="BoundFieldResource1" />
                                                        <asp:BoundField DataField="CenterName" HeaderText="Center Name" meta:resourcekey="BoundFieldResource2" />
                                                        <asp:BoundField DataField="Transactiondate" HeaderText="Transaction date" meta:resourcekey="BoundFieldResource3" />
                                                        <asp:BoundField DataField="VisitDate" HeaderText="Visit Date" meta:resourcekey="BoundFieldResource5" />
                                                        <asp:BoundField DataField="VisitNumber" HeaderText="Visit Number" meta:resourcekey="BoundFieldResource5" />
                                                        <asp:BoundField DataField="BillNumber" HeaderText="Bill Number" meta:resourcekey="BoundFieldResource5" />
                                                        <asp:BoundField DataField="ExtPatientID" HeaderText="Ext PatientID" meta:resourcekey="BoundFieldResource5" />
                                                        <asp:BoundField DataField="PatientName" HeaderText="Patient Name" meta:resourcekey="BoundFieldResource5" />
                                                        <asp:BoundField DataField="GrossAmount" DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Right"
                                                            HeaderText="Gross Amount" meta:resourcekey="BoundFieldResource8">
                                                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="Discount" DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Right"
                                                            HeaderText="Discount" meta:resourcekey="BoundFieldResource8">
                                                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="NetAmount" DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Right"
                                                            HeaderText="Net Amount" meta:resourcekey="BoundFieldResource8">
                                                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:BoundField DataField="Cash" DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Right"
                                                            HeaderText="Cash" meta:resourcekey="BoundFieldResource8">
                                                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="Cheque" DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Right"
                                                            HeaderText="Cheque" meta:resourcekey="BoundFieldResource8">
                                                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="Card" DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Right"
                                                            HeaderText="Card" meta:resourcekey="BoundFieldResource8">
                                                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="Prepaid" DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Right"
                                                            HeaderText="Prepaid" meta:resourcekey="BoundFieldResource8">
                                                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="Online" DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Right"
                                                            HeaderText="Online" meta:resourcekey="BoundFieldResource8">
                                                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="DemandDraft" DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Right"
                                                            HeaderText="DemandDraft" meta:resourcekey="BoundFieldResource8">
                                                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="AdjustmentAmount" DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Right"
                                                            HeaderText="AdjustmentAmount" meta:resourcekey="BoundFieldResource8">
                                                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="Collection" DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Right"
                                                            HeaderText="Collection" meta:resourcekey="BoundFieldResource8">
                                                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="RefDocName" HeaderText="Ref. DocName" meta:resourcekey="BoundFieldResource5" />
                                                        <asp:BoundField  HeaderText="Specialization" meta:resourcekey="BoundFieldResource5" />
                                                        <asp:BoundField  HeaderText="SourceName" meta:resourcekey="BoundFieldResource5" />
                                                        <asp:BoundField  HeaderText="SalespersonName" meta:resourcekey="BoundFieldResource5" />
                                                        <asp:BoundField DataField="DisApprovedBy" HeaderText="Discount Approved By" meta:resourcekey="BoundFieldResource5" />
                                                        <asp:BoundField DataField="DiscountComment" HeaderText="Discount Comment" meta:resourcekey="BoundFieldResource5" />
                                                        <asp:BoundField DataField="TransactionType" HeaderText="Transaction Type" meta:resourcekey="BoundFieldResource5" />
                                                        <asp:BoundField DataField="DueType" HeaderText="Due Type" meta:resourcekey="BoundFieldResource5" />
                                                        <asp:BoundField DataField="Specialization" HeaderText="Due ApprovedBy" meta:resourcekey="BoundFieldResource5" />
                                                        <asp:BoundField DataField="SourceName" HeaderText="Due Comment" meta:resourcekey="BoundFieldResource5" />
                                                        <asp:BoundField DataField="SalespersonName" HeaderText="Collected User" meta:resourcekey="BoundFieldResource5" />
                                                    </Columns>
                                                </asp:GridView>
                                            </div>
                                        </div>
