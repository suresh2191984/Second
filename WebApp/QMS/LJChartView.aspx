...
<head id="Head1" runat="server">
    ...
    <title>Internal Quality Control - LJ Chart</title>
    ...
    <div class="wrapper">
        ...
        <asp:UpdatePanel ID="test" runat="server" UpdateMode="Always">
          ...
          <div id="divDDL">
              <div class="row">
                    <div class="col-md-12">
                                <h4 class="strong">Internal Quality Control - LJ Chart</h4>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-2 col-md-2">
                     ...
                     <div class="col-xs-6 col-sm-2 col-md-2">
                            <div class="form-group">
                                  ...
                                  <select id="ddlLevel" change="ddlLotNo" class="form-control">
                                   <option value="-1">--Select---</option>
            ...
            <div id="ShowDate" class="pull-right  text-bold" style="padding-right:20px">
              ...
              <div id="AnalyzerFilter" style="padding-left: 15px;">
                ...
                <div id="OuterGraph">
                <div class="GraphTitle"> Levey-Jennings chart</div>
                    <div id="graph" >
                    
                    </div>
                     <div style="padding-top: 85px;padding-left: 70px;"><b style="color:Black">Legends:</b>
                    <div>
                   ...
                   <input type="button" id="GeneratePDF" class="btn-info pull-right " value="Download PDF"  />
                   ...
                   <input type="button" id="btnUpdate" class="btn-info pull-right " value="Update QC Status"  style ="display :none ;"/>
                   </br>
               <div  class="row"> 
