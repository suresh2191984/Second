<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QCResult.aspx.cs" Inherits="QMS_QCResult" %>
...
<head id="Head1" runat="server">
   ...
   <%-- <link rel="stylesheet" type="text/css" href="//cdn.datatables.net/1.10.12/css/jquery.dataTables.css">--%>
    ...
    <script src="bootstrap/js/bootstrap-select.js" type="text/javascript"></script>
       <script src="Script/QMSQCResult.js" type="text/javascript"></script>
              ...
              <div class="row">
                ...
                <div class="col-xs-6 col-sm-2 col-md-2">
                     <div class="form-group">
                        ...
                        <div class="input-group date">
                              <asp:TextBox ID="txtFromDate" runat="server" ReadOnly="true" CssClass="form-control pull-right"></asp:TextBox>
                 ...
                 <div class="col-xs-6 col-sm-2 col-md-2">
                     <div class="form-group">
                        ...
                        <div class="input-group date">
                              <asp:TextBox ID="txtToDate" runat="server" ReadOnly="true" CssClass="form-control pull-right"></asp:TextBox>
                              <div class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                              </div>
                            </div>
                ...
                <div class="row">
                    <div class="form-group text-center">
                        ...
                        <input type ="button" id="btnSearch"  class="btn btn-success" value="Search" onclick="GetQCResultDetails()"/>
                    </div>
                </div>
