<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DepositRefund.aspx.cs" Inherits="Billing_DepositRefund" meta:resourcekey="PageResource1" %>
...
<head id="Head1" runat="server">
   ...
   <link href="../StyleSheets/Common.css" rel="stylesheet" type="text/css" />
    ...
    function PopUpPage() {
        ...
        var dVouchNo = document.getElementById('<%= hdnReceiptNo.ClientID %>').value;
        ...
        var OID = document.getElementById('<%= hdnOutFlowID.ClientID %>').value;
        var BilledBy = document.getElementById('<%= BilledBy.ClientID %>').value;
        ...
        if((dAmount !='')&&(Number(dAmount) > 0))
        {
            ...
            //var strURL = "../admin/PrintVoucherPage.aspx?Amount=" + dAmount + "&dDate=" + dDate + "&VONO=" + dVouchNo + "&RNAME=" + pName + "&BBy=" + BilledBy + "&OID=" + OID
            var strURL = "../admin/PrintVoucherPage.aspx?VONO=" + dVouchNo + "&OID=" + OID
            //var strURL = "../Reception/PrintDepositReceipt.aspx?Amount=" + dAmount + "&dDate=" + dDate+ "&rcptno=" + dReceiptNo + "&PNAME="+pName+"&pdid=" + dBdetNo +"&pDet=" + sptype +"" + "&FromPage=RD";
    ...
    function Validate() {
//        alert(document.getElementById('txtPayment').value);
//        alert(document.getElementById('lblRefundAmount').innerText);

        if ( Number(document.getElementById('txtPayment').value) > Number(document.getElementById('lblRefundAmount').innerText)) {
                ...
                <td width="85%" valign="top" class="tdspace">
                    ...
                    <div class="contentdata">
                        <table border="0" width="100%" cellpadding="4" cellspacing="1" class="defaultfontcolor">
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                               <asp:Label ID="Rs_PatientNumber1" Text="Patient Number:" runat="server" 
                                                    meta:resourcekey="Rs_PatientNumber1Resource1"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr id="Preauth" runat="server" style="display: none;">
                                            <td>
                                                <asp:Label ID="lblPreAuthorizationAmount" runat="server" Text="Pre Authorization Amount :" 
                                                    Font-Bold="True" meta:resourcekey="lblPreAuthorizationAmountResource1" ></asp:Label>
                                            </td>
                                            <td>
                                    ...
                                    <div id="divAdvance">
                                                ...
                                                <tr>
                                                    <td class="colorforcontent"  colspan="2" height="23" align="left">
                                                        <div id="ACX2plusAdvPmt" style="display: block; width: 100%">
                                                            ...
                                                            <asp:Label  ID="Rs_PreviousDepositPaymentsAmountDeposited" 
                                                                Text="Previous Deposit Payments | Amount Deposited:" runat="server" 
                                                                meta:resourcekey="Rs_PreviousDepositPaymentsAmountDepositedResource1"></asp:Label>
                                                            &nbsp;<asp:Label 
                                                                ID="lblTotalDepositAmount" Font-Bold="True" runat="server" 
                                                                meta:resourcekey="lblTotalDepositAmountResource1"></asp:Label>
                                                                &nbsp;|<asp:Label ID="Rs_DepositAmountUsed" Text="Deposit Amount Used:" 
                                                                runat="server" meta:resourcekey="Rs_DepositAmountUsedResource1"></asp:Label>
                                                            &nbsp;<asp:Label 
                                                                ID="lblTotalDepositUsed" Font-Bold="True"  runat="server" 
                                                                meta:resourcekey="lblTotalDepositUsedResource1"></asp:Label>
                                                                &nbsp; | <asp:Label ID="Rs_Info" Text="Available Deposit Balance:" 
                                                                runat="server" meta:resourcekey="Rs_InfoResource1"></asp:Label>&nbsp;<asp:Label 
                                                                ID="lblTotalDepositBalance" Font-Bold="True"  runat="server" 
                                                                meta:resourcekey="lblTotalDepositBalanceResource1"></asp:Label>
                                                                &nbsp; | <asp:Label ID="Label2" Font-Bold="True"  runat="server" 
                                                                Text="Refundable Amount is :" meta:resourcekey="Label2Resource1"></asp:Label>
                                                            &nbsp;<asp:Label ForeColor="Gold" ID="lblRefundAmount" Font-Bold="True"  
                                                                runat="server" meta:resourcekey="lblRefundAmountResource1"></asp:Label>
                                                                &nbsp; | <asp:Label Visible="False" ID="lblRefundedAmt" runat="server" 
                                                                Text="Refund Amount:" meta:resourcekey="lblRefundedAmtResource1"></asp:Label>
                                                                &nbsp;<asp:Label Visible="False" ID="lblRefundAmt" Font-Bold="True"  
                                                                runat="server" meta:resourcekey="lblRefundAmtResource1"></asp:Label>
                                                            </span>
                                                        </div>
                                                    ...
                                                    <td colspan="2">
                                                        <div class="filterdatahe">
                                                            <asp:GridView ID="gvCollectDepositDetails" runat="server" AutoGenerateColumns="False"
                                                                ...
                                                                OnRowDataBound="gvCollectDepositDetails_RowDataBound" 
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="CreatedAt" 
                                                                        DataFormatString="{0:dd/MM/yyyy hh:mm tt}" HeaderText="Deposited Date" 
                                                            ...
                                                            <div align="right" style="width: 385px; font-weight: bold;" >
                                                               <asp:Label ID="Rs_TotalDepositedAmount" Text="Total Deposited Amount:" 
                                                                    runat="server" meta:resourcekey="Rs_TotalDepositedAmountResource1"></asp:Label>
                                                                <asp:Label ID="lblTotalDepositAmountTemp" Font-Bold="True" runat="server" 
                                                                    meta:resourcekey="lblTotalDepositAmountTempResource1"></asp:Label>
                                                            </div>
                                                            <br />
                                                            <asp:Button ID="btnPrint" runat="server" Text="Print Receipt" CssClass="btn" 
                                       ...
                                       <asp:Label ID="Rs_TotalAmount" Text="Total Amount :" runat="server" 
                                        ...
                                        <asp:TextBox ID="txtPayment" Width="70px" Style="text-align: right;" runat="server"
                                            ReadOnly="True" CssClass="Txtboxsmall" meta:resourcekey="txtPaymentResource1">0</asp:TextBox>
                            ...
                            <tr>
                                <td align="center">
                                    &nbsp;<asp:Button ID="btnSave" OnClientClick = "return Validate();" 
                                        runat="server" Text="Finish" CssClass="btn" 
                                        onmouseout="this.className='btn'" OnClick="btnSave_Click" Width="67px" 
                        ...
                        <input type="hidden" runat="server" id="hdnOutFlowID" />
                        <input type="hidden" runat="server" id="BilledBy" />
                        <br />
                    </div>
                </td>
            </tr>
