...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LabQuickBilling.aspx.cs"
    EnableEventValidation="false" Inherits="Billing_LabQuickBilling" meta:resourcekey="PageResource1" %>
...
<%@ Register Src="../CommonControls/Captureimage.ascx" TagName="Captureimage" TagPrefix="WebCam" %>
    ...
    <div class="contentdata">
        <table class="w-100p">
                                        ...
                                        <table class="w-100p">
                                                ...
                                                <td>
                                                   <%-- <asp:TextBox ID="txtExternalVisitID" runat="server" MaxLength="13" CssClass="Txtboxsmall"
                                                    ...
                                                    <img src="../Images/starbutton.png" alt="" align="middle" />--%>
                                                      <asp:TextBox ID="txtExternalVisitID" runat="server" onblur="javascript:SelectedExtVisitID();"
                                                    ...
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td class="a-left" nowrap="nowrap">
                                                                <asp:TextBox ID="txtName"  onfocus="javascript:setPatientSearchjquery();"   OnKeyPress="return  ValidateMultiLangChar(this) || ValidateOnlyNumeric(this) ;"
                                                        ...
                                                        <%--       <ajc:AutoCompleteExtender  ID="AutoCompleteExtenderPatient" runat="server" TargetControlID="txtName"
                                                                    ...
                                                                    OnClientPopulated="onListPopulated" MinimumPrefixLength="2" BehaviorID="autoExtender"> 
                                                                </ajc:AutoCompleteExtender>--%>
                                                                <asp:HiddenField ID="hdnContextText" runat="server" />
                                                                 <asp:HiddenField ID="hdnPatientVal" runat="server" />
                                            ...
                                            <tr>
                                                ...
                                                <td class="v-middle a-left">
                                                    ...
                                                    <asp:TextBox ID="txtMobileNumber" autocomplete="off" onchange="CheckSMS();"   onpaste="return false;"   onkeypress="return ValidateOnlyNumeric(this);"   
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtPhone" autocomplete="off" onpaste="return false;"   onkeypress="return ValidateOnlyNumeric(this);"   
                                                ...
                                                <td>
                                                    ...
                                                    &nbsp;<img src="../Images/starbutton.png" alt="" align="middle" 
                                                        id="imageEmail" runat="server" visible="false" />
                                            ...
                                            <tr id="trPatientPriorityPart" runat="server">
                                                ...
                                                <td id="tdRefDrParttxt" runat="server">
                                                    <asp:TextBox ID="txtInternalExternalPhysician" runat="server" CssClass="AutoCompletesearchBox"
                                                        onFocus="return getrefhospid(this.id)" onblur="javascript:ValidateRefPhysician()" onKeyDown="javascript:ClearDiscountLimitValues();"></asp:TextBox>
                                                    ...
                                                    <img src="../Images/starbutton.png" alt="" class="a-center" runat="server" ID="NeedRefPhyNeed" visible="false"/>
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblLocation" runat="server" Text="Proxy Registration By" meta:resourcekey="lblLocationResource1"></asp:Label>
                                                    <asp:Label ID="lblPriority" runat="server" Text="Patient Source" style="display: none;" ></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:DropDownList  ID="ddlPriority" runat="server" CssClass="ddlsmall" style="display: none;"
                                            ...
                                            <tr id="trVisitTypePart" runat="server" style="display: none;">
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtLogistics" runat="server" CssClass="AutoCompletesearchBox" onFocus="javascript:ClearlogisticsID()" onblur="javascript:ValidateLogistics()"></asp:TextBox>
                                            ...
                                            <tr>
                                               <td id="tdHubID" runat="server" nowrap="nowrap">
                                                    <asp:Label ID="lblHubID" runat="server" meta:resourcekey="lblHubIDResource1"></asp:Label>
                                                </td>
                                                <td id="tdtxtHubID" runat="server">
                                                    <asp:TextBox ID="txtHealthHubID" autocomplete="off" runat="server" onblur="javascript:ValidateHealthHubID();" 
                                                    nowrap="nowrap" CssClass = "Txtboxsmall" ></asp:TextBox>
                                                </td>
                                            ...
                                            <tr id="tdAdditionalDetails" runat="server" style="height:36.5px">
                                                ...
                                                <td>
                                                    ...
                                                    <td nowrap="nowrap">
                                                    <div id="divCaptureimage" class="hide">
                                                        <WebCam:Captureimage ID="Captureimage" runat="server" />
                                                    </div>
                                                    <img id="webcamimg" width="25p" height="25" src="../PlatForm/Images/Camera.jpg" onclick="javascript:return Show_CaptureImage();" />
                                                </td>
                                                <td>
                                                <img id="imgPatient"/>
                                                </td>
                                            ...
                                            <tr id="trEditRemarks" runat="server" style="display: none;">
                                                ...
                                                <td id="tdPatientHistory" runat="server" class="a-left" style="display:none">
                                                 ...
                                                 <td id="tdClientAttribute" runat="server" class="a-center" style="display:none;">
                                                    <a id="clientwise1" onclick="" style="font-weight: bold;text-decoration: underline;color: red;" >Client Attributes</a>
                                                </td>
                                            </tr>
                                            <tr style="display: none;">
                                                <td style="display: none;">
                                                    <asp:Label ID="lblCollectionCode" Text="<u>L</u>ocation" runat="server"  meta:resourcekey="lblCollectionCodeResource1"></asp:Label>
                                                </td>
                                                <td style="display: none;">
            ...
            <tr id="trOrderCalcPart" runat="server" style="display: table-row;">
             ...
             <tr id="trclincalhistoryedit" runat="server" visible="false"><td>
                                            <div id="Billingforclinichistory" runat="server"></div>
                                            </td></tr>
            <tr>
...
<%--                                <input runat="server" value=<%=Resources.Billing_ClientDisplay.Billing_BillingPart_aspx_10 %> type="button" id="btnClose" style="width:100px;" class="btn" onclick="clearbuttonClick()" />--%>
        ...
        <ContentTemplate>
            ...
            <asp:HiddenField ID="hdnrolevalue" runat="server"  Value="N" />
            <asp:HiddenField ID="hdneditdoc" runat="server" Value="N" />
            ...
            <ajc:ModalPopupExtender ID="modalpopupsendemail1" runat="server" PopupControlID="pnlMailReportcheck"
                TargetControlID="hdnTargetCtlMailReport" BackgroundCssClass="modalBackground"
                CancelControlID="btnCancel" DynamicServicePath="" Enabled="True">
            </ajc:ModalPopupExtender>
               <ajc:ModalPopupExtender ID="modalpopupCTK" runat="server" PopupControlID="pnlconforCTK"
                TargetControlID="hdnisCT" BackgroundCssClass="modalBackground"
                CancelControlID="btncancelctk" DynamicServicePath="" Enabled="True">
            </ajc:ModalPopupExtender>
            <%-- <ajc:ModalPopupExtender ID="modalpopupCTE" runat="server" PopupControlID="pnlconforCTE"
                TargetControlID="hdnisCT" BackgroundCssClass="modalBackground"
                CancelControlID="btncancelcte" DynamicServicePath="" Enabled="True">
            </ajc:ModalPopupExtender>
            <ajc:ModalPopupExtender ID="modalpopupMRIK" runat="server" PopupControlID="pnlconforMRIK"
                TargetControlID="hdnisMRI" BackgroundCssClass="modalBackground"
                CancelControlID="btncancelmrik" DynamicServicePath="" Enabled="True">
            </ajc:ModalPopupExtender>
            <ajc:ModalPopupExtender ID="modalpopupMRIE" runat="server" PopupControlID="pnlconforMRIE"
                TargetControlID="hdnisMRI" BackgroundCssClass="modalBackground"
                    ...
                    <table class="w-100p">
                        <tr>
                            <td class="h-100p a-center">
                                ...
                                <asp:Button ID="btnDisableIframSRC" CssClass="btn" runat="server" OnClientClick="return HideModalPopup()"
            ...
            <asp:Panel ID="pnlMailReportcheck" BorderWidth="1px" CssClass="modalPopup dataheaderPopup w-70p"
                runat="server" meta:resourcekey="pnlMailReportResource1">
                <asp:Panel ID="Panel2" runat="server" CssClass="dialogHeader w-100p" Height="550px"
                    meta:resourcekey="Panel1Resource1">
                    <table class="w-100p">
                        <tr>
                            <td class="h-100p a-center">
                                <iframe id="CouponCardBillFrame1" runat="server" name="myname" src="#toolbar=1" class="w-100p" style="height:500px; width:500px;"></iframe>
                                <asp:Button ID="Button2" CssClass="btn" runat="server" OnClientClick="return HideModalPopupcheck()"
                                    Text="Close" meta:resourcekey="btnCancelResource1" />
                            </td>
                        </tr>
                    </table>
                    <%--//Added by Thamilselvan...for Full Bill--%>
                    <input type="hidden" id="Hidden1" name="hdnFull" runat="server" />
                </asp:Panel>
            </asp:Panel>
    ...
    <input type="hidden" runat="server" id="hdnreplanguage" value ="" />
    ...
    <asp:HiddenField ID="hdnRefvisit" runat="server" />
    ...
    <asp:HiddenField ID="hdnRefPhyNeed" runat="server" Value="N" />
    <asp:HiddenField ID="hdnEmailNeed" runat="server" Value="N" />
    ...
    <asp:HiddenField ID="hdnPhcInvID" runat="server" Value="" />
        ...
        <asp:HiddenField runat="server" ID="hdnRefphyfreetext" Value="Y" />
    ...
    <asp:HiddenField ID="hdnNotAllowDue" Value="" runat="server" />
    <asp:HiddenField ID="hdnTestHistoryPatient" Value="" runat="server" />
  <asp:HiddenField ID="hdnDueReasonCollect" runat="server" Value="N" />
  <asp:HiddenField ID="hdndueauthorisedbyname" runat="server" Value="" />
  <asp:HiddenField ID="hdndueauthorisedbyid" runat="server" Value="" />
  <asp:HiddenField ID="hdnduereasontext" runat="server" Value="" />
  <asp:HiddenField ID="hdnduereasonddl" runat="server" Value="" />
  <asp:HiddenField ID="hdnduechecked" runat="server" Value="0" />
  ...
  <input id="hdnTotalCreditLimit" runat="server" value="0" type="hidden" />
    ...
    <asp:HiddenField ID="hdnCaptureimageFileName" runat="server" Value="" />
    <asp:HiddenField ID="hdnTRFimageFileName" runat="server" Value="" />
     <asp:HiddenField ID="hdnTRFimageFilePath" runat="server" Value="" />
    ...
    <asp:HiddenField ID="hdnpreviousdue" Value="0.00" runat="server" />
	 <input id="hdnHealthiBookingID" type="hidden" value="0" runat="server" /> 
...
<asp:HiddenField ID="hdnExBarcodeExpiry" Value="" runat="server" /> 
<asp:HiddenField ID="hdnIsExbarcode" Value="N" runat="server" />  
<input id="hdnIsPaymentAdded" runat="server" value="N" type="hidden" />
<asp:HiddenField ID="hdnAllowGreaterAmtfromMrp" Value="N" runat="server" /> 
    <script type="text/javascript">
        ...
        function HideModalPopup() {
            ...
            if (document.getElementById('hdnisCT').value == "Y" || document.getElementById('hdnisMRI').value == "Y") {
                $('#ConsentformctkFrame', parent.document).attr('src', $('#ConsentformctkFrame', parent.document).attr('src'));
                $find("modalpopupCTK").show();
            } 
            return false;
        }
        function HideModalPopupcheck() {
            $find("modalpopupsendemail1").hide(); 
            return false;
        }
            ...
            $("#txtName").autocomplete({
                source: function(request, response) {
                    $.ajax({
                        ...
                        url: '../OPIPBilling.asmx/GetQuickPatientSearchClient',
                        data: JSON.stringify({ prefixText: request.term, count: 10, contextKey: $('#hdnContextText').val(), PatientClientID: $('#hdnSerachPatientwithClientID').val() }),
                        dataType: "json",
                        success: function(data) {
                            if (data.d.length > 0) {
                                // var lst=   JSON.parse(data.d)
                                response($.map(data.d, function(item) {
                                    var rsltlable = item.Name.split('~')[0];
                                    var rsltvalue = item.Comments;
                                    return {
                                        label: rsltlable,
                                        val: rsltvalue
                                    }
...
//                        var value = i.item.value.split(":");
//                        var name = value[0];
//                        $("#txtName").val(name);
//                        $('#hdnSelectedPatientTempDetails').val(i.item.val);
//                        SelectedPatientClient(i.item.val);
...
//                },
    ...
    <script src="../Scripts/LabQuickBilling.js?v=<%= System.Configuration.ConfigurationManager.AppSettings["jsDownloadVersion"]%>" type="text/javascript"></script>

    <script src="../Scripts/JsonScript.js?v=<%= System.Configuration.ConfigurationManager.AppSettings["jsDownloadVersion"]%>" language="javascript" type="text/javascript"></script>

    <script src="../Scripts/CopaymentAndPreAuth.js?v=<%= System.Configuration.ConfigurationManager.AppSettings["jsDownloadVersion"]%>" type="text/javascript"></script>

    <%-- <script src="../Scripts_New/JsonScript.js?v=<%= System.Configuration.ConfigurationManager.AppSettings["jsDownloadVersion"]%>" language="javascript" type="text/javascript"></script>--%>

    <script src="../Scripts/jquery.MultiFile.js?v=<%= System.Configuration.ConfigurationManager.AppSettings["jsDownloadVersion"]%>" type="text/javascript"></script>

    <%--   <script src="../scripts_New/MessageHandler.js?v=<%= System.Configuration.ConfigurationManager.AppSettings["jsDownloadVersion"]%>" language="javascript" type="text/javascript"></script>--%>

    <script type="text/javascript" src="../Scripts/datetimepicker_css.js?v=<%= System.Configuration.ConfigurationManager.AppSettings["jsDownloadVersion"]%>"></script>

    <script src="../Scripts/CollectSample.js?v=<%= System.Configuration.ConfigurationManager.AppSettings["jsDownloadVersion"]%>" language="javascript" type="text/javascript"></script>
         <%--<link href="../QMS/dataTable/jquery.dataTables.min.css" rel="stylesheet" type="text/css" />--%>
    <script src="../QMS/dataTable/jquery.dataTables.min.js?v=<%= System.Configuration.ConfigurationManager.AppSettings["jsDownloadVersion"]%>" type="text/javascript"></script>
    <script src="../Scripts/CommonBilling.js?v=<%= System.Configuration.ConfigurationManager.AppSettings["jsDownloadVersion"]%>" type="text/javascript"></script>
    <link href="../StyleSheets/jquery-ui.css?v=<%= System.Configuration.ConfigurationManager.AppSettings["jsDownloadVersion"]%>" rel="stylesheet" type="text/css" />

    <link href="../QMS/Script/jquery-ui-git.css?v=<%= System.Configuration.ConfigurationManager.AppSettings["jsDownloadVersion"]%>" rel="stylesheet" type="text/css" />
    <%--   <script src="../Scripts_New/Format_Currency/jquery-1.7.2.min.js?v=<%= System.Configuration.ConfigurationManager.AppSettings["jsDownloadVersion"]%>" type="text/javascript"></script>--%>
    <%--   <script src="../Scripts_New/Format_Currency/jquery.formatCurrency-1.4.0.js?v=<%= System.Configuration.ConfigurationManager.AppSettings["jsDownloadVersion"]%>" type="text/javascript"></script>

   
    <script src="../Scripts/Format_Currency/jquery.formatCurrency.all.js?v=<%= System.Configuration.ConfigurationManager.AppSettings["jsDownloadVersion"]%>" type="text/javascript"></script>--%>
    <%--    <script type="text/javascript" src="../Scripts_New/datetimepicker_css.js?v=<%= System.Configuration.ConfigurationManager.AppSettings["jsDownloadVersion"]%>"></script>--%>
    <link href="../StyleSheets/billlingPopup.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" language="javascript">
        ...
        function OpenIframe(FinalBillID, patientVisitID) {
            ...
            var iframe = document.getElementById("ifPDF");
                       ...
                       iframe.src = '..\\Investigation\\BillPrint.aspx?vid=' + patientVisitID + '&finalBillID=' + FinalBillID + '&actionType=DefaultPrint&type=printreport&invstatus=approve';
       }

        $(document).ready(function() {
       var EditDocvalue = document.getElementById('hdnrolevalue').value;
       var EditDoc = document.getElementById('hdneditdoc').value;
       if (EditDocvalue == "Y" && EditDoc == "Y")
...
width: 0px
 ...
 <script type="text/javascript">
     ...
     function Validategender() {
        ...
        function changestatus(ID) {
            ...
            if (ID == 'ddlDOBDWMY') {
                ...
                else if (document.getElementById('chkIncomplete').style.Display == 'block') {
                    $('.InCom').show();
                    document.getElementById('tDOB').value = ''
                    document.getElementById('tDOB').placeholder = "dd//mm//yyyy";
                    //$('#ddlDOBDWMY').val('Year(s)');
        ...
        function ValidateRefPhysician() {
            var refID = document.getElementById('hdnReferedPhyID').value;
            var InternalExternalPhysician = document.getElementById('txtInternalExternalPhysician').value;
            //            var OrgID = document.getElementById('hdnOrgID').value;
            var _AllowFreeText = document.getElementById('hdnRefphyfreetext').value;
            var AlertType = SListForAppMsg.Get('Billing_Header_Alert') == null ? "Alert" : SListForAppMsg.Get('Billing_Header_Alert');
    ...
    <script type="text/javascript">
    function Show_CaptureImage() { 
        $("#divCaptureimage").dialog(
          {
              modal: true,
              height: 500,
              autoOpen: false,
              ...
              open: function(event, ui) {
                  ...
                  $(this).parent().css("left", "center");
              }
          });
          $("#divCaptureimage").dialog('open'); 
        return false;
    }
    function Showchangefile(input) { 
        if (input.files && input.files[0]) {
            var reader = new FileReader();
            reader.onload = function(e) {
                $('#imgPatient').attr('src', e.target.result);
                $('.photo_notavailable').hide();
            }
