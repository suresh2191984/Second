<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Tuberculosis.ascx.cs"
    Inherits="HealthPackageControls_Tuberculosis" %>
...
<table cellpadding="0" width="100%">
            ...
            <table cellpadding="0">
                <tr>
                    <td style="width:200px">
                        <asp:Label ID="lblTuberculosis_526" runat="server" Text="Tuberculosis" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="left" colspan="1">
                        <asp:RadioButton ID="rdoYes_526" Text="Yes" runat="server" GroupName="radioExtend"
                            onclick="javascript:showContentHis(this.id);" />
                        <asp:RadioButton ID="rdoNo_526" Text="No" runat="server" GroupName="radioExtend"
                            onclick="javascript:showContentHis(this.id);" />
                        <asp:RadioButton ID="rdoUnknown_526" Text="Unknown" runat="server" GroupName="radioExtend"
                            onclick="javascript:showContentHis(this.id);" />
                    </td>
                </tr>
            </table>
    ...
    <tr>
        <td colspan="2">
            <div id="divrdoYes_526" runat="server" style="display: none">
                <table cellpadding="0" align="center" width="100%">
                    ...
                    <tr>
                        <td colspan="3">
                            <asp:TextBox ID="txtTuberculosis_526" runat="server" Width="250px"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </div>
