...
public partial class EMR_Diagnosticsl : BaseControl
{
    ...
    private void BindCoronaryAngiogramResult()
    {
        ...
        returnCode = new SmartAccessor().GetDiagnosticsAttributeValues(18,IsParentAttID, out lstDiagnosticsAttributeValues);
    ...
    private void BindMVSType()
    {
        IsParentAttID = "NO";
        List<DiagnosticsAttributeValues> lstDiagnosticsAttributeValues = new List<DiagnosticsAttributeValues>();
        returnCode = new SmartAccessor().GetDiagnosticsAttributeValues(16,IsParentAttID, out lstDiagnosticsAttributeValues);
    ...
    private void BindMPSType()
    {
        IsParentAttID = "NO";
        List<DiagnosticsAttributeValues> lstDiagnosticsAttributeValues = new List<DiagnosticsAttributeValues>();
        returnCode = new SmartAccessor().GetDiagnosticsAttributeValues(14,IsParentAttID, out lstDiagnosticsAttributeValues);
    ...
    private void BindAssociatedSymptoms()
    {
        IsParentAttID = "NO";
        List<DiagnosticsAttributeValues> lstDiagnosticsAttributeValues = new List<DiagnosticsAttributeValues>();
        returnCode = new SmartAccessor().GetDiagnosticsAttributeValues(10, IsParentAttID, out lstDiagnosticsAttributeValues);
    ...
    private void BindStressRelatedECGChanges()
    {
        IsParentAttID = "NO";
        List<DiagnosticsAttributeValues> lstDiagnosticsAttributeValues = new List<DiagnosticsAttributeValues>();
        returnCode = new SmartAccessor().GetDiagnosticsAttributeValues(9, IsParentAttID, out lstDiagnosticsAttributeValues);
    ...
    private void BindTreadmillTestResult()
    {
        IsParentAttID = "NO";
        List<DiagnosticsAttributeValues> lstDiagnosticsAttributeValues = new List<DiagnosticsAttributeValues>();
        returnCode = new SmartAccessor().GetDiagnosticsAttributeValues(8, IsParentAttID, out lstDiagnosticsAttributeValues);
    ...
    private void BindValveAbnormality()
    {
        IsParentAttID = "NO";
        List<DiagnosticsAttributeValues> lstDiagnosticsAttributeValues = new List<DiagnosticsAttributeValues>();
        returnCode = new SmartAccessor().GetDiagnosticsAttributeValues(5, IsParentAttID, out lstDiagnosticsAttributeValues);
    ...
    private void BindMyocardium()
    {
        IsParentAttID = "NO";
        List<DiagnosticsAttributeValues> lstDiagnosticsAttributeValues = new List<DiagnosticsAttributeValues>();
        returnCode = new SmartAccessor().GetDiagnosticsAttributeValues(3, IsParentAttID, out lstDiagnosticsAttributeValues);
        ...
        returnCode = new SmartAccessor().GetDiagnosticsAttributeValues(1, IsParentAttID, out lstDiagnosticsAttributeValue);
    ...
    private void BindECGAbnormalities()
    {
        IsParentAttID = "YES";
        List<DiagnosticsAttributeValues> lstDiagnosticsAttributeValues = new List<DiagnosticsAttributeValues>();
        returnCode = new SmartAccessor().GetDiagnosticsAttributeValues(1, IsParentAttID, out lstDiagnosticsAttributeValues);
