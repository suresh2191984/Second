<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Diagnostics.ascx.cs" Inherits="EMR_Diagnostics" %>
                    ...
                    <td>
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="txtEjectionFraction_85" runat="server" Width="50px" 
                                meta:resourcekey="txtEjectionFraction_85Resource1" CssClass="Txtboxsmall"></asp:TextBox>
                ...
                <ContentTemplate>
                    <table border="1" cellpadding="0" align="center" width="100%" class="dataheaderInvCtrl">
                        <tr>
                            ...
                            <td style="width: 258px">
                                <asp:DropDownList ID="ddlCAR_18" runat="server" onClick="javascript:showDiagnosticsPKGOthers(this.id);" 
                                    meta:resourcekey="ddlCAR_18Resource1" CssClass="ddlsmall">
                                </asp:DropDownList>
                                <div id="divddlCAR_18" runat="server" style="display: none">
                                    <asp:TextBox ID="txtOthers_18" runat="server"></asp:TextBox>
                                </div>
                            </td>
                            <td>
                            ...
                            <td id="trCAR_18" runat="server" style="display: none;">
                                ...
                                <asp:DropDownList ID="ddlCoronaryVessel_19" runat="server" onClick="javascript:showOthersChkBox(this.id);" 
