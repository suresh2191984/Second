<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RenalDisorder.ascx.cs"
    Inherits="HealthPackageControls_RenalDisorder" %>
            ...
            <table cellpadding="0">
                <tr>
                    ...
                    <td align="left" colspan="1">
                        ...
                        <asp:RadioButton ID="rdoNo_32" Text="No" runat="server" GroupName="radioExtend" onclick="javascript:showContentHis(this.id);" />
