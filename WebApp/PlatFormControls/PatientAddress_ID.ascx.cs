...
public partial class PlatFormControls_PatientAddress_ID : Attune_BaseControl, Attune_IPatientAddress
{
    public PlatFormControls_PatientAddress_ID()
        : base("PlatFormControls_PatientAddress_ID_ascx")
    {}
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        sDefSelect = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_ID_ascx_01;
    }
    ...
    public void LoadCountry(long CodeID)
    {
        ...
        //Utilities objUt = new Utilities();
        //string Select = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_ID_ascx_01;
        ...
        try
        {
            ...
            if (StateID > 0)
            {
               ...
               // long StateCode = StateCodes[0].StateID;
                long StateCode = hdnAddressState.Value == "" ? StateCodes[0].StateID : Convert.ToInt32(hdnAddressState.Value);
    ...
    public void LoadCountry(long CodeID, long CountCode)
    {
        long returnCode = -1;
        Country_BL countryBL = new Country_BL(base.ContextInfo);
        List<Country> countries = new List<Country>();
    ...
    public PatientAddress GetPAddress()
    {
        ...
        Utilities objut = new Utilities();
        string sDefSelect = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_ID_ascx_01;
        //Arun
    ...
    public void SetAddresstoEdit(List<OrgUsers> lstOrgUsers)
    {
        try
        {
            ...
            if (lstOrgUsers.Count != 0)
            {
                ...
                hdnCityID.Value = Statecode.ToString();
                ...
                //}
                hdnCityID.Value = lstOrgUsers[0].CityCode.ToString();
                //if (lstOrgUsers != null && lstOrgUsers[0].AddLevel1 > 0 && ddlDistricts.Items.Count > 0)
                //{
                //    if (ddlDistricts.Items.FindByValue(lstOrgUsers[0].AddLevel1.ToString()) != null)
                //    {
                //        ddlDistricts.Items.FindByValue(lstOrgUsers[0].AddLevel1.ToString());
        ...
        {
			CLogger.LogError("Error while loading SetAddresstoEdit-PatientAddress_ID", ex);
        }
    }
    public void SetAddresstoEdit1(List<OrganizationAddress> lstOrgLocation)
    {
        if (lstOrgLocation.Count != 0)
        {
            ...
            txtAddress2.Text = lstOrgLocation[0].Add2;
            ...
            string sPath = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_ID_ascx_cs_01;
            if (sPath == null)
            {
                sPath = "OTHERS";
            }
            ...
            {
                tbState.Attributes.Add("class", "show");
                tbCountry.Attributes.Add("class", "show");
            }
            ...
            else
            {
                ...
                tbState.Attributes.Add("class", "hide");
                tbCountry.Attributes.Add("class", "hide");
            }
        }
    }
    ...
    public void LoadStates(long CodeID)
    {
        ...
        try
        {
            ...
            if (childItems != null)
            {
                txtCountryCode.Text = "+" + childItems.ISDCode.ToString();
                txtCountryCode.Enabled = false;
                //ddState.SelectedValue = Convert.ToString(childItems.Locality_ID);
                ddState.SelectedValue = Convert.ToString(StateLocID);
                LoadCity(StateLocID);
            }
        }
        catch (Exception ex)
    ...
    public UserAddress GetAddress1()
    {
        ...
        useAddress.CountryID = (ddCountry.SelectedValue != sDefSelect && ddCountry.SelectedValue != "") ? Convert.ToInt64(ddCountry.SelectedValue) : 0;
        useAddress.StateID = (ddState.SelectedValue != sDefSelect && ddState.SelectedValue != "") ? Convert.ToInt64(ddState.SelectedValue) : 0;
    ...
    public OrgUsers GetDynamicAddress(OrgUsers eUsers)
    {
        ...
        string sDefSelect = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_ID_ascx_01;
        eUsers.CountryID = (ddCountry.SelectedValue != sDefSelect && ddCountry.SelectedValue != "") ? Convert.ToInt64(ddCountry.SelectedValue) : 0;
        eUsers.StateID = (ddState.SelectedValue != sDefSelect && ddState.SelectedValue != "") ? Convert.ToInt64(ddState.SelectedValue) : 0;
    ...
    public void SetColumnWidths(double col1, double col2, double col3, double col4)
    {
        ...
        Col4.Style.Add("Width", Convert.ToString(col3) + "%");
        Col5.Style.Add("Width", Convert.ToString(col4) + "%");
