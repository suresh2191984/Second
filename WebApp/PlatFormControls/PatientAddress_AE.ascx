<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PatientAddress_AE.ascx.cs"
    Inherits="PlatFormControls_PatientAddress_AE" %>
<table id="tblAddressCntrl" class="w-100p">
    ...
    <tr>
        ...
        <td class="v-top w-9p Col5">
            <asp:Label ID="State" runat="server" Text="Emirate" meta:resourcekey="StateResource1"></asp:Label>
        </td>
        <td class="v-top">
    ...
    <tr>
        ...
        <td class="hide">
         ...
         <td>
            <asp:Label ID="City" runat="server" Text="Area" meta:resourcekey="CityResource1"></asp:Label>
        </td>
        <td>
        ...
        <td>
            <asp:Label ID="PostalCode" runat="server" Text="<u>P</u>O box " meta:resourcekey="PostalCodeResource1"></asp:Label>
        </td>
        <td>
        ...
        <td colspan="1">
            <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                <ContentTemplate>
                    <asp:TextBox ID="txtCountryCode" runat="server"  CssClass="mini" Font-Bold="True" onkeypress="return ValidateMultiLangChar(this);"
    ...
    <asp:HiddenField ID="hdnEmirate" runat="server" Value="Y" />
...
//            }
    ...
    function HideDistrict(objCity) {
        ...
        Config = document.getElementById("<%=hdnEmirate.ClientID %>").value;
        if (Config == 'Y') {
            if (($('#<%= lblDistricts.ClientID %>').selector == '#ucPAdd_lblDistricts' || $('#<%= lblDistricts.ClientID %>').selector == '#QPR_ucPAdd_lblDistricts') || ($('#<%= lblDistricts.ClientID %>').selector == '#ucCAdd_lblDistricts') || $('#<%= lblDistricts.ClientID %>').selector == '#QPR_ucCAdd_lblDistricts') {
                ...
                var Country = ''; //document.getElementById('#ucPAdd_lblDistricts').options[document.getElementById('#ucPAdd_lblDistricts').selectedIndex].text;
                ...
                if (flag = 1) {
                    if ($('#<%= lblDistricts.ClientID %>').selector == '#ucCAdd_lblDistricts' || $('#<%= lblDistricts.ClientID %>').selector == '#ucPAdd_lblDistricts') {
                        var parID = "ucPAdd";
                        Country = document.getElementById('ucPAdd_ddCountry').value;
                    }
                    if ($('#<%= lblDistricts.ClientID %>').selector == '#QPR_ucPAdd_lblDistricts') {
                        var parID = "QPR_ucPAdd";
                        Country = document.getElementById('QPR_ucPAdd_ddCountry').value;
                    }
                }

                if (Country == '211') {
                    var lblDistricts = parID + "_lblDistricts";
                    var ddlDistricts = parID + "_ddlDistricts";
                    var hdnDistricts = parID + "_hdnDistricts";
                    document.getElementById(lblDistricts).closest("td").hide();
                    document.getElementById(ddlDistricts).closest("td").hide();

                    document.getElementById(lblDistricts).hide();
                    document.getElementById(ddlDistricts).hide();
                    document.getElementById(ddlDistricts).next().hide();
                    
                    document.getElementById(ddlDistricts).value = StateValue;
                    document.getElementById(ddlDistricts).text = State;
                    document.getElementById(hdnDistricts).value = StateValue;
                    
                    
                }
                else {
                    document.getElementById(lblDistricts).closest("td").show();
                    document.getElementById(ddlDistricts).closest("td").show();

                    document.getElementById(lblDistricts).show();
                    document.getElementById(ddlDistricts).show();
                    document.getElementById(ddlDistricts).next().show();
                }
            }
