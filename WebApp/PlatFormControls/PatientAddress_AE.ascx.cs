...
public partial class PlatFormControls_PatientAddress_AE : Attune_BaseControl, Attune_IPatientAddress
{
    public PlatFormControls_PatientAddress_AE()
        : base("PlatFormControls_PatientAddress_AE_ascx")
    {
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            IsMiddleEastConfig = GetConfigValue("NeedPatientAllergyDetails", OrgID);
        ...
        sDefSelect = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_AE_ascx_01;
    }
    ...
    public void LoadCountry(long CodeID)
    {
        ...
        //Utilities objUt = new Utilities();
        //string Select = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_AE_ascx_01;
            ...
            if (StateID > 0)
            {
                ...
                if (StateCodes.Count > 0)
                {
                    ...
                    if (IsMiddleEastConfig == "Y")
                    {
                        ...
                        txtMobile.MaxLength = Convert.ToInt32(hdnPhLength.Value);
                    }
                }
            }
        }
    ...
    public PatientAddress GetPAddress()
    {
        ...
        Utilities objut = new Utilities();
        string sDefSelect = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_AE_ascx_01;
        if (txtAddressID.Text != "")
        {
            objAddress.AddressID = Convert.ToInt32(txtAddressID.Text);
        }
        ...
        objAddress.StateID = (ddState.SelectedValue != sDefSelect && ddState.SelectedValue != "0" && ddState.SelectedValue != "0") ? Convert.ToInt32(ddState.SelectedValue) : Convert.ToInt32(stateid);
    ...
    public void SetAddresstoEdit1(List<OrganizationAddress> lstOrgLocation)
    {
        if (lstOrgLocation.Count != 0)
        {
            ...
            string sPath = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_AE_ascx_cs_01;
            if (sPath == null)
            {
                sPath = "OTHERS";
            }
    ...
    {
        string sMob = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_AE_ascx_02 != null ? Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_AE_ascx_02 : "Mob : ";
        string sPh = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_AE_ascx_03 != null ? Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_AE_ascx_03 : "Ph : ";
        string sOCountry = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_AE_ascx_04 != null ? Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_AE_ascx_04 : "OCountry: ";
        string sOState = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_AE_ascx_05 != null ? Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_AE_ascx_05 : "OState : ";
