...
public partial class PlatFormControls_PatientAddress_IN : Attune_BaseControl, Attune_IPatientAddress
{
    public PlatFormControls_PatientAddress_IN()
        : base("PlatFormControls_PatientAddress_IN_ascx")
    {
    }
    ...
    string IsPostalCodeNeedConfig = string.Empty;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //    litTitle.Visible = false;
        //}
        string Hidelocality =string.Empty;
        Hidelocality=GetConfigValue("HideLocality", OrgID);
        if (Hidelocality == "Y")
        {
            lblLocality.Style.Add("display", "none");
            ddllocalities.Style.Add("display", "none");
        }
        else
        {
            lblLocality.Style.Add("display", "block");
            ddllocalities.Style.Add("display", "block");
        }
        string IsSmeConfig = "IsSMEOrg";
        string Smecode = GetConfigValue(IsSmeConfig, OrgID);
        hdnsme.Value = Smecode.ToString();
        string MobileLessDigit = GetConfigValue("AllowLesserDigitMobileYN", OrgID);
        string DistrictYN = GetConfigValue("DistrictReqYN", OrgID);
        string PostalCodeYN = GetConfigValue("PostalCodeReqYN", OrgID);
        hdnAllowLesserDigitMobileYN.Value = MobileLessDigit;
        hdnDistrictYN.Value = DistrictYN;
        hdnPostalCodeYN.Value = PostalCodeYN;
        IsPostalCodeNeedConfig = GetConfigValue("IsPostalCodeNeed", OrgID);
        if (IsPostalCodeNeedConfig == "Y")
        {
            hdnIsPostalCodeNeed.Value = "Y";
            imgPostalCode.Attributes.Add("style", "inline-block"); 
        }
        if (hdnPostalCodeYN.Value=="Y")
        {
            imgPostalCode.Attributes.Add("style", "inline-block");
                
        }
        if (hdnDistrictYN.Value != "N")
        {
            imgDistrict.Attributes.Add("style", "inline-block");
            imgCity.Attributes.Add("style", "inline-block"); 
        }
        if (!IsPostBack)
        {
            hdnOrgState.Value = StateID.ToString();
        ...
        sDefSelect = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_IN_ascx_01;
    }
    ...
    {
        long returnCode = -1;
        Country_BL countryBL = new Country_BL(new Attune_BaseClass().ContextInfo);
        List<Country> countries = new List<Country>();
        List<Localities> lstLocalities = new List<Localities>();
        List<InvestigationMaster> i = new List<InvestigationMaster>();
        List<State> states = new List<State>();
        State_BL stateBL = new State_BL(new Attune_BaseClass().ContextInfo);
        Country selectedCountry = new Country();
        //ddCountry.Items.Clear();
        //Utilities objUt = new Utilities();
        //string Select = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_IN_ascx_01;

        try
        {
            returnCode = countryBL.GetCountryList(out countries);

            returnCode = countryBL.GetLocalities(0, out lstLocalities);
    ...
    public void SetAddress(PatientAddress pAddress)
    {
        ...
        txtCountryCode.Text = "+ " + pAddress.ISDCode;
    ...
    public void SetAddress(PhysicianAddress phyAddress)
    {
        ...
        if (phyAddress.AddLevel1 > 0)
        {
            ...
            LoadCity(Convert.ToInt64(phyAddress.AddLevel1.ToString()));
        }
    ...
    public PatientAddress GetPAddress()
    {
        ...
        Utilities objut = new Utilities();
        string sDefSelect = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_IN_ascx_01;
        if (txtAddressID.Text != "")
        {
            objAddress.AddressID = Convert.ToInt32(txtAddressID.Text);
        }
        ...
        string stateid = hdnStateid.Value;
        ...
        objAddress.OtherCountryName = txtOtherCountry.Text;
        objAddress.OtherStateName = txtOtherState.Text;
        /*objAddress.CountryID = (hdnAddressCountry.Value != sDefSelect && hdnAddressCountry.Value != "") ? Convert.ToInt64(hdnAddressCountry.Value) : 0;
        objAddress.StateID = (hdnAddressState.Value != sDefSelect && hdnAddressState.Value != "") ? Convert.ToInt64(hdnAddressState.Value) : 0;
        ...
        objAddress.CountryID = (ddCountry.SelectedValue != sDefSelect && ddCountry.SelectedValue != "0") ? Convert.ToInt32(ddCountry.SelectedValue) : 0;
		
        objAddress.StateID = (ddState.SelectedValue != sDefSelect && ddState.SelectedValue != "" && ddState.SelectedValue != "0") ? Convert.ToInt32(ddState.SelectedValue) : Convert.ToInt32(stateid);
        objAddress.CityCode = (ddlCity.SelectedValue != sDefSelect && ddlCity.SelectedValue != "" && ddlCity.SelectedValue != "0") ? Convert.ToInt32(ddlCity.SelectedValue) : Convert.ToInt32(hdnCityID.Value);
        objAddress.AddLevel1 = (ddlDistricts.SelectedValue != sDefSelect && ddlDistricts.SelectedValue != "" && ddlDistricts.SelectedValue != "0") ? Convert.ToInt32(ddlDistricts.SelectedValue) : Convert.ToInt32(hdnDistricts.Value);
        objAddress.AddLevel2 = (ddllocalities.SelectedValue != sDefSelect && ddllocalities.SelectedValue != "" && ddllocalities.SelectedValue != "0") ? Convert.ToInt32(ddllocalities.SelectedValue) : Convert.ToInt32(hdnLoclities.Value);
        return objAddress;
    ...
    public void SetAddresstoEdit(List<OrgUsers> lstOrgUsers)
    {
        if (lstOrgUsers.Count != 0)
        {
            ...
            if (CCodeID > 0)
            {
                ddCountry.SelectedValue = CCodeID.ToString();
            }
            ...
            if (lstOrgUsers[0].StateID > 0)
            {
                ddState.SelectedValue = lstOrgUsers[0].StateID.ToString();
            }
            hdnAddressState.Value = lstOrgUsers[0].StateID.ToString();
    ...
    public void SetAddresstoEdit1(List<OrganizationAddress> lstOrgLocation)
    {
        if (lstOrgLocation.Count != 0)
        {
            ...
            string sPath = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_IN_ascx_cs_01;
            if (sPath == null)
            {
                sPath = "OTHERS";
            }
    ...
    {
        string sMob = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_IN_ascx_02 != null ? Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_IN_ascx_02 : "Mob : ";
        string sPh = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_IN_ascx_03 != null ? Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_IN_ascx_03 : "Ph : ";
        string sOCountry = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_IN_ascx_04 != null ? Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_IN_ascx_04 : "OCountry: ";
        string sOState = Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_IN_ascx_05 != null ? Resources.PlatFormControls_ClientDisplay.PlatFormControls_PatientAddress_IN_ascx_05 : "OState : ";
        ...
        {
            Address += sMob + cAddress.MobileNumber + "</td><td></td></tr><tr><td>";
        }
        if (cAddress.LandLineNumber != "")
        {
            Address += sPh + cAddress.LandLineNumber + "</td><td></td></tr><tr><td>";
        }
        if (cAddress.OtherCountryName != "")
        {
            Address += sOCountry + cAddress.OtherCountryName + "</td><td></td></tr><tr><td>";
        }
        if (cAddress.OtherStateName != "")
        {
            Address += sOState + cAddress.OtherStateName + "</td><td></td></tr><tr><td>";
        }
        Address += " </td></tr></table>";
        return Address;
    ...
    public void LoadCity(long CodeID)
    {
        ...
        try
        {
            ...
            if (CityID == 0)
            {
                CityID = Convert.ToInt32(CityCode);
            }
            if (CityID != 0)
            {
    ...
    public void LoadDistricts(long CodeID)
    {
        ...
        try
        {
            ...
            ddlDistricts.Items.Insert(0, GetMetaData("Select", "0"));
            long DistLocID = 0;
            Int64.TryParse(hdnDistricts.Value, out DistLocID);
            if (DistLocID == 0)
            {
                DistLocID = DistrictID;
            }
            if (DistLocID != 0)
            {
    ...
    public UserAddress GetAddress1()
    {
        ...
        Int64.TryParse(ddCountry.SelectedValue, out CountryID);
        Int64.TryParse(stateid, out StateID);
       ...
       // useAddress.StateID = StateID;
        ...
        useAddress.CountryID = (ddCountry.SelectedValue != sDefSelect && ddCountry.SelectedValue != "0") ? Convert.ToInt32(ddCountry.SelectedValue) : 0;
        useAddress.StateID = (ddState.SelectedValue != sDefSelect && ddState.SelectedValue != "0" && ddState.SelectedValue != "0") ? Convert.ToInt32(ddState.SelectedValue) : Convert.ToInt32(stateid);
        useAddress.CityCode = (ddlCity.SelectedValue != sDefSelect && ddlCity.SelectedValue != "" && ddlCity.SelectedValue != "0") ? Convert.ToInt32(ddlCity.SelectedValue) : Convert.ToInt32(hdnCityID.Value);
        useAddress.AddLevel1 = (ddlDistricts.SelectedValue != sDefSelect && ddlDistricts.SelectedValue != "" && ddlDistricts.SelectedValue != "0") ? Convert.ToInt32(ddlDistricts.SelectedValue) : Convert.ToInt32(hdnDistricts.Value);
        useAddress.AddLevel2 = (ddllocalities.SelectedValue != sDefSelect && ddllocalities.SelectedValue != "" && ddllocalities.SelectedValue != "0") ? Convert.ToInt32(ddllocalities.SelectedValue) : Convert.ToInt32(hdnLoclities.Value);
    ...
    public void SetAddresstoLocEdit(List<NewInstanceWaitingCustomers> lstloc)
    {
        ...
        if (lstloc.Count != 0)
        {
            long CCodeID = lstloc[0].CountryID;
            long Statecode = lstloc[0].StateID;
            long CityCode = lstloc[0].CityCode;
            long disCode = lstloc[0].CreatedBy;
            long locCode = lstloc[0].ModifiedBy;
            LoadCountry(CCodeID);
            ...
            {
                LoadDistricts(Statecode);
                ddlDistricts.SelectedValue = lstloc[0].CreatedBy.ToString();
            }
            if (CityCode > 0)
            {
                Loadlocalities(CityCode);
                ddlCity.SelectedValue = lstloc[0].CityCode.ToString();
            }
            ...
            //ddlDistricts.SelectedValue = lstloc[0].AddLevel1.ToString();
