<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PatientBilling.aspx.cs" EnableEventValidation="false"
    Inherits="Reception_PatientBilling" meta:resourcekey="PageResource1" %>
...
<%@ Register Src="../CommonControls/ProceduresBill.ascx" TagName="ipTreatmentBillDetails"
    TagPrefix="uc9" %>
<%@ Register Src="../CommonControls/ConsultationDynamicDetails.ascx" TagName="ipConsultationDetails"
    TagPrefix="uc10" %>
                        ...
                        <table class="w-100p">
                            <tr>
                                ...
                                <td class="w-50p a-right">
                                    <asp:LinkButton ID="QuickBill" CssClass="defaultfontcolor" ToolTip="Please Click here for Quick Bill"
                                        runat="server" Text="Quick Bill" OnClick="QuickBill_Click" meta:resourcekey="QuickBillResource1"></asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </div>
        ...
        <table class="w-100p">
                ...
                <td class="dataheaderInvCtrl">
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlCorporate" CssClass="ddlsmall" runat="server" meta:resourcekey="ddlCorporateResource1">
                                </asp:DropDownList>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlClients" runat="server" CssClass="ddlsmall" meta:resourcekey="ddlClientsResource1">
                                </asp:DropDownList>
                            </td>
                            <td>
                            </td>
            ...
            <tr>
                <td class="dataheaderInvCtrl">
                    ...
                    <asp:DropDownList ID="ddlTypes" CssClass="ddlTheme ddlsmall" runat="server" onChange="changefuncion()"
            ...
            <tr>
                <td>
                    ...
                    <div id="divImmunization" style="display: none;" class="dataheaderInvCtrl">
                        ...
                        &nbsp;&nbsp; : &nbsp;<asp:TextBox ID="txtBirthWeeks" CssClass="small" runat="server" meta:resourcekey="txtBirthWeeksResource1"></asp:TextBox>
                    ...
                    <br />
                    <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn1" OnClick="btnSave_Click"
                        meta:resourcekey="btnSaveResource1" />
                    <asp:Button ID="btnClose" runat="server" Text="Close" CssClass="btn1" OnClick="btnClose_Click"
