<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DueCollection.aspx.cs" Inherits="Reception_DueCollection" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        if(document.getElementById('txtReceivedDue').value=='') {
            document.getElementById('txtReceivedDue').value = parseFloat(0);
        }
        document.getElementById('txtReceivedDue').value = parseFloat(document.getElementById('txtReceivedDue').value).toFixed(2);
        if (parseFloat(document.getElementById('txtReceivedDue').value) > parseFloat(document.getElementById('hdnAmountDue').value)) {
            var userMsg = SListForApplicationMessages.Get('Reception\\DueCollection.aspx_1');
            if (userMsg != null) {
                alert(userMsg);
                return false;
                ...
                alert('Check the received due amount');
                return false;
            }
            document.getElementById('txtReceivedDue').select();
        }
        else if (parseFloat(document.getElementById('txtReceivedDue').value) == parseFloat(0)) {
        var userMsg = SListForApplicationMessages.Get('Reception\\DueCollection.aspx_1');
        if (userMsg != null) {
            alert(userMsg);
            return false;
        ...
        return false;
           ...
           // document.getElementById('txtBalanceDue').value = ((document.getElementById('hdnAmountDue').value) - (document.getElementById('txtReceivedDue').value)).toFixed(2);
    }
    function calculateDue1() {
        document.getElementById('txtReceivedDue').value = parseFloat(document.getElementById('txtReceivedDue').value).toFixed(2);
        document.getElementById('txtBalanceDue').value = ((document.getElementById('hdnAmountDue').value) - (document.getElementById('txtReceivedDue').value)).toFixed(2);
    }
                        ...
                        <table border="0" cellpadding="2" cellspacing="1" width="100%">
                                ...
                                <td width="600px" style="font-size: 11px;">
                                    ...
                                    <asp:Table CellPadding="4" CssClass="colorforcontentborder" CellSpacing="0" BorderWidth="0"
                                        ...
                                        <asp:TableRow ID="trReceivedDue" runat="server">
                                            ...
                                            <asp:TableCell HorizontalAlign="right">
                                                <input type="text" id="txtReceivedDue" onblur="javascript:calculateDue1();" runat="server"
                                                      onkeypress="return ValidateOnlyNumeric(this);"   value="0.00" style="width: 75px; text-align: right;
                                                    border-color: #d8d8d8; background-color: #efefef; border-style: solid;" />
                                            </asp:TableCell>
                                        </asp:TableRow>
                                        <asp:TableRow ID="trBalanceDue" runat="server">
                                            ...
                                            <asp:TableCell HorizontalAlign="right">
                                                <input type="text" id="txtBalanceDue" runat="server" readonly="readonly"   onkeypress="return ValidateOnlyNumeric(this);"  
                                                    value="0.00" style="width: 75px; text-align: right; border-color: #d8d8d8; background-color: #efefef;
                                                    border-style: solid;" />
                                            </asp:TableCell>
                                        </asp:TableRow>
                                    </asp:Table>
                            ...
                            <tr>
                                <td align="left" style="padding-left: 130px;">
                                    ...
                                    <asp:Button ID="btnCancel" ToolTip="Click here to View Home Page" Style="cursor: pointer;"
                                        runat="server" Text="Home" CssClass="btn" onmouseover="this.className='btn btnhov'"
                                        onmouseout="this.className='btn'" OnClick="btnCancel_Click" />
                                    <asp:Button ID="btnDueCollection" ToolTip="Click here to Collect the Due Amount"
                                        Style="cursor: pointer;" runat="server" Visible="true" Text="Collect Due" CssClass="btn"
                                        onmouseover="this.className='btn btnhov'" onmouseout="this.className='btn'" OnClientClick="javascript:return calculateDue();"
                                        OnClick="btnDueCollection_Click" />
                                </td>
                            </tr>
                        </table>
                    </div>
