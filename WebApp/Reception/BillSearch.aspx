                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tr id="aRow" runat="server" visible="false">
                                <td class="defaultfontcolor">
                                    ...
                                    <asp:Button ID="bGo" runat="server" Text="Go" OnClick="bGo_Click" Style="cursor: pointer;"
                                        CssClass="btn" OnClientClick="return pBillValidation()" ToolTip="Click here to Proceed"
