<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangePriority.aspx.cs" Inherits="Reception_ChangePriority" %>
...
<body oncontextmenu="return false;" runat="server">
    ...
    <div id="wrapper">
        ...
        <tr id="priorityBlock" runat="server" style=" display:block;">
        <td align="left" valign="middle" style="padding-bottom:10px; padding-top:10px;">
        <asp:Label ID="lblPriorityChange" runat="server" Font-Bold="true" Font-Size="12px" >Select To Change Priority</asp:Label>
        <asp:DropDownList ID="ddlPriority" ToolTip="Select here to Change the Work Order Priority" TabIndex="3" runat="server"></asp:DropDownList>
        </td>
        </tr>
        ...
        <tr>
            ...
            <asp:Button ID="btnCancel" runat="server" ToolTip="Click here to View the Home Page" style="cursor:pointer;" Text="Home" CssClass="btn" onmouseover="this.className='btn btnhov'"
                    onmouseout="this.className='btn'" OnClick="btnCancel_Click" />
                    &nbsp;&nbsp;
                   
              <asp:HyperLink ID="hypLnkPrint" Font-Bold="true" Visible="false" Font-Size="12px"  ForeColor="#000000" Target="BillWindow" runat="server" ><u>Print Bill</u></asp:HyperLink> 
               <asp:Button ID="btnChangePriority" runat="server" Visible="true" ToolTip="Click here to Change the Work Order Priority" style="cursor:pointer;" Text="Change Priority" CssClass="btn" onmouseover="this.className='btn btnhov'"
onmouseout="this.className='btn'" OnClientClick="javascript:return confirm('Are you sure wish to the Priority?');" OnClick="btnChangePriority_Click" />
               </td>
        </tr>
    </table>
  </div>
