<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HistoSampleCollection.aspx.cs" Inherits="Lab_HistoSampleCollection" meta:resourcekey="PageResource1" %>
...
//            date1 = new Date(yr1, mon1, dt1);
    ...
    <script type="text/javascript">
        ...
        function DDLAction() {
            ...
            else if ($('#ddlAction :selected').val() == 'Reject_Sample_SampleSearch') {
                $('#ddlReason').show();
                $('#txtNewBarcode').hide();
                $('#TxtAliquot').hide();
                $("#linkBarcodeLayerGenerate").hide();
            ...
            <table cellpadding="2" class="searchPanel w-100p" cellspacing="2" border="0">
                ...
                <tr runat="server" id="IDColors">
                                        ...
                                        <asp:TextBox ID="txtAuto" Enabled="false" runat="server" Width="10px" Height="10px" style="background-color:Green"></asp:TextBox>
                                            <asp:Label ID="lblAutoColor" Text="Barcode" runat="server" ></asp:Label>
                                        <asp:TextBox ID="txtblocks" Enabled="false" runat="server" Width="10px" Height="10px" style="background-color:Black"></asp:TextBox>
                                            <asp:Label ID="lblblockcolor" runat="server" Text="Block" meta:resourcekey="lblPanicColorResource1"></asp:Label>
                                            <asp:TextBox ID="txtSlides" Enabled="false" runat="server" Width="10px" Height="10px" style="background-color:Orange"></asp:TextBox>
                                            <asp:Label ID="lblslidescolor" Text="Slide" runat="server" meta:resourcekey="lblreferencecolorResource1"></asp:Label>
                                        </td>
