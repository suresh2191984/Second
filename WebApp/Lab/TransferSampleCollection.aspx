<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransferSampleCollection.aspx.cs"
    Inherits="Lab_TransferSampleCollection" EnableEventValidation="false" meta:resourcekey="PageResource1" %>
...
function validate()
{
 var ddlMultiRoleUser = document.getElementById("ddlMultiRoleuser");
                if (ddlMultiRoleUser.options[ddlMultiRoleUser.selectedIndex].value == '0') {
                   alert('Please Select Sample Collected Person');
                    return false;
}
}
//        $(function() {
                                ...
                                <table cellpadding="2" class="dataheaderInvCtrl w-100p" cellspacing="2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:DropDownList CssClass="ddlsmall" ID="ddlcontname" runat="server" Style="display: none"
                                               >
                                            </asp:DropDownList>
                                        </td>
                                        <td class="a-left">
                                     ...
                                     <tr >
                                        <td style="display:none" class="a-left">
                                            <asp:Label ID="lblLocationn" runat="server" Text="Location" meta:resourcekey="lblLocationResource123"></asp:Label>
                                        </td>
                                        <td style="display:none">
                                            <asp:DropDownList ID="ddlLocationn" runat="server" meta:resourcekey="ddlLocationResource123"
                                                                CssClass="ddlsmall" >
                                                              
                                                            </asp:DropDownList>
                                        </td>
                                        <td class="a-left">
                                            <asp:Label ID="lblCollectedname" runat="server" Text="Transfered&nbsp;Collected Name"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:DropDownList ID="ddlMultiRoleuser" Width="130px" runat="server" normalWidth="130px"
                                                onchange="onGetUsersByRole();">
                                            </asp:DropDownList>
                                            <asp:HiddenField ID="hdnMultiRoleUser" runat="server" />
                                        </td>
                                        </tr>
                                    <tr>
                                                ...
                                                <table class="w-100p">
                                                        ...
                                                        <td>
                                                            <asp:GridView ID="grdSample" runat="server" AutoGenerateColumns="False" Height="12%"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="SampleCollectedPerson" HeaderText="Sample Collected Person"
                                                    ...
                                                    <tr id="GrdFooter" runat="server" class="dataheaderInvCtrl">
                                                        <td align="center" colspan="10" class="defaultfontcolor">
                                                            ...
                                                            <asp:Label ID="Label5" runat="server" Text="Of" ></asp:Label>
