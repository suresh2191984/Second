<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvestigationResultDeflagging.aspx.cs"
    Inherits="Lab_InvestigationResultDeflagging" meta:resourcekey="PageResource1" %>
...
//                }
        ...
        function Cleartxt() {
            ...
            else if ($('#grdResult tr:not(:first)').find('input[type="checkbox"]:checked').length == 0) {
        ...
        function DropCheck(ddlLocID, chkSelID) {
            ...
            //Row wise Checkbox select will select once it will be enabled otherwise it will not selected
            var ChkboxEnabled = document.getElementById(chkSelID);
            if (ChkboxEnabled.disabled != true && !ChkboxEnabled.disabled) {
    ...
    function SelectheaderCheckboxes(headerchk) {
        ...
        if (headerchk.checked) {
            for (i = 0; i < gvcheck.rows.length; i++) {
                ...
                /* BEGIN | NA | Sabari | 03032019 | Created | InvestigationResultDeflagging */
                /*While select All select only enabled Checkbox's only not all check boxes*/
                if (inputs[0].disabled != true && !inputs[0].disabled) {
    ...
    <div class="contentdata">
        ...
        <div runat="server" id="dInves" style="display: none;">
            <asp:Table CssClass="font11 w-100p colorforcontentborder" runat="server" ID="dispTab"
                ...
                <asp:TableRow ID="tblReferred" runat="server" CssClass="h-15" meta:resourcekey="tblReferredResource1" Visible="false">
                ...
                <asp:TableRow ID="TableRow1" runat="server" meta:resourcekey="TableRow1Resource1" Visible="false">
                            ...
                            <Columns>
                               ...
                               <HeaderTemplate>
                                ...
                                <asp:TemplateField HeaderText="Role">
                                    <ItemTemplate>
                                        <asp:DropDownList ID="ddlRole" runat="server" CssClass="ddlsmall" ToolTip="Select Role">
                                        </asp:DropDownList>
                                    </ItemTemplate>
                                </asp:TemplateField>
