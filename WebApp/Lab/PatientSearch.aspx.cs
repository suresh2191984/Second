...
public partial class Nurse_PatientSearch : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            returnCode = nurseBL.GetActionsIsTrusterdOrg(RoleID, OP, out lstActionMaster); //returnCode = nurseBL.GetSearchActions(RoleID, OP, out pages);
    ...
    protected void bGo_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //Response.Redirect(Request.ApplicationPath + dList.SelectedValue + "?PID=" + pid.ToString());
