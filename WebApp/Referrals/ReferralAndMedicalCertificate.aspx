<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReferralAndMedicalCertificate.aspx.cs"
    Inherits="Referrals_ReferralAndMedicalCertificate" meta:resourcekey="PageResource1" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function avoiddoubleentry() {
            ...
            if (TemplateType == "Referral") {
                if (document.getElementById('ddlReferingOrg').value == 0) {
        ...
        function Validation() {
            ...
            if (document.getElementById("hdnIstrustedOrg").value == "N") {
                ...
                if (TemplateType == "Referral") {
                    ...
                    if (document.getElementById("txtReferingOrg").value == "") {
                        document.getElementById('txtReferingOrg').focus();
                alert('Provide the Organization referred to ');
                        return false;
                    }

                    if (document.getElementById("txtRefToPhy").value == "") {
                    ...
                    <div class="contentdata">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <table cellspacing="0" border="0" width="100%" style="display: none;" id="TbTrustedOrg"
                                    runat="server">
                                    <tr runat="server">
                                        <td runat="server">
                                            <table cellpadding="4" cellspacing="0" border="0" width="100%" runat="server" style="display: none;"
                                                id="TbRefCF">
                                                <tr runat="server">
                                                    <td style="width: 140px;" runat="server">
                                                ...
                                                <tr id="TrTrustedReffOrg" style="display: none;" runat="server">
                                                    ...
                                                    <td style="width: 500px" runat="server">
                                            ...
                                            <table cellpadding="4" cellspacing="0" border="0" width="100%" id="tbfckreferrelNotes"
                                                ...
                                                <tr runat="server">
                                                    <td align="center" runat="server">
                                                        ...
                                                        <asp:Button ID="btnSave" runat="server" Text="More Referral Letter" Width="130px"
