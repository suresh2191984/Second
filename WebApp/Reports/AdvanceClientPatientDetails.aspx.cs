...
public partial class Reports_AdvanceClientPatientDetails : BasePage
{
    List<AdvanceClientDetails> lstCollectionsHistory = new List<AdvanceClientDetails>();
    public Reports_AdvanceClientPatientDetails()
        : base("Reports\\AdvanceClientPatientDetails.aspx")
    {
    }
    ...
    public void loadGrid(int GridPageNo, int GridPageSize)
    {
        try
        {
            ...
            returnCode = patientBL.SearchAdvancePatientDetails(OrgID, ClientID, type, fromdate, todate, GridPageNo, GridPageSize, out lstCollectionsHistory);
    ...
    public void ExportToExcel(Control ctr)
    {
        try
        {
            ...
            prefix = "Client Wise Advance Patient Reports_";
            ...
            oHtmlTextWriter.WriteLine("<span style='font-size:14.0pt; color:#538ED5;font-weight:700;'>Client Wise Advance Patient Reports </span>");
