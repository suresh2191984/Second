...
public partial class Reports_InvestigationStockUsage :BasePage
{

    public Reports_InvestigationStockUsage()
        : base("Reports_InvestigationStockUsage_aspx")
    {
    }
	
    SharedInventory_BL inventoryBL;
    Investigation_BL invbal;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        invbal = new Investigation_BL(base.ContextInfo);
        if (!IsPostBack)
        {
    ...
    public void LoadDeviceUsageProduct()
    {
        ...
        try
        {
            ...
            invbal.GetProductUsage(OrgID, ILocationID, fromdate, todate, Location, DeviceName, InvestigationName, ProductName, DeviceID, out lsttotalInvest1, out lstCategories, out lstLocations);
