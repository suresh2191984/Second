...
public partial class Reports_RollingAdvanceClientDetailsWithDate : BasePage
{
    ...
    public Reports_RollingAdvanceClientDetailsWithDate()
        : base("Reports\\RollingAdvanceClientDetailsWithDate.aspx")
    {
    }
        ...
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                */ 
                ...
                /*returnCode = patientBL.SearchRollingAdvanceClientDetailsWithDate(OrgID, ClientID, currentPageNo, PageSize, out lstCollectionsHistory, out lstRefundistory);*/
                ...
                if (lstChildAdvanceCollection.Count > 0)
                {
                ...
                if (lstChildAdvanceRefund.Count > 0)
                {
    ...
    protected void loadInitialClientDatas()
    {
        ...
        try
        {
            ...
            objapdBL.pGetClientDepositDetailsSummaryWithDate(lstClientID, OrgID, fromdate, todate, out lstRollingAdvance, out lstCollectionsHistory, out lstRefundistory);
