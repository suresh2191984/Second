<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OperationTheatre.aspx.cs"
    Inherits="Reports_OperationTheatre" meta:resourcekey="PageResource1" %>
                    ...
                    <div class="contentdata1">
                        ...
                        <table id="tblICDreport" align="center">
                            <tr align="left">
                                <td>
                                    <div class="dataheaderWider">
                                        <table id="tbl">
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:RadioButtonList ID="rblReportType" Visible="False" RepeatDirection="Horizontal"
                                    ...
                                    <asp:UpdatePanel ID="updatePanel1" runat="server">
                                        <ContentTemplate>
                                            <div id="prnReport">
                                            <asp:Label ID="lblOTReport" runat="server" Text="Operation Theatre Report :" Font-Bold="true" Visible="false" Font-Underline="true"></asp:Label>
                                                <asp:GridView ID="grdresult" runat="server" AutoGenerateColumns="False" Width="100%"
                                                    EmptyDataText="No Records Found" CssClass="mytable1">
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Room/BedName">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Ward Name">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblRoomType" runat="server" Text='<%# Bind("WardName") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="DOA" meta:resourcekey="TemplateFieldResource12">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblDOA" runat="server" Text='<%# Bind("DOA","{0:dd/MM/yyyy}") %>'
                                                        ...
                                                        <asp:BoundField HeaderText="From DateTime" DataFormatString="{0:dd/MM/yyyy hh:mm tt}" DataField="FromDate" />
                                                        <asp:BoundField HeaderText="To DateTime" DataFormatString="{0:dd/MM/yyyy hh:mm tt}" DataField="ToDate" />
                            ...
                            <tr id="GrdFooter" runat="server" style="display: none" class="dataheaderInvCtrl">
                                ...
                                <asp:TextBox ID="txtpageNo" runat="server" CssClass="Txtboxverysmall" Height ="15px" Width ="30px"   onkeypress="return ValidateOnlyNumeric(this);"  ></asp:TextBox>
