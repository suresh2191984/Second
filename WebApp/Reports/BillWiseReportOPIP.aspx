<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BillWiseReportOPIP.aspx.cs"
    Inherits="Reports_BillWiseReportOPIP" meta:resourcekey="PageResource1" %>
                                            ...
                                            <div id="divOPDWCR" runat="server" style="display: none;">
                                                <div id="prnReport">
                                                    <asp:GridView ID="gvIPReport" runat="server" AutoGenerateColumns="False" Visible="False"
                                                        Width="850px" OnRowDataBound="gvIPReport_RowDataBound" 
                                                                            ...
                                                                            <td>
                                                                                <asp:GridView ID="gvIPCreditMain" runat="server" AutoGenerateColumns="False" Width="100%"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:BoundField DataField="NetValue" HeaderText="Net Amt" 
                                                                                            meta:resourcekey="BoundFieldResource10" >
                                                                                            <ItemStyle HorizontalAlign="Right" />
                                                                                        </asp:BoundField>
                                                                                        <asp:BoundField DataField="ReceivedAmount" HeaderText="Rcvd Amt" 
                                                                                        ...
                                                                                        <asp:BoundField DataField="DD" HeaderText="Drafts" 
                                                                                            meta:resourcekey="BoundFieldResource15" >
                                                                                            <ItemStyle Width="25px" />
                                                                                        </asp:BoundField>
                                                                                        <asp:BoundField DataField="Due" HeaderText="Bill Due" 
                                                                                            meta:resourcekey="BoundFieldResource16" >
                                                                                            <ItemStyle HorizontalAlign="Right" />
                                                                                        </asp:BoundField>
                                                                                        <asp:BoundField DataField="IPAdvance" HeaderText="ADV" 
                                                                                        ...
                                                                                        <asp:BoundField DataField="PaidCurrencyAmount"
                                                                                            HeaderText="Paid Currency Amt" meta:resourcekey="BoundFieldResource20" >
                                                                                            <ItemStyle HorizontalAlign="Right" />
                                                                                        </asp:BoundField>
                                                                                    </Columns>
