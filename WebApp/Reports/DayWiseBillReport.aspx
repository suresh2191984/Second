<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DayWiseBillReport.aspx.cs"
    Inherits="Reports_DayWiseBillReport" meta:resourcekey="PageResource1" %>
                        ...
                        <table width="100%">
                            <tr style="width: 100%">
                                <td style="width: 35%" valign="top">
                                    ...
                                    <asp:TextBox ID="txtFrom" runat="server" MaxLength="1" Style="text-align: justify"  CssClass ="Txtboxsmall"
                                        TabIndex="3" ValidationGroup="MKE"  meta:resourcekey="txtFromResource1" />
                                ...
                                <td style="width: 30%" valign="top">
                                    ...
                                    <asp:TextBox ID="txtTo" runat="server" MaxLength="1" Style="text-align: justify" CssClass ="Txtboxsmall"
                                        TabIndex="4" ValidationGroup="MKE" meta:resourcekey="txtToResource1" />
                                ...
                                <td align="left" valign="top" style="width: 10%">
                                    <asp:CheckBox ID="chkTodayDate" Text="ToDay" runat="server" meta:resourcekey="chkTodayDateResource1" />
                                </td>
                                <td align="left" valign="top" style="width: 15%">
                                    <asp:Button ID="btnGo" runat="server" Text="Go" CssClass="btn" Height="23px" Width="43px"
                                        onmouseover="this.className='btn btnhov'" onmouseout="this.className='btn'" meta:resourcekey="btnGoResource1" />
                                </td>
