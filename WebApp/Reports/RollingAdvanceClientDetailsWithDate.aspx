<%@ Page EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeFile="RollingAdvanceClientDetailsWithDate.aspx.cs"
    Inherits="Reports_RollingAdvanceClientDetailsWithDate" meta:resourcekey="PageResource1" %>
                    ...
                    <div class="defaultfontcolor">
                        <asp:Panel ID="pnlPSearch" runat="server" GroupingText="Search for Rolling Advance Summary"
                            ...
                            <table width="100%" border="0" cellpadding="2" cellspacing="0" class="dataheader3">
                                <tr>
                                    <td>
                                        <asp:Label ID="Label1" Text="From Date :" runat="server" meta:resourcekey="Rs_FromDateResource2"></asp:Label>
                                        <asp:TextBox ID="txtFromDate" runat="server" CssClass="Txtboxsmall" TabIndex="1"
                                            onblur="javascript:return checkDate1(this);" ></asp:TextBox>
                                    ...
                                    <td>
                                        <asp:Label ID="Label2" Text="To Date:" runat="server" meta:resourcekey="Rs_ToDateResource2"></asp:Label>
                                                ...
                                                <asp:TemplateField HeaderText="Collection Report">
                                                    <ItemTemplate>
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                          ...
                                                          <%-- <tr>
                                                                <td align="left" >
                                                                    <asp:Label runat="server" visible="false" ID="lblClientNamee" Text="Client Name :"></asp:Label>
                                                                    <asp:Label runat="server" visible="false" ID="lblClientNameee" Text='<%# DataBinder.Eval(Container.DataItem, "ClientName") %>'></asp:Label>
                                                                    &nbsp;&nbsp;
                                                                    <asp:Label runat="server" visible="false" ID="lblDeposited" Text="Total Deposit Amount :"></asp:Label>
                                                                    <asp:Label runat="server" visible="false" ID="lblAmountDeposited" Text='<%# DataBinder.Eval(Container.DataItem, "AmountDeposited") %>'></asp:Label>
                                                                    &nbsp;&nbsp;
                                                                    <asp:Label runat="server" visible="false" ID="lblTotalDepositUsed" Text="Total Used Amount :"></asp:Label>
                                                                    <asp:Label runat="server" visible="false" ID="lblAmountUsed" Text='<%# DataBinder.Eval(Container.DataItem, "AmountUsed") %>'></asp:Label>
                                                                    &nbsp;&nbsp;
                                                                    <asp:Label runat="server" visible="false" ID="lblAmtRefund" Text="Total Refund Amount :"></asp:Label>
                                                                    <asp:Label runat="server" visible="false" ID="lblRefundAmount" Text='<%# DataBinder.Eval(Container.DataItem, "RefundAmount") %>'></asp:Label>
                                                                    <asp:Label runat="server" visible="false" ID="lblAvlBalance" Text="Total Available Balance :"></asp:Label>
                                                                    <asp:Label runat="server" visible="false" ID="lblAvailableBalance" Text='<%# DataBinder.Eval(Container.DataItem, "AvailableBalance") %>'></asp:Label>
                                                                </td>
                                                            </tr>--%>
                                                        </table>
                                                    </ItemTemplate>
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                  ...
                                                  <%--  <tr>
                                                        <td align="left">
                                                            ...
                                                            <asp:Label runat="server" ID="lblDeposited" visible="false" Text="Total Deposit Amount :"></asp:Label>
                                                            <asp:Label runat="server" ID="lblAmountDeposited" visible="false" Text='<%# DataBinder.Eval(Container.DataItem, "AmountDeposited") %>'></asp:Label>
                                                            &nbsp;&nbsp;
