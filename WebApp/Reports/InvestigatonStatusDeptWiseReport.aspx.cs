...
public partial class Reports_InvestigatonStatusDeptWiseReport : BasePage
{
    long returnCode = -1;
    List<InvestigatonStatusDeptWiseReport> lstDWR = new List<InvestigatonStatusDeptWiseReport>();
    ...
    public void LoadGrid()
    {
        try
        {
            ...
            long ClientID = 0;
            returnCode = new ReportBusinessLogic.ReportExcel_BL(base.ContextInfo).GetInvestigatonStatusDeptWiseReport(strBillFromDate, strBillToDate, ClientID, CountryID, out lstDWR);
            grdResult.Width = 700;
            grdResult.Visible = true;
            grdResult.DataSource = lstDWR;
            grdResult.DataBind();
    ...
    protected void btnPrintAll_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            sb.Append(",top=0,width=728,height=600,status=0,scrollbars=1');");
    ...
    protected void btnSendMailReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string str = "Investigation Status Department Wise Report";
    ...
    protected void grdResult_RowDataBound(Object sender, GridViewRowEventArgs e)
    {
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Font.Size = 8;
                Label lnkFeeDescription = (Label)e.Row.FindControl("lnkDept");
        ...
        {
            CLogger.LogError("Error while Loading Investigationstatusdeptwise Details", Ex);
        }
