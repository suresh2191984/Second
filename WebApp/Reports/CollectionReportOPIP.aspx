<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CollectionReportOPIP.aspx.cs"
    Inherits="Reports_CollectionReportOPIP" meta:resourcekey="PageResource1" %>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:RadioButtonList ID="rblVisitType" RepeatDirection="Horizontal" RepeatColumns="3"
                                                        ...
                                                        <%--<asp:ListItem Text="Other Source" Value="2"></asp:ListItem>
                                            ...
                                            <tr>
                                                <td align="right" style="padding-right: 10px; color: #000000;">
                                                    <b id="printText" runat="server">
                                                        ...
                                                        <img alt="Print Report" id="btnPrint" src="../Images/printer.gif" onclick="return popupprint();" meta:resourcekey="btnPrintResource1" style="cursor:pointer;" />
                                            ...
                                            <div id="divOPDWCR" runat="server" style="display: none;">
                                                <div id="prnReport">
                                                    ...
                                                    <asp:GridView ID="gvIPCreditMainGrandTotal" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            <asp:BoundField DataField="patientID" Visible="False" HeaderText="Patient ID" meta:resourcekey="BoundFieldResource1">
                                                            ...
                                                            <asp:BoundField DataField="PreviousDue" DataFormatString="{0:0.00}" 
                                                                HeaderText="Acc Due" Visible ="False" 
                                                               meta:resourcekey="BoundFieldResource7">
                                                                <ItemStyle HorizontalAlign="Right" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="CreditDue" DataFormatString="{0:0.00}" 
                                                                            ...
                                                                            <td>
                                                                                <asp:GridView ID="gvIPCreditMain" runat="server" AutoGenerateColumns="False" Width="100%"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:BoundField DataField="PreviousDue" HeaderText="Acc Due" 
                                                                                            DataFormatString="{0:0.00}" Visible ="False" 
                                                                                            meta:resourcekey="BoundFieldResource30">
                                                                                            <ItemStyle HorizontalAlign="Right"  />
                                                                                        </asp:BoundField>
                                                                                        <asp:BoundField DataField="CreditDue" HeaderText="Credit Due" 
                                                                                            DataFormatString="{0:0.00}" Visible ="False" 
