<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeptRevenueDetails.aspx.cs"
    Inherits="Reports_DeptRevenueDetails" meta:resourcekey="PageResource1" %>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="gvCollReport" runat="server" AutoGenerateColumns="False" Visible="False"
                                                        Width="100%" OnRowDataBound="gvCollReport_RowDataBound" 
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                        <tr>
                                                                            <td align="left" style="height: 25px;">
                                                                                <b>
                                                                                    <asp:Label ID="Rs_Department" Text="Department:" runat="server" 
                                                                                ...
                                                                                <asp:GridView ID="gvCollIndDept" runat="server" AutoGenerateColumns="False" Width="650px"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:BoundField DataField="ConsultantName"
                                                                                            HeaderText="Description" meta:resourcekey="BoundFieldResource4" >
                                                                                        ...
                                                                                        <asp:BoundField DataFormatString="{0:N0}" DataField="ItemQuantity"
                                                                                            HeaderText="Quantity" meta:resourcekey="BoundFieldResource5" >
                                                                                            <ItemStyle HorizontalAlign="Right" />
                                                                                        </asp:BoundField>
                                                                                        <asp:BoundField DataFormatString="{0:0.00}" DataField="BilledAmount"
                                                                                            HeaderText="BilledAmount" meta:resourcekey="BoundFieldResource6" >
                                                                                            <ItemStyle HorizontalAlign="Right" />
                                                                                        </asp:BoundField>
                                                    ...
                                                    <table id="tblgvCollIndDeptS" runat="server" visible="False" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr runat="server">
                                                            <td align="left" style="height: 25px;" runat="server">
                                                                <b>
                                                                    <asp:Label ID="Rs_Department" Text="Department:" runat="server"></asp:Label></b>
                                                                <asp:Label ID="lblFeeType" runat="server"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr runat="server">
                                                            <td runat="server">
                                                                <asp:GridView ID="gvCollIndDeptS" runat="server" AutoGenerateColumns="False" Width="650px"
                                                    ...
                                                    <table>
                                                        <tr>
                                                            <td width="85%" align="right">
                                                                <b>
                                                                    <asp:Label runat="server" ID="lblGrdTot" 
                                                                    meta:resourcekey="lblGrdTotResource1"></asp:Label>
                                                                </b>
                                                            </td>
                                                        </tr>
                                                    </table>
