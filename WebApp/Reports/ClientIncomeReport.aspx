<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClientIncomeReport.aspx.cs"
    Inherits="Reports_ClientIncomeReport" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
...
<head id="Head1" runat="server">
    ...
    <title>Client Income Report</title>
                            ...
                            <table width="100%">
                                <tr>
                                    <td style="width: 17%">
                                        ...
                                        <asp:DropDownList ID="ddlOrganization" Width="170px" runat="server" CssClass="ddl"
                                            AutoPostBack="True">
                                        </asp:DropDownList>
                                    </td>
                                    <td id="Td1" runat="server" style="width: 16%">
                                    ...
                                    <td style="width: 16%">
                                        ...
                                        <asp:TextBox runat="server" ID="txtFromDate" Width="170px" MaxLength="10" size="25"
                                        ...
                                        &nbsp;<asp:Image runat="server" ID="ImgBntCalc" ImageUrl="~/Images/Calendar_scheduleHS.png"
                                            Width="16px" Height="16px" border="0" Style="vertical-align: bottom;" alt="Pick from date"
                                    ...
                                    <td style="width: 16%">
                                        ...
                                        <asp:TextBox runat="server" ID="txtToDate" Width="170px" MaxLength="10" CssClass="Txtboxsmall"
                                    ...
                                    <td style="width: 6%">
                                        <asp:Button runat="server" Visible="true" ID="btnGo" Text=" Go " CssClass="btn" TabIndex="6"
                                            onmouseover="this.className='btn btnhov'" onmouseout="this.className='btn'" OnClick="btnGo_Click"
                                            OnClientClick="javascript:return Validate()" meta:resourcekey="btnGoResource1" />
                                        ...
                                        &nbsp;
                                        <asp:Button ID="btnCancel" runat="server" Visible="false" Text="Reset" CssClass="btn"
                                        ...
                                        <asp:ImageButton ID="imgBtnXL" runat="server" ImageUrl="../Images/ExcelImage.GIF"
                                            ToolTip="Save As Excel" Style="vertical-align: bottom; height: 16px;" OnClick="imgBtnXL_Click"
                                ...
                                <table cellpadding="2" class="defaultfontcolor" style="color: Black; font-family: Verdana;
                                    ...
                                    <tr>
                                        <td valign="top" class="dataheader2" nowrap="nowrap">
                                            <asp:GridView ID="grdResult" runat="server" EmptyDataText="No Results Found." AutoGenerateColumns="true"
                                                CellPadding="4" CssClass="mytable1" Width="100%" meta:resourcekey="grdResultResource1">
