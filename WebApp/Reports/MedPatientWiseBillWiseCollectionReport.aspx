<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MedPatientWiseBillWiseCollectionReport.aspx.cs"
    Inherits="Reports_MedPatientWiseBillWiseCollectionReport" meta:resourcekey="PageResource1" %>
            ...
            <tr>
                ...
                <td width="85%" valign="top" class="tdspace">
                    ...
                    <div class="contentdata">
                        <ul>
                            <li class="dataheader">Patient-Wise Bill-Wise Collection Details</li>
                        </ul>
                        <ul>
                            <li>
                                            ...
                                            <div id="divOPDWCR" runat="server" style="display: block;">
                                                <div id="prnReport" style="font-family: Arial; text-decoration: none; font-size: 10px;">
                                                    <asp:GridView ID="gvIPReport" runat="server" AutoGenerateColumns="False" Visible="False"
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:GridView ID="gvDescription" Width="100%" GridLines="None" ShowHeader="False"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:BoundField HeaderText="BilledAmt" DataField="BilledAmount" 
                                                        ...
                                                        <asp:BoundField HeaderText =" BilledAmount" DataField ="BilledAmount" />
                                                        <asp:BoundField HeaderText ="DiscountAmount" DataField ="Discount" />
                                                            ...
                                                            <asp:BoundField HeaderText ="DueAmount" DataField ="Due" />                                                          
                                                              <asp:BoundField HeaderText ="DepositUsed" DataField ="DepositUsed" />
