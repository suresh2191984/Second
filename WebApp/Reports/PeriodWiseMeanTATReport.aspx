<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PeriodWiseMeanTATReport.aspx.cs"
    Inherits="Reports_PeriodWiseMeanTATReport" %>
...
<head id="Head1" runat="server">
    <title>PeriodWise MeanTAT Report</title>
            ...
            <ContentTemplate>
                <table id="tblCollectionOPIP" align="center" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td>
                            <div>
                                <table id="tblPatient" runat="server" class="w-50p" border="0" cellpadding="0" cellspacing="0">
                                    <tr id="Tr1" runat="server">
                                        <td id="Td1" align="left" runat="server" class="w-100p">
                                            <div style="display: block">
                                                <table class="w-100p searchPanel" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox Width="125px" ID="txtFrom" CssClass="Txtboxsmall" runat="server" onkeydown="return DateFormat(this, event.keyCode)"></asp:TextBox>
                                                        ...
                                                        <td>
                                                            <asp:Button ID="Button1" runat="server" CssClass="btn" OnClick="btnSearch_Click"
                                                                ...
                                                                onmouseover="this.className='btn btnhov'" Text="Tests" />
                                                            &nbsp;&nbsp;
                                                            <asp:Button ID="btnProfile" runat="server" CssClass="btn" OnClientClick="return CheckPatientSearch();"
                                                                onmouseout="this.className='btn'" onmouseover="this.className='btn btnhov'" Text="Profile"
                ...
                <asp:Panel ID="pnl" runat="server" ScrollBars="Vertical" Style="width: 55%; height: 500px;"
                    Visible="false">
                    <asp:GridView ID="grdResult" runat="server" CellPadding="4" AlternatingRowStyle-CssClass="trEven"
                        AutoGenerateColumns="False" OnRowDataBound="grdResult_RowDataBound" ForeColor="#333333"
                        CssClass="gridView w-50p" EmptyDataText="Periodwise MeanTAT Not Available">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Mins" HeaderText="Sum" Visible="false">
                                <HeaderStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" Width="5%" />
                            </asp:BoundField>
                            <asp:BoundField DataField="TotalHours" HeaderText="Mean TAT (Hrs)" Visible="false">
                                <HeaderStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" Width="7%" />
                            </asp:BoundField>
                            <asp:BoundField DataField="AvgHours" HeaderText="Mean TAT">
                                <HeaderStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" Width="7%" />
                            </asp:BoundField>
                        </Columns>
