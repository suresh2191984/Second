<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MicroStainPattern.ascx.cs"
    Inherits="Investigation_MicroStainPattern" %>
...
<script language="javascript" type="text/javascript">
    ...
    function AddStainResult(ddlStainType, txtStainResult, tblStainResult, divTblStainResult, ACEStainResult, txtOtherstaintype, divstaintype, GroupName, hdnSelectedRowIndex, ddlStatus) {
        var vType = SListForAppMsg.Get('Investigation_MicroStainPattern_ascx_01') == null ? "Select stain type\n" : SListForAppMsg.Get('Investigation_MicroStainPattern_ascx_01');
        var vResult = SListForAppMsg.Get('Investigation_MicroStainPattern_ascx_02') == null ? "Enter stain result\n" : SListForAppMsg.Get('Investigation_MicroStainPattern_ascx_02');
        ...
        try {
            ...
            if (!isRequiredMissing) {
                ...
                if (document.getElementById(btnAddStain).value == 'Update' && document.getElementById(hdnSelectedRowIndex).value >= 0) {
                    ...
                    tdStainResult.innerHTML = selectedStainResult;
                    var tdEdit = row.insertCell(2);
                    tdEdit.innerHTML = '<input id="btnEditStainResult" value="Edit" type="button" style="background-color: Transparent; color: Blue; border-style: none; text-decoration: underline; cursor: pointer; font-size: 11px;" onclick="onEditStainResult(this,\'' + hdnSelectedRowIndex + '\',\'' + ddlStainType + '\',\'' + txtStainResult + '\',\'' + txtOtherstaintype + '\',\'' + divstaintype + '\');" />';
    ...
    function LoadAllStainResult(hdnLstStainResultXML, tblStainResult, divTblStainResult, hdnSelectedRowIndex, ddlStainType, txtStainResult, txtOtherstaintype, divstaintype, ACEStainResult) {
        try {
    ...
    function onEditStainResult(obj, hdnSelectedRowIndex, ddlStainType, txtStainResult, txtOtherstaintype, divstaintype) {
        try {
    ...
    function onDeleteStainResult(obj, hdnSelectedRowIndex, ddlStainType, txtStainResult, txtOtherstaintype, divstaintype, ACEStainResult) {
        try {
    ...
    function onFocusStainResult(txtStainResult) {
        ...
        var vAddStain = SListForAppMsg.Get('Investigation_MicroStainPattern_ascx_03') == null ? "Add stain result" : SListForAppMsg.Get('Investigation_MicroStainPattern_ascx_03');
    ...
    function SaveMicroStainPatternDetails(hdnInvID, ctrlClientID) {
        try {
            var lstStainResult = [];
                    ...
                    <tr>
                        <td class="font11 h-20 w-19p" id="tdInvName" runat="server" style="font-weight: normal;
                            ...
                            <a id="ATag" runat="server" onclick="lnkEdit_OnClientClick(this.id);" style="color: red;"
                                visible="false"><u>
                                    <%=Resources.Investigation_ClientDisplay.Investigation_MicroPattern_ascx_01 %>
                                </u></a>
                        </td>
                        <td>
                            <table class="w-100p">
                                <tr>
                                    <td>
                                        ...
                                        <div id="divstaintype" class="paddingT10" runat="server" style="display: none;">
                                    ...
                                    <td>
                                        <asp:Button runat="server" ID="btnAddStain" Text="Add" onmouseover="this.className='btn btnhov'"
                                            onmouseout="this.className='btn'" CssClass="w-50 h-25 btn" 
                                            meta:resourcekey="btnAddStainResource1" />
                                    </td>
                                    <td>
                                        <asp:Button runat="server" ID="btnCancelStain" Text="Cancel" onmouseover="this.className='btn btnhov'"
                                            onmouseout="this.className='btn'" CssClass="w-50 h-25 btn" 
                                            Style="display: none;" meta:resourcekey="btnCancelStainResource1" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                                    ...
                                    <table id='tblStainResult' runat="server" class='dataheaderInvCtrl w-100p'>
                                        <thead>
                                            <tr class="colorforcontent h-20">
                                                <th class="font11 h-8 bold" style="color: White;">
                                                <asp:Label ID="thStainType" runat="server" Text="Stain Type" 
                                                    meta:resourcekey="thStainTypeResource1"></asp:Label>
                                                </th>
                                                <th class="font11 h-8 bold" style="color: White;">
                                                <asp:Label ID="thStainResult" runat="server" Text="Result" 
                                                    meta:resourcekey="thStainResultResource1"></asp:Label>
                                                </th>
                                                <th colspan="2" style="font-weight: bold; font-size: 11px; height: 8px; color: White; width: 10%;">
                                                <asp:Label ID="thStainAction" runat="server" Text="Action" 
                                                    meta:resourcekey="thStainActionResource1"></asp:Label>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
