...
public partial class Investigation_HEMATOLOGY : BaseControl
{
    public Investigation_HEMATOLOGY()
        : base("Investigation_HEMATOLOGY_ascx")
    {
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            btnAddStain.Attributes.Add("onclick", "return AddStainResult('" + ddlStainType.ClientID + "','" + txtStainResult.ClientID +"','" +txtRemarks.ClientID + "','" + tblStainResult.ClientID + "','" + divTblStainResult.ClientID + "','" + ACEStainResult.ClientID + "','" + txtOtherstaintype.ClientID + "','" + divstaintype.ClientID + "','" + GroupName + "','" + hdnSelectedRowIndex.ClientID + "',this.id);");
    ...
    public string CreateXML()
    {
        ...
        try
        {
            ...
            foreach (Dictionary<string, string> obj in lstStainResult)
            {
                ...
                xmlRemarks = xmlDoc.CreateAttribute("Remarks");
                xmlRemarks.Value = obj["Remarks"];
                xmlNodeStain.Attributes.Append(xmlRemarks);
        ...
        try
        {
            if (xmlTag != string.Empty)
            {
                ...
                if (lstStainDetails != null && lstStainDetails.Count > 0)
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "LoadStainXMLData" + this.ClientID, "LoadAllStainResult('" + hdnLstStainResultXML.ClientID + "','" + tblStainResult.ClientID + "','" + divTblStainResult.ClientID + "','" + hdnSelectedRowIndex.ClientID + "','" + ddlStainType.ClientID + "','" + txtStainResult.ClientID +"','" + txtRemarks.ClientID + "','" + txtOtherstaintype.ClientID + "','" + divstaintype.ClientID + "','" + ACEStainResult.ClientID + "');", true);
                }
            }
        }
        catch (Exception ex)
