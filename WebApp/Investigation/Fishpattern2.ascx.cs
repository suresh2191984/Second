...
public partial class Investigation_Fishpattern2 : BaseControl
{
    public Investigation_Fishpattern2()
        : base("Investigation_Fishpattern2_ascx")
    {
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //txtMedRemarks.Attributes.Add("onfocus", "javascript:setCompletedStatus('" + GroupName + "',this.id);");

        AutoGetAutoComments.ContextKey = ControlID.ToString() + "~" + GroupID.ToString() + "~" + orgID.ToString() + "~" + string.Empty;
        ...
        txtValue.Attributes.Add("onfocus", "javascript:setCompletedStatus('" + GroupName + "',this.id);");
       // txtMedRemarks.Attributes.Add("onfocus", "javascript:setCompletedStatus('" + GroupName + "',this.id);");
        //if (!IsPostBack)
        //{
        //    txtValue.Text = "Hb is normal.~Red cells are normochromic normocytic.~WBC count is normal with normal morphology.~Platelet appear adequate.~Normal blood film." ;
        //}
    ...
    public void loadStatus(List<InvestigationStatus> lstStatus)
    {
        ...
        {
            CLogger.LogError("Error while loading fishpattern2 status dropdown", ex);
        }
    }
    public InvestigationValues GetResult(long VID)
    {
        ...
        String[] status;
        //Changed By Arivalagan while Result is empty it should be allow
        //if (txtValue.Text != "")
        //{
