<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BulkEnterResult.aspx.cs"
    Inherits="Investigation_BulkEnterResult" EnableEventValidation="false" meta:resourcekey="PageResource1" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function BatchValidation() {
            ...
            try {
                ...
                if (ddlProtocol == '0' && ddlHeader == '0' && ddlDept == '0' && ddlDevice == '0' && ($('#txtFromVisitID').val() == "" || $('#txtFromVisitID').val() == "0") && ($('#txtToVisitID').val() == "" || $('#txtToVisitID').val() == "0") && ($('#txtWorkListID').val() == "" || $('#txtWorkListID').val() == "0") && ($('#txtInvestigationName').val() == "") && ($('#txtSampleID').val() == "" || $('#txtSampleID').val() == "0")) {
                                    ...
                                    <div id="DivSearchArea" class="filterdataheader2" style="display: block;">
                                        <table class="w-100p">
                                            <tr>
                                                ...
                                                <td class="w-10p a-right" id="tdlblProtocol" runat="server" style="display: none">
                                                    <asp:Label ID="lblProtocol" runat="server" class="style1" meta:resourcekey="lblProtocolResource1"
                                                        Text="Protocol Group"></asp:Label>
                                                </td>
                                                <td class="w-13p a-left" id="tddlProtocol" runat="server" style="display: none">
                                                    <span class="richcombobox">
                                            ...
                                            <tr>
                                                ...
                                                <td class="a-right" id="tdlblWorkListID" runat="server"  style="display: none">
                                                    <asp:Label ID="lblWorkListID" runat="server" class="style1" meta:resourcekey="lblWorkListIDResource1"
                                                        Text="WorkList ID"></asp:Label>
                                                </td>
                                                <td class="a-left" id="tdtxtWorkListID" runat="server" style="display: none">
                                           ...
                                           <tr>
                                           <td class="w-10p a-right" id="tdcolllocation" runat="server">
                                                    <asp:Label ID="lblcolllocation" runat="server" class="style1" meta:resourcekey="lblcolllocationResource1" 
                                                    Text="Collection Location"></asp:Label>
                                                </td>
                                                <td class="w-12p a-right" id="tdddlcolllocation"  runat="server">
                                                    <span class="richcombobox">
                                                        <asp:DropDownList ID="ddlCollelocation" runat="server" CssClass="ddlsmall" meta:resourcekey="ddlCollelocationResource1">
                                                        </asp:DropDownList>
                                                    </span>
                                                </td>
                                                <td colspan="10"></td>
                                            ...
                                            <%--<tr id="trUser" Visible="false" >
                                                <td class="w-10p a-right">
                                                    <asp:Label ID="lblUser" runat="server" Visible="false" class="style1" Text="User :"></asp:Label>
                                                </td>
                                                <td class="w-12p a-right">
                                                    <span class="richcombobox">
                                                        <asp:DropDownList ID="ddlUser" runat="server" Visible="false" CssClass="ddlsmall">
                                                        </asp:DropDownList>
                                                    </span>
                                                </td>
                                            </tr>--%>
