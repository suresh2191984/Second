...
public partial class Investigation_PatternMappingForInvestigation : BasePage
{
    ...
    public Investigation_PatternMappingForInvestigation()
        : base("Investigation_PatternMappingForInvestigation_aspx")
    {
    }
