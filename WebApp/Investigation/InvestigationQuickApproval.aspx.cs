...
public partial class Investigation_InvestigationQuickApproval : BasePage
{
    public Investigation_InvestigationQuickApproval()
        : base("Investigation_InvestigationQuickApproval_aspx")
    {
    }
