<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PTTPattern.ascx.cs" Inherits="Investigation_PTTPattern" %>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" class="defaultfontcolor">
    <tr>
        ...
        <td style="font-weight: normal; font-size: 11px; height: 20px; color: #000; width: 10%">
            <asp:Label runat="server" ID="lblControl" Text="Control PTT" meta:resourcekey="lblControlResource1"></asp:Label>
        </td>
        <td class="style1">
        ...
        <td style="font-weight: normal; font-size: 11px; height: 20px; color: #000; width: 10%">
            <asp:Label runat="server" ID="lblPatient" Text="Patient PTT" meta:resourcekey="lblPatientResource1"></asp:Label>
        </td>
        <td style="width: 7%">
            <asp:TextBox ForeColor="Black" Font-Bold="true" runat="server" onkeyup="javascript:return setCompletedStatus(this.id);"
            ...
            <table>
                ...
                <tr>
                    <td style="font-weight: normal; font-size: 10px; height: 40px; color: #000; width: 8%;">
                        <asp:TextBox ForeColor="Black" Font-Bold="true" runat="server" onkeyup="javascript:return setCompletedStatus(this.id);"
                            ID="txtRefRange" TextMode="MultiLine" CssClass="textbox_pattern" Height="90%"
        ...
        <td style="font-weight: bold; font-size: 10px; height: 40px; color: #000; width: 8%;">
            <table>
                ...
                <tr>
                    <td style="font-weight: normal; font-size: 10px; height: 40px; color: #000; width: 8%;">
                        <asp:TextBox ForeColor="Black" Font-Bold="true" runat="server" onkeyup="javascript:return setCompletedStatus(this.id);"
                            ID="txtReason" TextMode="MultiLine" CssClass="textbox_pattern" Height="80%" Width="122px"
                ...
                <tr>
                    <td style="font-weight: normal; font-size: 10px; height: 40px; color: #000; width: 8%;">
                        <asp:TextBox ForeColor="Black" Font-Bold="true" runat="server" ID="txtMedRemarks"
                            ...
                            CssClass="textbox_pattern" Height="84%" Width="122px"></asp:TextBox>
        ...
        <td style="width: 14%">
            <table>
                ...
                <tr>
                    <td>
                        <asp:DropDownList ForeColor="Black" ID="ddlstatus" runat="server" CssClass="ddl" TabIndex="-1" onChange="javascript:ShowStatusReason(this.id);"
