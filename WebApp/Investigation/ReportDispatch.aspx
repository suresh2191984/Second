<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportDispatch.aspx.cs" Inherits="Investigation_ReportDispatch"
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .tblrpt td{
        border: 1px solid #8babbf !important;
        border-collapse:collapse !important;
    ...
    <script type="text/javascript">
        ...
        function popupprint1() {
            ...
            var prtContent = document.getElementById('dvInvstigationDetailsprint');
            var cln = prtContent.cloneNode(true);
            prtContent = document.getElementById('dvInvstigationDetailsprint');
            ...
            // WinPrint.document.write(stl);
            WinPrint.document.write('<html>');
            WinPrint.document.write('<link href="../StyleSheets/Print.css"  rel="stylesheet" media="print,screen" type="text/css" />');
            WinPrint.document.write('</head><body onload="window.print();">')
            WinPrint.document.write(cln.innerHTML);
            WinPrint.document.write('</body></html>')
            //WinPrint.document.write(cln.innerHTML);
           //WinPrint.document.head.innerHTML = stl;
    ...
    <script type="text/javascript">
        ...
        function CheckPrint() {
			...
			//arun
                if (document.getElementById("ddlVisitActionName").value != "Save_PDF") {
...
<body id="oneColLayout">
        ...
        <Triggers>
            ...
            <ContentTemplate>
                <table id="tblPatient" runat="server" class="w-100p">
                                        ...
                                        <tr>
                                            <td class="w-100p" colspan="6">
                                                <table class="w-100p">
                                                    ...
                                                    <tr id="excel" runat="server" style="display:none" >
                                        <td align="left">
                                            <asp:Label ID="LblPdf" Text="Dispatch Checklist" runat="server" meta:resourcekey="LblPdfResource1"></asp:Label>
                                        </td>
                                        <td align="left">
                                        ...
                                        <tr class="tablerow" id="ACX2responses3" style="display: table-row;">
                                            <td>
                                                ...
                                                <table class="w-100p">
                                                    ...
                                                    <tr  class="w-100p">
                                                    <td style="display:none">
                                                     <asp:GridView ID ="excelgrid" runat = "server" AllowPaging="false" AllowSorting="True"  CssClass="gridView w-100p m-auto paddgridView" AutoGenerateColumns="false"
                                                     DataKeyNames="PatientVisitID">
                                                     <columns>
                                                      <asp:BoundField DataField="VisitNumber" HeaderText="Visit Number" meta:resourcekey="BoundFieldResource2" />
                                                     <asp:BoundField DataField="PatientName" HeaderText="Patient Name" meta:resourcekey="BoundFieldResource2" />
                                                     <asp:BoundField DataField="PatientAge" HeaderText="Gender/Age" meta:resourcekey="BoundFieldResource2" />
                                                     <asp:BoundField DataField="VisitDate" HeaderText="VisitDate" meta:resourcekey="BoundFieldResource2" />
                                                     <asp:BoundField DataField="ReferingPhysicianName" HeaderText="ReferingPhysicianName" meta:resourcekey="BoundFieldResource2" />
                                                     <asp:BoundField DataField="Location" HeaderText="Reg.Location" meta:resourcekey="BoundFieldResource2" />
                                                     <asp:BoundField DataField="ClientName" HeaderText="ClientName" meta:resourcekey="BoundFieldResource2" />
                                                     </columns>
                                    ...
                                    <asp:Panel ID="PanelGroup" runat="server" Style="height: 420px; width: 1200px;" CssClass="modalPopup dataheaderPopup">
                                        <div id="dvInvstigationDetails" runat="server" style="display: block;">
                                            <asp:Panel ID="table_GroupItem" runat="server" class="AddScroll">
                                                ...
                                                <asp:DataList ID="ZoneDatList" CssClass="table" runat="server" OnItemDataBound="ZoneDatList_ItemDataBound">
                                                    <ItemTemplate>
                                                        <table>
                                                            <tr>
                                                                <td class="a-center">
                                                                <asp:Label CssClass="font19 h-30" ID="Labelorgname" Style="font-family: Trebuchet MS"
                                                                        Font-Bold="true" Width="550px" runat="server" Text="" /><br />
                                                                    <asp:Label CssClass="font19 h-30" ID="Label25" Style="font-family: Trebuchet MS"
                                                                        Font-Bold="true" Width="300px" runat="server" Text="REPORT DISPATCH CHECK LIST" />
                                                                    <asp:Label CssClass="font19 h-30" Style="font-family: Trebuchet MS" ID="lblprintingperiod"
                                                                        Font-Bold="true" runat="server" Text="" Visible="false" />
                                                                    <tr><td><br/>
                                                                    <asp:Label CssClass="font11 h-30" Style="font-family: Arial" ID="lblPrintedAt"
                                                                        Font-Bold="true" Width="500px" runat="server" Text="" />
                                                                        &nbsp;
                                                                        <asp:Label CssClass="font11 h-30"  Style="font-family: Arial" ID="lblPrintedUser"
                                                                        Font-Bold="true" Width="350px" runat="server" Text="" />
                                                                        &nbsp;
                                                                        
                                                                        <asp:Label CssClass="font11 h-30" Style="font-family: Arial" ID="lblPrintedNoOfCount"
                                                                        Font-Bold="true" Width="250px" runat="server" Text="Total No" />
                                                                        
                                                                        </tr></td>
                                                                    <br />
                                                                    <asp:Label Font-Bold="true" CssClass="font20" Style="page-break-before: always" ID="ZoneName"
                                                                        runat="server" Text='<%# Eval("Zone") %>' Visible="false" />
                                                                        </td> </tr>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <br />
                                                                    <asp:DataList ID="outerDataList" runat="server" OnItemDataBound="outerRep_ItemDataBound" RepeatLayout="Table" Width="100%" BorderWidth="1px" > 
                                                                       ...
                                                                       <%-- </HeaderTemplate>--%>
                                                                        <ItemTemplate>
                                                                        <br/>
                                                                            <asp:Label Font-Bold="true" CssClass="font20"  ID="ClientName"
                                                                                runat="server" Text='<%# Eval("ClientName") %>'  Visible="false"/> <br/>
                                                                            ...
                                                                            <HeaderTemplate >
                                                                              <table cellpadding="0" border="1" style="table-layout:fixed">  
	                ...
	                <tr>  
	                <td  colspan="2" style="width:1%">
	                <asp:Label ID="lblRowNumber"  Text='<%# Container.ItemIndex + 1 %>' runat="server" /><br/>
	                </td>
	                <td colspan="2" style="width:5%">  
	                       
	                        <%#Eval("ExternalVisitID")%><br />  
	                    </td>  
	                    ...
	                    <td colspan="2" style="width:5%">
	                    <asp:Label ID="lblAge" runat="server" Text='<%# Bind("PatientAge") %>'></asp:Label><br/>
	                    </td>
	                     <td colspan="2" style="width:3%">  
	                     ...
	                     <td colspan="2" style="width:5%">  
	                        ...
	                        <%#Eval("ICDCodeStatus")%><br />  
	                    </td>  
	                    <td colspan="2" style="width:15%">  
	                       
	                        <%#Eval("PriorityName")%><br />  
	                    </td>  
	                    <td colspan="2" style="width:15%">  
	                       
	                        <%#Eval("SpecialityName")%><br />  
	                    </td>  
	                     <td colspan="2" style="width:5%">  
	               ...
	               <tr  >  
	                ...
	                <td >
	                <asp:Label  ID="lbldispatch1" Font-Bold="true" Width="550px" runat="server" Text="DISPATCHED BY :" />
	                </td>
	                <td >
	                <asp:Label  ID="lbldatetime" Font-Bold="true" Width="550px" runat="server" Text="DATE & TIME :" />
	                </td>
	                ...
	                <tr > 
                        ...
                        <td>
                            <asp:Label ID="lblreceive" runat="server" Font-Bold="true" Text="RECEIVED BY :" 
                                Width="550px" />
                        </td>
                        <td>
                            <asp:Label ID="Labeldatetime" runat="server" Font-Bold="true" 
                                Text="DATE & TIME :" Width="550px" />
                        </td>
                                 ...
                                 <div id="divdispatchdetails" style="display: none;" >
                                    <asp:Panel ID="Panel1" runat="server" Style="height: 420px; width: 1200px; overflow:auto " CssClass="modalPopup dataheaderPopup">
                                     <div id="dvInvstigationDetailsprint" style="max-height : 400px; overflow:scroll" ><div>
                                     ...
                                     <td class="a-center">
                                      ...
                                      <asp:Label CssClass="font19 h-30" ID="Label25" Style="font-family: Trebuchet MS"
                                       ...
                                       <asp:Label CssClass="font11 h-30" Style="font-family: Arial" ID="lblPrintedAt" Font-Bold="true"
                                          Width="500px" runat="server" Text="" />&nbsp;
                                       <asp:Label CssClass="font11 h-30" Style="font-family: Arial" ID="lblPrintedUser"
                                          Font-Bold="true" Width="350px" runat="server" Text="" />&nbsp;
                                        <asp:Label CssClass="font11 h-30" Style="font-family: Arial" ID="lblPrintedNoOfCount"
                                           Font-Bold="true" Width="250px" runat="server" Text="Total No" /><br />                                                                                  
                                       </td>                            
                                       </tr>   
                                       </table> 
                                       </div>
                                       <div id="divrptchklst" runat="server">
                                      ...
                                      <tr>
                                      <td>
                                      <asp:Label ID="Label1" Font-Bold="true" Width="550px" runat="server" Text="DISPATCHED BY :" />
                                      </td>
                                      <td>
                                      <asp:Label ID="Label2" Font-Bold="true" Width="550px" runat="server" Text="DATE & TIME :" />
                                      </td>
                                      </tr>
                                      </table>
                                      <br />
                                      ...
                                      <tr>
                                      <td>
                                      <asp:Label ID="Label3" runat="server" Font-Bold="true" Text="RECEIVED BY :" Width="550px" />
                                      </td>
                                      <td>
                                       <asp:Label ID="Label4" runat="server" Font-Bold="true" Text="DATE & TIME :" Width="550px" />
                                       </td>
                                       </tr>
                                       </table>                               
                                            ...
                                            <tr>
                                                <td class="a-center">
                                                    <asp:Button ID="Button5" runat="server" class="btn" Text="Close" OnClientClick="return popupClosed()" />
                                                </td>
                                                <td class="a-center">
                                                    <asp:Button ID="Button6" runat="server" class="btn" Text="Print" OnClientClick="return popupprint1();" />
                                                </td>
                                            </tr>
                                        </table>
                                   ...
                                   <asp:Button ID="Button4" runat="server" Text="Go" CssClass="btn" onmouseover="this.className='btn btnhov'"
                                                    OnClientClick="return ShowdispatchList();" onmouseout="this.className='btn'"
                                                    meta:resourcekey="btnGoResource1" OnClick="btnGo_ClickP" visible="false"/>
                                    <cc1:ModalPopupExtender ID="InvStatusPopup" runat="server" BackgroundCssClass="modalBackground"
                                        DropShadow="false" PopupControlID="Panel1" Enabled="True" TargetControlID="Button3">
    ...
    <input type="hidden" id="hdnPDFType" name="PType" runat="server" />
        <input type="hidden" id="hdnPrintData" name="PType" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function ChangeLabel() {
          ...
          if (document.getElementById('ddlPrintType').value == 'RPTCHK') {
