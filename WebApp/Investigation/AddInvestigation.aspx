<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddInvestigation.aspx.cs"
    Inherits="Investigation_AddInvestigation" meta:resourcekey="PageResource1" %>
...
--%>
    ...
    <script language="javascript" type="text/javascript">
        ...
        //            document.getElementById('txtCodingSchemeNameMaster').value == "";
        //        }

        function FnClearValues() {
            if (document.getElementById("<%= grdCodingScheme.ClientID %>") != null) {
                var gridId = document.getElementById("<%= grdCodingScheme.ClientID %>");
                var gdrowcount = document.getElementById("<%= grdCodingScheme.ClientID %>").rows.length;
        ...
        function txtBoxValidation() {
            ...
            if (document.getElementById('txtInvestigation').value.trim() == "") {
             //   alert("Enter the InvestigationName");
                ValidationWindow(vInvestigationName, AlertType);
                document.getElementById('txtInvestigation').focus();
                return false;
            }
...
<body>
    ...
    <asp:ScriptManager ID="scrpt" runat="server" ScriptMode="Release">
        <Services>
                ...
                <table class="w-100p searchPanel">
                    ...
                    <tr>
                        <td id="tdAddInvestigations" class="a-left" style="display: none;">
                            ...
                            <table class="w-75p" runat="server">
                                <tr>
                                    <td>
