<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvestigationProfile.aspx.cs"
    Inherits="Investigation_InvestigationProfile" meta:resourcekey="PageResource1" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function ValidateInv() {
            ...
            if (inv == "") {
                var userMsg = SListForApplicationMessages.Get("Investigation\\InvestigationProfile.aspx_1");
            if (userMsg != null) {
                alert(userMsg);
                return false;
            }
                                ...
                                <table border="0" width="100%" cellpadding="0" cellspacing="0" class="defaultfontcolor">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 20%" style="display: none;">
                                            <asp:RadioButton ID="rdoPayNow" runat="server" GroupName="grprdo" 
                                                Text="Pay Now" meta:resourcekey="rdoPayNowResource1" />
                                            &nbsp;
                                            <asp:RadioButton ID="rdoPayLater" runat="server" Checked="True" GroupName="grprdo"
                                                Text="Pay Later" meta:resourcekey="rdoPayLaterResource1" />
                                        </td>
                                        <td style="width: 20%">
                                            &nbsp;
                                        </td>
