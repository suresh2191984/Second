...
public partial class Investigation_FishResultPattern : BaseControl
{
    ...
    public void loadStatus(List<InvestigationStatus> lstStatus)
    {
        ...
        {
            CLogger.LogError("Error while loading FishResultsPattern status dropdown", ex);
        }
    }
    ...
    {       
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            HtmlSelect Result = (HtmlSelect)e.Item.FindControl("Result");
