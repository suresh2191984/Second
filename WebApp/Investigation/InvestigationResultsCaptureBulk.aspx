<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvestigationResultsCaptureBulk.aspx.cs"
    Inherits="Investigation_InvestigationResultsCaptureBulk" EnableEventValidation="false"
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function VaidateApprovedUser() {
            ...
            //                        }
            //                        if (length > 0) {
            //                            var status = ddldwn.options[ddldwn.selectedIndex].value.split("_");
            //                            if (status[0] != null && status[0] == 'Approve') {

            //                                $('select[id$="ddlOpinionUser_' + ctrlID[0] + '"]').each(function(i, n) {
            ...
            //                                    alert("Some of the Test was Approved but Approver name for Department  " + ctrlID[0] + " was not selected");
                    ...
                    if (item != "" && item != 0 && item != undefined && item != null) {
                        ...
                        if (ctrlID[0] != null && ctrlID[0] != 0) {
                            ...
                            if (length > 0) {
                                var status = ddldwn.options[ddldwn.selectedIndex].value.split("_");
                                if (status[0] != null && status[0] == 'Approve') {
                                    var selectedStatus = $('select[id$="ddlOpinionUser_' + ctrlID[0] + '"] option:selected').val();
                                    if (selectedStatus != "--Select--") {
                                        rslt = true;
                                    }
                                    else {
                                        rslt = false;
                                        alert("Provide Approved User for Department  " + ctrlID[0]);
                                        return false;
                                    }
