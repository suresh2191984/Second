<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MonthlyWastageConsumption.aspx.cs"
    Inherits="LabConsumptionInventory_MonthlyWasteageConsumption" meta:resourcekey="PageResource1"  %>
...
<body>
    ...
    <div>
        ...
        <div id="Divshow" runat="server" class="w-100p">
            <table id="MonthlyWastage"  class="responstable w-100p" style="display: none;">
                <thead>
                    <tr>
                        <th>
                        ...
                        <th>
                        <asp:Label ID="Label7" runat="server" Text="Wastage %" 
    ...
    <style>
    #MonthlyWastage_info{display:none;}
    </style>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetData() {
            try {
                ...
                $.ajax({
                    type: "POST",
                    url: "../LabConsumptionInventory/MonthlyWastageConsumption.aspx/MonthlyWastageReport",
                    contentType: "application/json;charset=utf-8",
                        ...
                        "oTableTools": {
                            ...
                            "aButtons": [

                                              {
                                                ...
                                                {
                                                    "sExtends": "csv",
                                                    "sFileName": "MonthlyWastage.csv",
                                                    "bFooter": true

                                                },
                                                {
                                                    "sExtends": "pdf",
                                                    "sFileName": "MonthlyWastage.pdf",
                                                    "bFooter": true
