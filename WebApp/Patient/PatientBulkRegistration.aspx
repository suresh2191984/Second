<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PatientBulkRegistration.aspx.cs" Inherits="Inventory_PatientBulkRegistration" meta:resourcekey="PageResource1" %>
                ...
                if (list[1] > 0) {
                    ...
                    if (result != "[]") {
                        ...
                        //                                          },
                                          ...
                                          { "mDataProp": "SRFID",
                                              "fnRender": function(oObj) {
                                              return '	<label id="jSRFID" >' + oObj.aData.SRFID + '</label>';
                                              }
                                          },
                                          { "mDataProp": "TRFID",
                                              "fnRender": function(oObj) {
                                              return '	<label id="jTRFID" >' + oObj.aData.TRFID + '</label>';
                                              }
                                          }
                ...
                if (result != "[]") {
                    oTable = $('#example1').dataTable({
                        ...
                        //                                          },
                                          ...
                                          { "mDataProp": "SRFID",
                                              "fnRender": function(oObj) {
                                                  return '	<label id="jSRFID1" >' + oObj.aData.SRFID + '</label>';
                                              }
                                          },
                                          { "mDataProp": "TRFID",
                                              "fnRender": function(oObj) {
                                                  return '	<label id="jTRFID1" >' + oObj.aData.TRFID + '</label>';
                                              }
                                          }
...
//                    SampleCollectionDate = "01-01-1900";
                ...
                var SRFID = $row.find("#jSRFID").text();
                var TRFID = $row.find("#jTRFID").text();
                dtBulkReg.push({
                    OrgName: OrgName,
                    SlNo: SlNo,
            ...
            $.ajax({
                type: "POST",
                url: "../WebService.asmx/ValidateBulkRegistrationDetails",
                contentType: "application/json; charset=utf-8",
        ...
        try {
            $("#example1 tr:not(:first)").each(function(i, n) {
                ...
                if (checked) {
                    ...
                    var SRFID = $row.find("#jSRFID1").text();
                    var TRFID = $row.find("#jTRFID1").text();
            ...
            $.ajax({
                type: "POST",
                url: "../WebService.asmx/SaveBulkRegistrationDetails",
                contentType: "application/json; charset=utf-8",
