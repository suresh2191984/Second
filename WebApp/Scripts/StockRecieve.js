...
//            pMFTDate = document.getElementById('txtMFTDate').value;
        //        }
        if ((document.getElementById('txtMFTDate').value == '') || (document.getElementById('txtMFTDate').value == "___/____")) {
            pMFTDate = '**';
        }
        else {
            pMFTDate = document.getElementById('txtMFTDate').value;
        ...
        //        document.getElementById('txtTax').value == 0.00 ? 0 : document.getElementById('txtTax').value;
...
function Tblist() {
    ...
    for (i = 0; i < x.length; i++) {
        if (x[i] != "") {
            ...
            document.getElementById('lblTotalCostAmount').innerHTML = parseFloat(parseFloat(y[15]) + parseFloat(document.getElementById('lblTotalCostAmount').innerHTML)).toFixed(2);
            ...
            document.getElementById('txtGrandTotal').value = parseFloat(parseFloat(y[15]) + parseFloat(document.getElementById('txtGrandTotal').value)).toFixed(2);
            document.getElementById('txtNetTotal').value = (parseFloat(document.getElementById('txtGrandTotal').value)).toFixed(2);
            document.getElementById('txtDiscountAmt').value = parseFloat(parseFloat(document.getElementById('txtDiscountAmt').value) + parseFloat(parseFloat(parseFloat(y[13]) / 100) * (parseFloat(y[12]) * parseFloat(y[9])))).toFixed(2);
...
function CheckDatesMfg(splitChar, ObjDate, flag) {
    ...
    if (ObjDate.value.trim() == "___/____") {
        document.getElementById('txtMFTDate').value == '';
        return true;
    }
    else {
