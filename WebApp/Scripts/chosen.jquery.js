    ...
    Chosen = (function (_super) {
        ...
        Chosen.prototype.set_up_html = function () {
            ...
            if (this.is_multiple) {
                ...
                this.container.html('<a class="chosen-single chosen-default" tabindex="-1"><span>' + this.default_text + '</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off" style="font-family: trebuchet MS;font-size: 12px;line-height: 21px; color: rgb(128, 128, 128);" /></div><ul class="chosen-results"></ul></div>');
            }
        ...
        _this = this;
            ...
            choice = $('<li />', {
                "class": "search-choice"
            }).html("<div style='*margin-top:-2px;*margin-bottom:3px;'>" + item.html + "</div>");
            if (item.disabled) {
