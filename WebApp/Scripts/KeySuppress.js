...
function SuppressKeyStrokes(e) {
    if ((e.keyCode == KEYCODE_BACKSPACE && e.target.type != "text" && e.target.type != "textarea" && e.target.type != "password") || (e.keyCode == KEYCODE_BACKSPACE && e.target.type == "textarea" && e.target.readOnly == true)) {
