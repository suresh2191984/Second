    ...
    if (document.getElementById('txtProduct').value.length < 2) {
        ...
        for (i = lis.length - 1; i >= 0; i--) {
            if (lis[i] != "") {
                ...
                cell4.innerHTML = tblData[5];
                cell5.innerHTML = tblData[14];
                cell6.innerHTML = tblData[3] + "(" + tblData[4] + ")";
                pcount++;
            }
...
//                cell5.innerHTML = tblData[18];
                cell4.innerHTML = tblData[3] + "(" + tblData[4] + ")";
                pcount++;
            }
...
//            var fcell6 = fotrow.insertCell(5);
            fotrow.style.align = "right";
            fcell3.innerHTML = "Total";
            fcell4.innerHTML = sum.toFixed(2);
            document.getElementById('tbllist').style.display = "block";
        }
    ...
    if (document.getElementById('txtProduct').value.length < 2) {
        ...
        for (i = lis.length - 1; i >= 0; i--) {
            if (lis[i] != "") {
                ...
                cell4.innerHTML = tblData[9];
                cell5.innerHTML = tblData[5] + "(" + tblData[7] + ")";
                pcount++;
            }
