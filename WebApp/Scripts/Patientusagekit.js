...
function BindProductList() {
    if (document.getElementById('add').value == 'Update') {
        ...
        document.getElementById('hdnProductList').value += pId + "~" + pName + "~" +
                        ...
                        + "~" + hdnRemarks + "~" + kit + "~" + phdnUnitPrice + "~" + pMedSellingPrice + "~" + pNonSellingPrice +'~'+'0'+"^"; //+ document.getElementById('hdnkittables').value;
        document.getElementById('hdnkittables').value = "";
        Tblist();
        document.getElementById('txtQuantity').value = '';
        document.getElementById('txtUnit').value = '';
...
function Tblist() {
    ...
    for (i = 0; i < x.length; i++) {
        if (x[i] != "") {
            ...
            cell8.innerHTML = y[16];
            var pAction = "";

           // "<input name='" + y[0] + "~" + y[1] + "~" + y[2] + "~" + y[3] + "~" + y[4] + "~" + y[5] + "~" + y[6] + "~" + y[7] + "~" + y[8] + "~" + y[9] + "~" + y[10] + "~" + y[11] + "~" + y[12] + "~" + y[13] + "~" + y[14] + "~" + y[15] + "~" + y[16] + "~" + y[17] + "~" + y[18] + "~" + y[19] + "~" + y[20] + "' onclick='btnEdit_OnClick(name);' value = 'Edit' type='button' style='background-color:Transparent;color:Red;border-style:none;text-decoration:underline;cursor:pointer'  /> &nbsp;&nbsp;" +
                       pAction =  "<input name='" + y[0] + "~" + y[1] + "~" + y[2] + "~" + y[3] + "~" + y[4] + "~" + y[5] + "~" + y[6] + "~" + y[7] + "~" + y[8] + "~" + y[9] + "~" + y[10] + "~" + y[11] + "~" + y[12] + "~" + y[13] + "~" + y[14] + "~" + y[15] + "~" + y[16] + "~" + y[17] + "~" + y[18] + "~" + y[19] + "~" + y[20] + "' onclick='btnDelete(name);' value = 'Delete' type='button' style='background-color:Transparent;color:Red;border-style:none;text-decoration:underline;cursor:pointer'  />"
//            if (y[16] == "Y") {
//                pAction += "<input tabindex='-1' onblur='divDisplay();'  name='" + y[2] + "~" + y[6] + "'  onclick='GetKitDetails(name);DisplayKitDetails();' value = 'Show Kit Details' type='button' style='background-color:Transparent;color:Red;border-style:none;text-decoration:underline;cursor:pointer'  />";
...
function DisplayKitDetails() {
    ...
    var res = document.getElementById('hdnkittables').value;
...
function Deleterows() {
    ...
    if (RowEdit != "") {
        ...
        document.getElementById('hdnProductList').value = pId + "~" + pName + "~" +
                            ...
                            pProductId + "~" + pSellingPrice + "~" + pTax + "~" + pExp + "~" + pProBatchNo + "~" +
                            IsReimburse + "~" + pHasExpiryDate + "~" + hdnDisorEnhpercent + "~" + hdnDisorEnhType
                            + "~" + hdnRemarks + "~" + kit + "~" + phdnUnitPrice + "~" + pMedSellingPrice + "~" + pNonSellingPrice + "^";
...
//    var alte = false;  //PaymentSaveValidation();
//    if (alte == true) {
