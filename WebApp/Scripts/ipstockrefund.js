        ...
        for (i = 0; i < BatchNoList.length; i++) {
            if (BatchNoList[i] != "") {
                ...
                if (val[0].toUpperCase() == (document.getElementById('txtBatchNo').value.trim()).toUpperCase()) {
                    ...
                    document.getElementById('txtUnit').value = val[5];
                    ...
                    document.getElementById('hdnReceiptId').value = val[10];
                    document.getElementById('hdnBillingDetailid').value = val[11];
...
function validqty()
{
      var  unit = Number(document.getElementById('txtUnit').value);
      var qty = Number(document.getElementById('txtQuantity').value);
    
    if (pUnit != 0 &&  pQuantity != 0 && pUnit <= pQuantity) {
            // Number(document.getElementById('txtUnit').value) =document.getElementById('txtQuantity').value))
...
function checkIsEmpty() {
   if (document.getElementById('txtBatchNo').value.trim() == "") {
    ...
    if (document.getElementById('add').value != 'Update') {
        ...
        var NonmedicalAmt = document.getElementById('hdnNonMedicalAmt').value;
        var y; var i;
        for (i = 0; i < x.length; i++) {
            if (x[i] != "") {
                y = x[i].split('~');
...
function BindProductList() {
    if (document.getElementById('add').value == 'Update') {
        ...
        var pRecepitNo = document.getElementById('hdnReceiptId').value;
        var pBillingDetailsID= document.getElementById('hdnBillingDetailid').value ;
        ...
        document.getElementById('hdnProductList').value += pId + "~" + pName + "~" +
                        pBatchNo + "~" + pQuantity + "~" + pUnit + "~" + pSellingPrice + "~" +

                        pProductId + "~" + pSellingPrice + "~" + pTax + "~" + pExp + "~" + pProBatchNo + "~" + IsReimburse + "~" + pRecepitNo + "~" + pBillingDetailsID + "~" + pFinalBillID + "^";
...
function Tblist() {
   ...
   cell11.style.display = "none";
    ...
    cell9.innerHTML = "RecepitNO";
    cell10.innerHTML = "billingID";
    cell11.innerHTML = "FinalBillID";
    ...
    for (i = 0; i < x.length; i++) {
        if (x[i] != "") {
            ...
            cell8.innerHTML = "<input name='" + y[0] + "~" + y[1] + "~" + y[2] + "~" + y[3] + "~" + y[4] + "~" + y[5] + "~" + y[6] + "~" + y[7] + "~" + y[8] + "~" + y[9] + "~" + y[10] + "~" + y[11] + "~" + y[12] + "~" + y[13] + "' onclick='btnEdit_OnClick(name);' value = 'Edit' type='button' style='background-color:Transparent;color:Red;border-style:none;text-decoration:underline;cursor:pointer'  /> &nbsp;&nbsp;" +
...
function btnEdit_OnClick(sEditedData) {
    ...
    document.getElementById('hdnReceiptId').value = y[10];
    document.getElementById('hdnBillingDetailid').value = y[11];
    document.getElementById('hdnFinalBillId').value = y[13];
...
function GetNetAmount() {
    ...
    document.getElementById('PaymentType_txtAmount').value = parseFloat(nonmedicalamt).toFixed(2);
    document.getElementById('hdnNonMedicalAmt1').value = parseFloat(nonmedicalamt).toFixed(2);
...
function checkDetails() {
    ...
    if (alte == true) {
        var AmtRecieved = document.getElementById('txtAmountRecieved').value;
        var AmtNet = document.getElementById('txtNetAmount').value;
...
function TotalCalculation() {
    ...
    document.getElementById('txtGrandTotal').value = parseFloat(parseFloat(AddedAmt[2]) + parseFloat(TaskAmt[2])).toFixed(2);
    ...
    Getdigitalnumber(document.getElementById('lbldigitalnumber'), parseFloat(parseFloat(AddedAmt[2]) + parseFloat(TaskAmt[2])).toFixed(2));
...
function doCalcReimburse() {
    ...
    var hdnNonMedical = 0;
    var txtServiceCharge = document.getElementById("txtServiceCharge");
    var txtGrandTotal = document.getElementById("txtGrandTotal");
    var txtAmountRecieved = document.getElementById("txtAmountRecieved");
    //
    var txtNonMedical = document.getElementById("txtNonMedical");
    ...
    // alert("");
    if (document.getElementById('lblNonMedicalAmt') != null)
        var NonReimburseAmt = Number(document.getElementById("lblNonMedicalAmt").innerHTML);
...
function doGetProductTotalQuantity(source, eventArgs) {
    ...
    if (document.getElementById('txtProduct').value.length < 2) {
        ...
        tblString[0] = "<table border ='1px' class='dataheaderInvCtrl'>";
        tblString[1] = "<tr align='center'><td>Product</td><td>Batch No.</td><td>Exp. Date</td><td>Selling Price</td><td>Available Qty.</td></tr>";
        tblString[2] = "";
        tblString[3] = "</table>";
        ...
        for (i = 0; i < lis.length; i++) {
            if (lis[i] != "") {
                ...
                //<td>Product</td><td>Batch No.</td><td>Exp. Date</td><td>Selling Price</td><td>Available Qty.</td>
                ...
                tblString[2] += "<tr><td>" + tblData[1] + "</td><td>" + tblData[0].split('|')[1] + "</td><td align='left'>" + tblData[8] + "</td><td>" + tblData[9] + "</td><td align='right'>" + tblData[5] +  "</td></tr>";
