    ...
    $.fn.tableHeadFixer = function(param) {
        ...
        function setParent() {
            ...
            parent.scroll(function() {
                ...
                if (settings.head)
                    this.find(".fixTableHeader > *").css("top", top);

                if (settings.foot)
                    this.find(".fixTableFooter > *").css("bottom", scrollHeight - clientHeight - top);
            ...
            if(settings.tableHead == true)
	    {
            ...
            var thead = $(settings.table).find("tbody");
            var tr = thead.find(".fixTableHeader");
            var cells = thead.find(".fixTableHeader > *");
