    ...
    for (i = 0; i < BatchNoList.length; i++) {
        if (BatchNoList[i] != "") {
            ...
            if (val[0].toUpperCase() == (document.getElementById('txtBatchNo').value.trim()).toUpperCase()) {
                ...
                document.getElementById('hdnprdid').value = val[19];
...
function BindProductList() {
    if (document.getElementById('add').value == 'Update') {
        ...
        var pprdid = document.getElementById('hdnprdid').value;
        ...
        document.getElementById('hdnProductList').value += pId + "~" + pName + "~" +
                        ...
                        pProductId + "~" + pSellingPrice + "~" + pTax + "~" + pExp + "~" + pIntendID + "~" + pCategoryID + "~" + pStockInHandID + "~" + pUnitPrice + "~" + pIsReimbursable + "~"+ pprdid + "^";
        Tblist();
        //        GetSmallestDate();
...
function Tblist() {
    ...
    for (i = 0; i < x.length; i++) {
        if (x[i] != "") {
            ...
            cell8.innerHTML = "<input name='" + y[0] + "~" + y[1] + "~" + y[2] + "~" + y[3] + "~" + y[4] + "~" + y[5] + "~" + y[6] + "~" + y[7] + "~" + y[8] + "~" + y[9] + "~" + y[10] + "~" + y[11] + "~" + y[12] + "~" + y[13] + "~" + y[14] + "~" + y[15] + "' onclick='btnEdit_OnClick(name);' value = 'Edit' type='button' style='background-color:Transparent;color:Red;border-style:none;text-decoration:underline;cursor:pointer'  /> &nbsp;&nbsp;" +
                        "<input name='" + y[0] + "~" + y[1] + "~" + y[2] + "~" + y[3] + "~" + y[4] + "~" + y[5] + "~" + y[6] + "~" + y[7] + "~" + y[8] + "~" + y[9] + "~" + y[10] + "~" + y[11] + "~" + y[12] + "~" + y[13] + "~" + y[14] + "~" + y[15] + "' onclick='btnDelete(name);' value = 'Delete' type='button' style='background-color:Transparent;color:Red;border-style:none;text-decoration:underline;cursor:pointer'  />"
        }
    }
    ...
    document.getElementById('hdnprdid').value = '';
...
function btnEdit_OnClick(sEditedData) {
    ...
    document.getElementById('hdnprdid').value = y[15];
