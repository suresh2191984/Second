<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DaywiseCollectionReport.aspx.cs"
											...
											meta:resourcekey="gvBillDetails1Resource2">
                                                    ...
                                                    AutoGenerateColumns="false" meta:resourcekey="gvAllUsersResource2">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="PendingSettlementAmt" HeaderText="UPI" 
                                                                            >
                                                                        <ItemStyle HorizontalAlign="Right" />
                                                                        </asp:BoundField>
                                                                    </Columns>
                                            ...
                                            <asp:Panel ID="Panel1" runat="server" GroupingText="Received Details" meta:resourcekey="gvBillDetails1Resource2">
                                                <asp:GridView ID="gvBillDetails" EmptyDataText="No Results Found."  runat="server"
                                                    ...
                                                    AutoGenerateColumns="False" meta:resourcekey="gvBillDetailsResource2">
                                                        ...
                                                        <asp:BoundField DataField="BilledAmount" HeaderText="UPI" ItemStyle-HorizontalAlign="Right">
                                                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:BoundField DataField="CreatedAt" HeaderText="Collected DateTime" meta:resourcekey="BoundField1Resource32" />
                                                            ...
                                                            <tr>
                                                             ...
                                                             <tr>
                                                                ...
                                                                <td style="text-align: right;">
                                                                    <asp:Label ID="lblCreditAmt" runat="server" Text="0.00"></asp:Label>
                                                                </td>
                                                            </tr>
                                                            <tr>
