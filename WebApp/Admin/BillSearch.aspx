<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BillSearch.aspx.cs" Inherits="BillSearch" meta:resourcekey="PageResource1" %>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td height="32">
                                    <table border="0" id="mytable1" cellpadding="4" cellspacing="0" width="100%">
                                        <tr>
                                            <td colspan="5" id="us">
                                                <asp:Label ID="Rs_SearchforBillsIssued" Text="Search for Bills Issued" 
                                                    runat="server" meta:resourcekey="Rs_SearchforBillsIssuedResource1"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr id="aRow" runat="server" visible="false">
                                <td class="defaultfontcolor">
                                    <asp:Label ID="Rs_Info" Text="Select a Bill and Perform one of the following" 
                                        runat="server" meta:resourcekey="Rs_InfoResource1"></asp:Label>
                                    <asp:DropDownList ID="dList" runat="server" 
                                        ToolTip="Select the Action to be Performed" meta:resourcekey="dListResource1">
                                    </asp:DropDownList>
                                    <asp:Button ID="bGo" ToolTip="Click Here To Proceed" Style="cursor: pointer;" runat="server"
                                        Text="Go" OnClick="bGo_Click" CssClass="btn" OnClientClick="return pBillValidation()"
