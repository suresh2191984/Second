...
public class BarcodeHandler : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
            ...
            if (String.IsNullOrEmpty(context.Request.QueryString["vertical"]))
            {
                ...
                {
                    System.Drawing.Font headerFont = String.IsNullOrEmpty(headerText) ? null : new System.Drawing.Font(context.Request.QueryString["headerff"] != null ? context.Request.QueryString["headerff"] : "Times New Roman", context.Request.QueryString["headerfsize"] != null ? Convert.ToSingle(context.Request.QueryString["headerfsize"]) : 11, GetFontStyle(Convert.ToString(context.Request.QueryString["headerfstyle"])));
                    System.Drawing.Font footerFont = String.IsNullOrEmpty(footerText) ? null : new System.Drawing.Font(context.Request.QueryString["footerff"] != null ? context.Request.QueryString["footerff"] : "Times New Roman", context.Request.QueryString["footerfsize"] != null ? Convert.ToSingle(context.Request.QueryString["footerfsize"]) : 11, GetFontStyle(Convert.ToString(context.Request.QueryString["footerfstyle"])));
                    System.Drawing.Font barcodeNumberFont = new System.Drawing.Font("Times New Roman", 11, FontStyle.Bold);
            ...
            else
            {
                ...
                System.Drawing.Font font = new System.Drawing.Font("Trebuchet MS", 8, FontStyle.Bold);
    ...
    public Byte[] GetBarCodeImage(Int32 width, Int32 Height, String BarCodeNumber)
    {
