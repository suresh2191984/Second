...
public partial class Admin_InventoryProductMapping : BasePage
{
    ...
    //            newBasket.Type = listChild[11];
    //              //newBasket.AttributeDetail = listChild[13];
    //              newBasket.HasBatchNo = listChild[14];
    //              char Iscredit = Convert.ToChar(listChild[14]);
    ...
    //            //    Isreimbursable = "N";
    //            //}
    //            //newBasket.Type = Isreimbursable;    //Act As a Isreimbursable
    //            //newBasket.AttributeDetail = "N";

    //            // newBasket.ReceiptNO = Convert.ToInt64(listChild[12]);
    //            // newBasket.BillingDetailsID = Convert.ToInt64(listChild[13]);
    //            // newBasket.FinalBillID = Convert.ToInt64(listChild[14]);
    //            // newBasket.Attributes = "Y";// att act as a is re,
    ...
    //              newBasket.HasUsage = listChild[15];
    //              newBasket.Providedby = Convert.ToInt64(listChild[16]);
    //              newBasket.Description = listChild[17];
    //              newBasket.parentProductID  = Convert.ToInt64(listChild[18]);
