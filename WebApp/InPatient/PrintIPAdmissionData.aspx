<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintIPAdmissionData.aspx.cs"
    Inherits="InPatient_PrintIPAdmissionData" meta:resourcekey="PageResource1" %>
...
<%@ Register Src="../CommonControls/AdmissionChkList.ascx" TagName="IPAdmChk" TagPrefix="ucAdmChk" %>
                    ...
                    <div class="contentdata">
                        ...
                        <div id="printCS">
                            <table width="600px">
                                <tr>
                                    <td>
                                        <ucAdmChk:IPAdmChk ID="ucIPAdm" runat="server" />
                                    </td>
                                </tr>
                            </table>
                        </div>
