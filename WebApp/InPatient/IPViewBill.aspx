<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IPViewBill.aspx.cs" Inherits="InPatient_IPViewBill"
...
<body onload="javascript: AddTHEAD('DataGrid')" oncontextmenu="return false;">
 ...
 function ShowAlertMsg(key) {
       var userMsg = SListForApplicationMessages.Get(key);
            ...
            {
            alert('No Receipt for this Patient');
            return false ;
            }
        ...
        function CallPrintRecceipt() {
            ...
            if (document.getElementById('hdnPreprinter').value == "Y") {
                document.getElementById('trpreprinter').style.display = "block";
                var height = document.getElementById('hdnpreprinterHeight').value;
                document.getElementById('trpreprinter').style.height = height;
            }
    ...
    <div id="wrapper">
                ...
                <td width="85%" valign="top" class="tdspace">
                    ...
                    <div class="contentdata">
                        <div align="center" id="printArea1" style="font-family: Verdana; font-size: 10px;"
                            runat="server">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr style=" display:none;" id="trpreprinter" runat="server">
                                    <td>
                                    </td>
                                </tr>
                            </table>
                            <table width="95%" border="1" style="border-style: solid; border-width: 1px; border-color: Black;
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" border="0" style="font-size: 10px; font-family: Verdana;" cellspacing="0"
                                            ...
                                            <tr class="dataheaderInvCtrl" style="display: none;" id="trInsuranceDetails" runat="server">
                                                <td colspan="7">
                                                    <table width="98%" id="Table1" runat="server" border="0" cellspacing="0" cellpadding="0"
                                                        style="font-family: Verdana; font-size: 10px;">
                                                        <tr>
                                                            <td align="center" colspan="6">
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    ...
                                                    <div class="dataheaderInvCtrl" align="left" style="display: none; font-weight: bold"
                                                        ...
                                                        <asp:Label ID="Rs_RoomCharges" Text="Room Charges" runat="server" meta:resourcekey="Rs_RoomChargesResource1"></asp:Label>
                                                    </div>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:GridView ID="gvIndentRoomDetails" runat="server" AutoGenerateColumns="False"
                                                                                        ...
                                                                                        Font-Names="Verdana" Font-Size="10px" meta:resourcekey="gvIndentRoomDetailsResource1">
                                                                                        ...
                                                                                        <Columns>
                                                                                            ...
                                                                                            <asp:BoundField HeaderText="Description" DataField="Description" meta:resourcekey="BoundFieldResource4">
                                                                                            ...
                                                                                            <asp:TemplateField HeaderText="UnitPrice" meta:resourcekey="TemplateFieldResource1">
                                                                                                <ItemTemplate>
                                                                                            ...
                                                                                            <asp:BoundField DataField="Status" HeaderText="Status" meta:resourcekey="BoundFieldResource7" />
                                                                                            <asp:BoundField DataField="FromTable" Visible="False" HeaderText="From Table" meta:resourcekey="BoundFieldResource8" />
                                                                                        </Columns>
                                                                                    </asp:GridView>
                                                                                </td>
                                                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan="3" align="right">
                                                    ...
                                                    <div style="padding-left: 10px;">
                                                                            ...
                                                                            <tr>
                                                                                <td align="left">
                                                                                    <span style="font-family: Verdana; font-size: 10px;"><b>
                                                                                        ...
                                                                                        <asp:Label ID="lblComments" runat="server" Visible="False" Text='<%# DataBinder.Eval(Container.DataItem, "Comments") %>'></asp:Label>
                                                                                        <span style="text-decoration: underline;">
                                                                                            <asp:Label ID="lblFeeTypeDetails" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "FeeType") %>'
                                                                                                meta:resourcekey="lblFeeTypeDetailsResource2"></asp:Label></span> </span>
                                                                                    </b>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:GridView ID="gvIndents" CellPadding="3" runat="server" AutoGenerateColumns="False"
                                                                                        ...
                                                                                        <PagerStyle CssClass="dataheader1" />
                                                                                        <Columns>
                                                                                            <asp:BoundField HeaderText="ID" DataField="DetailsID" meta:resourcekey="BoundFieldResource9" />
                                                                                            <asp:BoundField HeaderText="FeeType" DataField="FeeType" meta:resourcekey="BoundFieldResource10">
                                                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                                            </asp:BoundField>
                                                                                            <asp:BoundField HeaderText="FeeID" DataField="FeeID" meta:resourcekey="BoundFieldResource11" />
                                                                                            ...
                                                                                            <asp:BoundField DataField="Status" HeaderText="Status" meta:resourcekey="BoundFieldResource13" />
                                                                                            <asp:BoundField DataField="FromTable" Visible="False" HeaderText="From Table" meta:resourcekey="BoundFieldResource14" />
                                                                                        </Columns>
                                                                                    </asp:GridView>
                                                                                </td>
                                                                            </tr>
                                                        ...
                                                        <asp:Label ID="lblLab" Font-Bold="true" Text ="Lab Charges :" Visible ="false" runat ="server"></asp:Label>
                                                        <asp:Label ID="lblLabValue" Font-Bold ="true" Text ="0" Visible ="false" runat ="server"></asp:Label>
                                                    </div>
                                                </td>
                                            </tr>
                                                    ...
                                                    <asp:GridView ID="gvMedicalItems" CellPadding="3" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField ItemStyle-Width="7%" HeaderText="Receipt/Interim No" meta:resourcekey="TemplateFieldResource10">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblReceiptNo" runat="server" Text='<%# bind("ReceiptInterimNo") %>' meta:resourcekey="lblReceiptNoResource1"></asp:Label>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:BoundField HeaderText="Date" ItemStyle-Width="15%" DataField="FromDate" meta:resourcekey="BoundFieldResource16">
                                                                <ItemStyle Width="15%"></ItemStyle>
                                                            </asp:BoundField>
                                                            <asp:BoundField HeaderText="Quantity" ItemStyle-Width="7%" DataField="unit" meta:resourcekey="BoundFieldResource17">
                                                                <ItemStyle Width="7%"></ItemStyle>
                                                            </asp:BoundField>
                                                    ...
                                                    <div id="divNonMedical" visible="false" runat="server" style="padding-left: 10px">
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:GridView ID="gvNonMedicalItems" CellPadding="3" runat="server" AutoGenerateColumns="False"
                                                                        ...
                                                                        <PagerStyle CssClass="dataheader1" />
                                                                        <Columns>
                                                                            <asp:BoundField HeaderText="ID" DataField="DetailsID" meta:resourcekey="BoundFieldResource19" />
                                                                            <asp:BoundField HeaderText="FeeType" DataField="FeeType" meta:resourcekey="BoundFieldResource20">
                                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                            </asp:BoundField>
                                                                            <asp:BoundField HeaderText="FeeID" DataField="FeeID" meta:resourcekey="BoundFieldResource21" />
                                                            ...
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                                            ...
                                                                            <asp:BoundField DataField="Status" HeaderText="Status" meta:resourcekey="BoundFieldResource23" />
                                                                            <asp:BoundField DataField="FromTable" Visible="false" HeaderText="From Table" meta:resourcekey="BoundFieldResource24" />
                                                                        </Columns>
                                                                    </asp:GridView>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <tr id="divMore3" style="display: none">
                                                            <td colspan="3" align="right">
                                                                <asp:GridView ID="grdPayDetails" CellPadding="5" runat="server" ShowFooter="True"
                                                                    ...
                                                                    <PagerStyle CssClass="dataheader1" />
                                                                    <Columns>
                                                                        <asp:BoundField HeaderText="Rno" DataField="ReceiptNO" meta:resourcekey="BoundFieldResource25" />
                                ...
                                <tr>
                                    <td align="left">
                                        <table>
                                            ...
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="lblSignature" runat="server" Text="Signature" align="right" meta:resourcekey="lblSignatureResource1"></asp:Label>
                                                </td>
                                            </tr>
                        ...
                        <div>
                            <center>
                                <table>
                                    <tr>
                                        <td>
                                            <asp:CheckBox AutoPostBack="True" ID="chkPharmaPrint" Visible="False" runat="server"
                                                OnCheckedChanged="chkPharmaPrint_CheckedChanged" meta:resourcekey="chkPharmaPrintResource1" />
                                            <asp:CheckBox AutoPostBack="True" ID="chkLabPrint" Text ="Show Lab Items" runat="server"
                                                OnCheckedChanged="chkLabPrint_CheckedChanged" />
        ...
        <asp:HiddenField ID="hdnPreprinter" runat="server" />
        <asp:HiddenField ID="hdnpreprinterHeight" runat="server" />
    </div>
    </form>
