...
public partial class InPatient_NeonatalCaseSheets : BaseControl
{
    ...
    public void GetNewBornDetails(long patientVisitID)
    {
        returnCode = -1;
    ...
    public void GetInpatientDetails(long patientVisitID)
    {
        returnCode = -1;
    ...
    public void GetNeonatalCaseSheet(long patientVisitID)
    {
        ...
        if (returnCode == 0)
        {
            ...
            if (lstPatientAdvice.Count > 0)
            {
                ...
                {
                    string Description = oPatientAdvice.ToString();
                    if (Description.Split('-')[0] == "G")
                    {
                        TableRow row1 = new TableRow();
                        TableCell cell1 = new TableCell();
                        cell1.Attributes.Add("align", "left");
                        cell1.Text = "<li type=a>" + Description.Split('-')[1];
                        row1.Cells.Add(cell1);
                        row1.Style.Add("color", "#000");
