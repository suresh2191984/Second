<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KDRDischargeSummary.aspx.cs"
    Inherits="InPatient_KDRDischargeSummary" meta:resourcekey="PageResource1" %>
                                        ...
                                        <tr style="height: 10px;">
                                            <td style="font-weight: normal; color: #000;" colspan="2" align="center">
                                                ...
                                                <asp:GridView ID="gvDischargeDetail" runat="server" AutoGenerateColumns="False" DataKeyNames="PatientVistID"
                                                    OnRowDataBound="gvDischargeDetail_RowDataBound" 
                                                    meta:resourcekey="gvDischargeDetailResource1">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField Visible="False" meta:resourcekey="TemplateFieldResource2">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPatientVistID" runat="server" 
                                                                    Text='<%# Bind("DateOfDischarge") %>' 
                                                                    meta:resourcekey="lblDateOfDischargeResource1"></asp:Label>
                                                            </ItemTemplate>
                                                            <ItemStyle Width="14%" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Date Of Discharge" ItemStyle-Width="14%" 
                                                            meta:resourcekey="TemplateFieldResource3">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblDateOfDischarge" runat="server" 
                                                                    Text='<%# Bind("PatientVistID") %>' 
                                                                    meta:resourcekey="lblPatientVistIDResource1"></asp:Label>
                                                            </ItemTemplate>
                                                            <ItemStyle Width="14%" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Diagnosis" ItemStyle-Width="14%" 
                                                            meta:resourcekey="TemplateFieldResource4">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblDiagnosis" runat="server" 
                                                                    meta:resourcekey="lblDiagnosisResource1"></asp:Label>
                                                            </ItemTemplate>
                                                            <ItemStyle Width="14%" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Surgery / Procedure" ItemStyle-Width="14%" 
                                                            meta:resourcekey="TemplateFieldResource5">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblSurgery" runat="server" 
                                                                    meta:resourcekey="lblSurgeryResource1"></asp:Label>
                                                            </ItemTemplate>
                                                            <ItemStyle Width="14%" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Physician" ItemStyle-Width="14%" 
                                        ...
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Button ID="btnEditDischrageDetails" runat="server" Text="Edit / Print Discharge Summary "
                                                    CssClass="btn" OnClientClick="return pValidationDischarge()" 
                                                    OnClick="btnEditDischrageDetails_Click" 
                                                    meta:resourcekey="btnEditDischrageDetailsResource1" />
                                                <asp:Button ID="btnEditOperationCancel" runat="server" Text="Cancel" 
                                                    CssClass="btn" meta:resourcekey="btnEditOperationCancelResource1" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <div id="PrintDischarge">
                            ...
                            <table cellpadding="0" runat="server" cellspacing="0" border="0" width="100%" id="tblDischrageResult"
                                ...
                                <tr id="trDOA" runat="server" style="display: none">
                                    <td>
                                        <strong><asp:Label ID="Rs_DateofAdmission" Text="Date of Admission :" 
                                            runat="server" meta:resourcekey="Rs_DateofAdmissionResource1"></asp:Label></strong>
                                        <asp:Label ID="lblDOA" runat="server" meta:resourcekey="lblDOAResource1"></asp:Label>
                                    </td>
                                </tr>
                                <tr id="trDOS" runat="server" style="display: none">
                                    <td>
                                        <strong><asp:Label ID="Rs_DateofSurgery" Text="Date of Surgery" runat="server" 
                                            meta:resourcekey="Rs_DateofSurgeryResource1"></asp:Label></strong>
                                        <asp:Label ID="lblDOS" runat="server" meta:resourcekey="lblDOSResource1"></asp:Label>
                                    </td>
                                </tr>
                                <tr id="trDOD" runat="server" style="display: none">
                                    <td>
                                        <strong><asp:Label ID="Rs_DateofDischarge" Text="Date of Discharge :" 
                                            runat="server" meta:resourcekey="Rs_DateofDischargeResource1"></asp:Label></strong>
                                        <asp:Label ID="lblDOD" runat="server" meta:resourcekey="lblDODResource1"></asp:Label>
                                    </td>
                                </tr>
                                <tr id="trTOD" runat="server" style="display: none">
                                    <td>
                                        <strong><asp:Label ID="Rs_TypeofDischarge" Text="Type of Discharge :" 
                                            runat="server" meta:resourcekey="Rs_TypeofDischargeResource1"></asp:Label></strong>
                                ...
                                <tr id="trConsultant" runat="server" style="display: none">
                                    <td>
                                        <asp:Label ID="lblConsultantT" runat="server" Text="Primary Consultant" 
                                            Font-Bold="True" meta:resourcekey="lblConsultantTResource1"></asp:Label>
                                        :<asp:Label ID="lblConsultant" runat="server" 
                                            meta:resourcekey="lblConsultantResource1"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr id="trDiagnosis" runat="server" style="display: none">
                                    <td>
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <tr>
                                                <td style="font-weight: bold; height: 20px; color: #000;">
                                                    <asp:Label ID="Rs_DIAGNOSIS" Text="DIAGNOSIS" runat="server" 
                                                        meta:resourcekey="Rs_DIAGNOSISResource1"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                ...
                                <tr id="trCPhysician" runat="server" style="display: none">
                                    <td style="font-weight: bold; height: 15px; color: #000;">
                                        <asp:Label ID="Rs_PrimaryPhysician" Text="Primary Physician -" runat="server" 
                                            meta:resourcekey="Rs_PrimaryPhysicianResource1"></asp:Label>
                                        <asp:Label ID="lblCPhysician" runat="server" 
                                            meta:resourcekey="lblCPhysicianResource1"></asp:Label>
                                    </td>
                                </tr>
                                <tr id="trCSurgeon" runat="server" style="display: none">
                                    <td style="font-weight: bold; height: 15px; color: #000;">
                                        <asp:Label ID="Rs_ConsultingSurgeon" Text="Consulting Surgeon -" runat="server" 
                                            meta:resourcekey="Rs_ConsultingSurgeonResource1"></asp:Label>
                                        <asp:Label ID="lblCSurgeon" runat="server" 
                                            meta:resourcekey="lblCSurgeonResource1"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr id="trplan" runat="server" style="display: none">
                                    <td>
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <tr>
                                                <td style="font-weight: bold; height: 20px; color: #000;">
                                                    <asp:Label ID="Rs_TREATMENTPLAN" Text="TREATMENT PLAN" runat="server" 
                                                        meta:resourcekey="Rs_TREATMENTPLANResource1"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" width="80%">
                                            <tr>
                                                <td style="font-weight: bold; height: 10px; color: #000;">
                                                    <asp:Label ID="Rs_BACKROUNDMEDICALPROBLEMS" Text="BACKROUND MEDICAL PROBLEMS" 
                                                        runat="server" meta:resourcekey="Rs_BACKROUNDMEDICALPROBLEMSResource1"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                ...
                                <tr id="trGeneralExamination" runat="server" style="display: none">
                                    <td>
                                        <table cellpadding="0" cellspacing="0" border="0" width="80%">
                                            <tr>
                                                <td style="font-weight: bold; height: 20px; color: #000;">
                                                    <asp:Label  ID="Rs_GENERALEXAMINATION"  Text="GENERAL EXAMINATION" 
                                                        runat="server" meta:resourcekey="Rs_GENERALEXAMINATIONResource1"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                ...
                                <tr id="trDischargeVitals" runat="server" style="display: none">
                                    <td>
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <tr>
                                                <td style="font-weight: bold; height: 20px; color: #000;">
                                                    <asp:Label ID="Rs_DISCHARGEVITALS" Text="DISCHARGE VITALS" runat="server" 
                                                        meta:resourcekey="Rs_DISCHARGEVITALSResource1"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                ...
                                <tr id="trSurgery" runat="server" style="display: none">
                                    <td>
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <tr>
                                                <td style="font-weight: bold; height: 20px; color: #000;">
                                                   <asp:Label ID="Rs_SURGERYPROCEDUREDETAILS" Text="SURGERY / PROCEDURE DETAILS" 
                                                        runat="server" meta:resourcekey="Rs_SURGERYPROCEDUREDETAILSResource1"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Repeater ID="repTreatmentPlan" runat="server" OnItemDataBound="repTreatmentPlan_ItemDataBound">
                                                        <ItemTemplate>
                                                            <asp:Table ID="tblSOI" Width="100%" runat="server" 
                                                                meta:resourcekey="tblSOIResource1">
                                                                <asp:TableRow runat="server" meta:resourcekey="TableRowResource1">
                                                                    <asp:TableCell runat="server" meta:resourcekey="TableCellResource1"><asp:Label 
                                                                        ID="lblTreatmentNameT" runat="server" Text="Treatment Name:" 
                                                                        meta:resourcekey="lblTreatmentNameTResource1"></asp:Label>
<asp:Label ID="lblTreatmentName" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "TreatmentName") %>' 
                                                                ...
                                                                <asp:TableRow runat="server" meta:resourcekey="TableRowResource2">
                                                                    <asp:TableCell runat="server" meta:resourcekey="TableCellResource2"><asp:Label 
                                                                        ID="lblFromTimeT" runat="server" Text="Treatment Date:" 
                                                                        meta:resourcekey="lblFromTimeTResource1"></asp:Label>
<asp:Label ID="lblFromTime" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "FromTime") %>' meta:resourcekey="lblFromTimeResource1"></asp:Label>
</asp:TableCell>
                                                                </asp:TableRow>
                                                                <asp:TableRow runat="server" meta:resourcekey="TableRowResource3">
                                                                    <asp:TableCell runat="server" meta:resourcekey="TableCellResource3"><asp:Label 
                                                                        ID="lblAnesthesiaTypeT" runat="server" Text="Anesthesia Type:" 
                                                                        meta:resourcekey="lblAnesthesiaTypeTResource1"></asp:Label>
<asp:Label ID="lblAnesthesiaType" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "AnesthesiaType") %>' 
                                                                ...
                                                                <asp:TableRow runat="server" meta:resourcekey="TableRowResource4">
                                                                    <asp:TableCell runat="server" meta:resourcekey="TableCellResource4"><asp:Label 
                                                                        ID="lblSurgeryTypeT" runat="server" Text="Surgery Type:" 
                                                                        meta:resourcekey="lblSurgeryTypeTResource1"></asp:Label>
<asp:Label ID="lblSurgeryType" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "SurgeryType") %>' 
                                                                ...
                                                                <asp:TableRow runat="server" meta:resourcekey="TableRowResource5">
                                                                    <asp:TableCell runat="server" meta:resourcekey="TableCellResource5"><asp:Label 
                                                                        ID="lblOperationTypeT" runat="server" Text="Operation Type:" 
                                                                        meta:resourcekey="lblOperationTypeTResource1"></asp:Label>
<asp:Label ID="lblOperationType" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "OperationType") %>' 
                                                                ...
                                                                <asp:TableRow runat="server" meta:resourcekey="TableRowResource6">
                                                                    <asp:TableCell runat="server" meta:resourcekey="TableCellResource6"><asp:Label 
                                                                        ID="lblOperationFindingsT" runat="server" Text="Operation Findings:" 
                                                                        meta:resourcekey="lblOperationFindingsTResource1"></asp:Label>
<asp:Label ID="lblOperationFindings" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "OperativeFindings") %>' 
                                                                ...
                                                                <asp:TableRow runat="server" meta:resourcekey="TableRowResource7">
                                                                    <asp:TableCell runat="server" meta:resourcekey="TableCellResource7"><asp:Label 
                                                                        ID="lblOperativeTechniqueT" runat="server" Text="Operative Technique:" 
...
<asp:Label ID="lblOperativeTechnique" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "OperativeTechnique") %>' 
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <asp:Label ID="Rs_Reporttohospitalincaseofthefollowingissues" 
                                                        Text="Report to hospital in case of the following issues:" runat="server" 
                                                        meta:resourcekey="Rs_ReporttohospitalincaseofthefollowingissuesResource1"></asp:Label><br />
                                                    <li type="a"><asp:Label  ID="Rs_Highgradefever"  Text="High grade fever" 
                                                            runat="server" meta:resourcekey="Rs_HighgradefeverResource1"></asp:Label><br />
                                                        <%--<li type="a">Giddiness, decreased level of consciousness and/or altered mentation<br />
                                                            <li type="a">Difficulty in breathing, chest pain and/or profuse sweating<br />--%>
                                                    <li type="a">
                                                        <asp:Label ID="Rs_Info" Text="Urinary retention, decreased urine output, leg swelling, nausea and/or
                                                        loss of appetite" runat="server" meta:resourcekey="Rs_InfoResource1"></asp:Label><br />
                                                        <li type="a">
                                                    <asp:Label ID="Rs_Operatedsitebleedingorinfection" 
                                                                Text="Operated site bleeding or infection" runat="server" 
                                                                meta:resourcekey="Rs_OperatedsitebleedingorinfectionResource1"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                ...
                                <tr id="trPrescription" runat="server" style="display: none">
                                    <td>
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <tr>
                                                <td style="font-weight: bold; height: 20px; color: #000;">
                                                    <asp:Label ID="Rs_DISCHARGEPRESCRIPTION" Text="DISCHARGE PRESCRIPTION" 
                                                        runat="server" meta:resourcekey="Rs_DISCHARGEPRESCRIPTIONResource1"></asp:Label>
                                                </td>
                                ...
                                <tr>
                                    <td>
                                       <asp:Label ID="Rs_Info2" Text="Always review with a scheduled appointment from the front office counter for us
                                        to serve you better." runat="server" meta:resourcekey="Rs_Info2Resource1"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Rs_Info3" Text="(INVESTIGATION REPORTS ENCLOSED IN THE FILE)" 
                                            runat="server" meta:resourcekey="Rs_Info3Resource1"></asp:Label>
                                    </td>
                                </tr>
                                <%-- <tr>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                    <td width="30%">
                                        <asp:Label ID="lblSMO" runat="server" Visible="False" 
                                            meta:resourcekey="lblSMOResource1"></asp:Label>
                                    </td>
                                    <td width="30%" align="center">
                                        <asp:Label ID="lblCI" runat="server" Visible="False" 
                                            meta:resourcekey="lblCIResource1"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="30%">
                                        <asp:Label ID="lblSMOT" runat="server" Text="Senior Medical Officer" 
                                            Visible="False" meta:resourcekey="lblSMOTResource1"></asp:Label>
                                    </td>
                                    <td width="30%" align="center">
                                        <asp:Label ID="lblCIT" runat="server" Text="Consultant Incharge" 
                                            Visible="False" meta:resourcekey="lblCITResource1"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td width="30%" id="tdPreparedBy" runat="server">
                                        <asp:Label ID="lblPreparedByT" runat="server" Text="Prepared By:" 
                                            Visible="False" meta:resourcekey="lblPreparedByTResource1"></asp:Label>
                                        <asp:Label ID="lblPreparedBy" runat="server" Visible="False" 
                                            meta:resourcekey="lblPreparedByResource1"></asp:Label>
                                    </td>
                                    <td width="30%" align="center" id="tdTyped" runat="server">
                                        <asp:Label ID="lblTypedByT" runat="server" Text="Typed By:" Visible="False" 
                                            meta:resourcekey="lblTypedByTResource1"></asp:Label><asp:Label
                                            ID="lblTypedBy" runat="server" Visible="False" 
