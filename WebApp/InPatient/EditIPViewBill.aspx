<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditIPViewBill.aspx.cs" Inherits="InPatient_EditIPViewBill" meta:resourcekey="PageResource1" %>
...
<body onload="javascript: AddTHEAD('DataGrid')" oncontextmenu="return false;">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function printVou(visitID) {
            ...
            var strURL = "../Billing/RefundVoucher.aspx?VID=" + visitID + "&IsPopup=" + "Y";
                    ...
                    <div class="contentdata">
                        <div align="center" id="printArea1" style="font-family: Verdana; font-size: 10px;"
                            ...
                            <table width="95%" border="1" style="border-style: solid; border-width: 1px; border-color: Black;
                                ...
                                <tr>
                                    <td>
                                        <table id="Table1" width="100%" border="0" style="font-size: 10px; font-family: Verdana;" cellspacing="0"
                                            cellpadding="0" align="center" runat="server">
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" width="100%" style="font-family: Verdana;
                                                                                            ...
                                                                                            <asp:TemplateField HeaderText="Quantity" 
                                                                                                ...
                                                                                                <ItemTemplate>
                                                                                                    <asp:Label ID="txtQuantity" runat="server" Style="text-align: right;" MaxLength="10"
                                                                                                        Text='<%# String.Format("{0:N0}",Eval("unit")) %>'  
                                            ...
                                            <tr>
                                                <td colspan="3" align="right">
                                                    <br />
                                                    <div id="dvTreatmentCharges" class="" align="left" style="font-weight: bold"
                                                        runat="server">
                                                        <asp:Label ID="Rs_TreatmentCharges" Text="Treatment Charges" runat="server" 
                                                            meta:resourcekey="Rs_TreatmentChargesResource1"></asp:Label>                                                     </div>
                                                    <div style="padding-left: 10px;">
                                                        <asp:GridView ID="gvTreatmentCharges" runat="server" GridLines="None" AutoGenerateColumns="False"
                                                            OnRowDataBound="gvTreatment_RowDataBound" Width="98%" 
                                            ...
                                            <tr class="dataheaderInvCtrl">
                                                <td colspan="3" id="tdpharma" runat="server" align="left">
                                                    ...
                                                    <asp:GridView ID="gvMedicalItems" CellPadding="3" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField ItemStyle-Width="7%" HeaderText="Receipt/Interim No" 
...
<ItemStyle Width="7%"></ItemStyle>
                                                            ...
                                                            <asp:BoundField HeaderText="Description" DataField="Description" 
                                                                HeaderStyle-HorizontalAlign="Left" meta:resourcekey="BoundFieldResource15" >
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                                            </asp:BoundField>
                                                            <asp:TemplateField ItemStyle-Width="10%" HeaderText="Batch No" 
...
<ItemStyle Width="10%"></ItemStyle>
                                                            ...
                                                            <asp:TemplateField ItemStyle-Width="10%" HeaderText="Expiry Date" 
...
<ItemStyle Width="10%"></ItemStyle>
                                                            ...
                                                            <asp:BoundField HeaderText="Date" ItemStyle-Width="15%" DataField="FromDate" 
                                                                meta:resourcekey="BoundFieldResource16" >
<ItemStyle Width="15%"></ItemStyle>
                                                            </asp:BoundField>
                                                            <asp:BoundField HeaderText="Quantity" ItemStyle-Width="7%" DataField="unit" 
...
<ItemStyle Width="7%"></ItemStyle>
                                                            ...
                                                            <asp:BoundField HeaderText="UnitPrice" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="7%"
                                                                DataField="AMOUNT" meta:resourcekey="BoundFieldResource18" >
                                                            ...
                                                            <asp:TemplateField HeaderText="Amount" ItemStyle-HorizontalAlign="Right" 
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="txtAmount" runat="server" 
                                                                        Style="text-align: right;padding-right: 10px;" Text='<%# NumberConvert(Eval("unit"),Eval("AMOUNT")) %>'
                                                ...
                                                <td colspan="3" align="center">
                                                    ...
                                                    <div id="divNonMedicalHead" class="dataheaderInvCtrl" align="left" style="font-weight: bold"
                                                        ...
                                                        <asp:Label ID="Rs_NonMedicalItems" Text="Non-MedicalItems" runat="server" 
                                                            meta:resourcekey="Rs_NonMedicalItemsResource1"></asp:Label>                                                     </div>
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <span style="font-family: Verdana; font-size: 10px;"><b><span style="text-decoration: underline;
                                                                        text-align: left;">
                                                                        <asp:Label ID="lblNonMedicalItem" runat="server" 
                                                                        Text="Sum of NonMedicalItems :-" meta:resourcekey="lblNonMedicalItemResource1"></asp:Label>
                                                                        <asp:Label ID="lblNonMedicalDetails" runat="server" 
                                                                        meta:resourcekey="lblNonMedicalDetailsResource1"></asp:Label>
                                            ...
                                            <tr runat="server" id="trAmountDetails">
                                                <td colspan="3" style="padding-top: 10px; vertical-align: middle;">
                                                    <table cellpadding="4" class="dataheaderInvCtrl" style="vertical-align: middle; font-family: Verdana;
                                                        ...
                                                        <tr id="trCreditDebit" runat="server" style="display: none">
                                                            <td>
                                                                &nbsp;
                                                            </td>
                                                            <td align="right">
                                                        ...
                                                        <tr id="trRoundOff" runat="server" style="display: none">
                                                            <td>
                                                                &nbsp;
                                                            </td>
                                                            <td align="right">
                                                            ...
                                                            <td align="right">
                                                                <div id="divMore1" onclick="showResponses('divMore1','divMore2','divMore3',1);" style="cursor: pointer;
                                                                    ...
                                                                    <strong><asp:Label ID="Rs_AmountReceivedfromPatient" 
                                                                        ...
                                                                        meta:resourcekey="Rs_AmountReceivedfromPatient"></asp:Label></strong>
                                                                </div>
                                                                <div id="divMore2" style="cursor: pointer; display: none; cursor: pointer;" onclick="showResponses('divMore1','divMore2','divMore3',0);"
                                                                    ...
                                                                    <strong><asp:Label ID="Rs_AmountReceivedfromPatient1" 
                                                                        Text="Amount Received from Patient" runat="server" 
                                                                        meta:resourcekey="Rs_AmountReceivedfromPatient1Resource1"></asp:Label></strong>
                                                                </div>
                                                            </td>
                                                            <td align="right">
                                                                ...
                                                                <asp:GridView ID="grdPayDetails" CellPadding="5" runat="server" ShowFooter="True"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField HeaderText="Date" DataField="CreatedAt" 
                                                                            DataFormatString="{0:dd/MM/yyyy}" meta:resourcekey="BoundFieldResource26" />
                                                                        <asp:BoundField HeaderText="Description" DataField="Remarks" 
                                                                            ItemStyle-HorizontalAlign="Left" meta:resourcekey="BoundFieldResource27" >
<ItemStyle HorizontalAlign="Left"></ItemStyle>
                                                                        </asp:BoundField>
                                                                        <asp:BoundField HeaderText="Amount" DataField="AmtReceived" DataFormatString="{0:0.00}"
                                                                            ItemStyle-HorizontalAlign="Right" meta:resourcekey="BoundFieldResource28" >
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                                        </asp:BoundField>
                                                                    </Columns>
                                                                </asp:GridView>
                                                        ...
                                                        <tr runat="server" id="trPaidAmt" visible="true">
                                                            ...
                                                            <td align="right">
                                                                <asp:Label ID="Rs_NonMedicalItems1" Text="Non-MedicalItems" runat="server" 
                                                                    meta:resourcekey="Rs_NonMedicalItems1Resource1"></asp:Label>
                                                            </td>
                                                                                                                        <td align="right">
                                                        ...
                                                        <tr runat="server" id="trCoPay" visible="true" style="display: none">
                                                            <td>
                                                                &nbsp;
                                                            </td>
                                                            <td align="right">
                                                            ...
                                                            <asp:Image  runat="server" Height="10px" Width="10px" ID="Irupee11" 
                                                                    ImageUrl="~/Images/Indian_rupees.PNG" meta:resourcekey="Irupee11Resource1" />
                                                                <asp:Label ID="lblCoPayment" runat="server" Font-Bold="True" Text="0.00" 
                                                                    meta:resourcekey="lblCoPaymentResource1"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr id="trAmountFromTPA" runat="server"  style="display: none">
                                                            <td>
                                                                &nbsp;
                                                            </td>
                                                            <td align="right">
                                                ...
                                                <td style="padding-top: 10px; vertical-align: middle;">
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td align="right" colspan="2">
                                                                <asp:Label ID="Rs_GrossBillAmount1" Text="Gross Bill Amount" runat="server" 
                                                                    meta:resourcekey="Rs_GrossBillAmount1Resource1"></asp:Label>
                                                            </td>
                                                            <td align="right" class="details_value">
                                                            <asp:Image  runat="server" Height="10px" Width="10px" ID="Irupee15" 
                                                                    ImageUrl="~/Images/Indian_rupees.PNG" meta:resourcekey="Irupee15Resource1" />
                                                                <asp:Label ID="ldlGross" runat="server" Text="0.00" Font-Bold="True" 
                                                                    meta:resourcekey="ldlGrossResource1"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td align="right" colspan="2">
                                                                <asp:Label ID="Rs_PreAuthorizationAmount" Text="Pre Authorization Amount" 
                                                                    runat="server" meta:resourcekey="Rs_PreAuthorizationAmountResource1"></asp:Label>
                                                            </td>
                                                            <td align="right">
                                                            <asp:Image  runat="server" ID="Irupee16" Height="10px" Width="10px" 
                                                                    ImageUrl="~/Images/Indian_rupees.PNG" meta:resourcekey="Irupee16Resource1" />
                                                                <asp:Label ID="lblPreAutho" Text="0.00" runat="server" Font-Bold="True" 
                                                                    meta:resourcekey="lblPreAuthoResource1"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td align="right" colspan="2">
                                                                <asp:Label ID="Rs_CoPaymen1" Text="Co-Payment" runat="server" 
                                                                    meta:resourcekey="Rs_CoPaymen1Resource1"></asp:Label>
                                                            </td>
                                                            <td align="right">
                                                            <asp:Image  runat="server" ID="Irupee17" Height="10px" Width="10px" 
                                                                    ImageUrl="~/Images/Indian_rupees.PNG" meta:resourcekey="Irupee17Resource1" />
                                                                <asp:Label ID="lblCoPayments" runat="server" Font-Bold="True" Text="0.00" 
                                                                    meta:resourcekey="lblCoPaymentsResource1"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td align="right" colspan="2">
                                                                <asp:Label ID="Rs_Tax1" Text="Tax" runat="server" 
                                                                    meta:resourcekey="Rs_Tax1Resource1"></asp:Label>
                                                            </td>
                                                            <td align="right">
                                                            <asp:Image  runat="server" ID="Irupee18" Height="10px" Width="10px" 
                                                                    ImageUrl="~/Images/Indian_rupees.PNG" meta:resourcekey="Irupee18Resource1" />
                                                                <asp:Label ID="lblTax" runat="server" Font-Bold="True" Text="0.00" 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="right" colspan="2">
                                                                <asp:Label ID="Rs_ClaimAmount" Text="Claim Amount" runat="server" 
                                                                    meta:resourcekey="Rs_ClaimAmountResource1"></asp:Label>
                                                            </td>
                                                            <td align="right">
                                                            <asp:Image  runat="server" ID="Irupee19" Height="10px" Width="10px" 
                                                                    ImageUrl="~/Images/Indian_rupees.PNG" meta:resourcekey="Irupee19Resource1" />
                                                                <asp:Label ID="lblDueTpa" runat="server" Font-Bold="True" Text="0.00" 
                                                                    meta:resourcekey="lblDueTpaResource1"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                            ...
                            <td align="left">
                             <table>
                                <tr id="trAmountInWords" runat="server">
                                    ...
                                    <td  align="left">
                                        <%--<asp:Label ID="lblAmountinWords" runat="server" Style="font-family: Verdana; font-size: 10px">Amount received in Words:&nbsp;(<%= CurrencyName %>)&nbsp;</asp:Label>--%>
                                ...
                                <tr id="trDueAmountinWords" runat="server" style="display:none;">
                                    ...
                                    <td  align="left" runat="server" id="tdDueAmount" style="display:none;">
                                ...
                                <td><div ID="medfortfooter" style="height:auto;" runat="server"></div>
                                </td>
                                </tr>
                                </table>
                        ...
                        <table>
                            <tr>
                                <td>
                                    <asp:CheckBox AutoPostBack="True" 
                                        ID="chkPharmaPrint" Visible="False" runat="server" 
                                        oncheckedchanged="chkPharmaPrint_CheckedChanged" 
                                        meta:resourcekey="chkPharmaPrintResource1" />
                                    &nbsp;<asp:CheckBox AutoPostBack="True" Text="Show Only ReImbursable Items" runat="server"
                                        ID="chkMedicalItems" Visible="False" 
                                        OnCheckedChanged="chkMedicalItems_CheckedChanged" 
                                        meta:resourcekey="chkMedicalItemsResource1" />
                                </td>
                        </tr>   
                        </table>
                            <br />
                            <%--<asp:Button ID="btnGeneratePDF" runat="server" Text="Generate TPA PDF"
                                CssClass="btn" onclick="btnGeneratePDF_Click" />--%>
                            ...
                            <asp:Button ID="btnReceipt" Visible="False" runat="server" OnClick="btnViewReceipt_Click"
                                Text="Print Receipt" CssClass="btn" 
                                meta:resourcekey="btnReceiptResource1" />
                            &nbsp; &nbsp; &nbsp; &nbsp;
                            ...
                            <asp:Button ID="btnItemizedBill" Visible="False" runat="server" OnClick="btnItemizedBill_Click"
                                Text="View Itemized Bill" CssClass="btn" 
                                meta:resourcekey="btnItemizedBillResource1" />
                            <br />
                        </center>
                    </div>
                </td>
   ...
   <%-- <script type="text/javascript" language="javascript">
        if (document.getElementById('hdnPharmaShow').value == "1") {
            document.getElementById('gvMedicalItems').style.display = "block";
        }
        else {
            document.getElementById('gvMedicalItems').style.textAlign = "right";
        }
    </script>--%>
