...
public partial class HomeCollection_HC_BulkBooking : BasePage
{
    public HomeCollection_HC_BulkBooking()
        : base("HomeCollection_HC_BulkBooking_aspx")
    {
    }
    ...
    {
        CLogger.LogWarning("Excel upload Start ");
        string path = "";
        ...
        path = path.Replace("\\", "~");
        CLogger.LogWarning("Excel upload path " + path);
    ...
    protected void lnkXls_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string filepath = Server.MapPath(@"~\ExcelTest\BulkBooking.xls");
    ...
    public void ExportToExcelForBulkReg()
    {
        try
        {
            ...
            using (ExcelPackage pck = new ExcelPackage())
            {
                ...
                ExcelWorksheet ws = pck.Workbook.Worksheets.Add("BulkBooking");
                var tbl = dt;
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;  filename=" + OrgName + "_" + OrgID + "_" + "BulkBooking.xls");
