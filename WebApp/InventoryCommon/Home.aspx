<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="InventoryCommon_Home"
    meta:resourcekey="PageResource1" EnableEventValidation="false" %>

<%--<%@ Register Src="~/PlatForm/CommonControls/PhySchedule.ascx" TagName="PSchedule" TagPrefix="ps" %>
<%@ Register Src="~/PlatForm/CommonControls/ErrorDisplay.ascx" TagName="ErrorDisplay" TagPrefix="uc7" %>
--%>
