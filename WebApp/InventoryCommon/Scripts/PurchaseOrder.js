 var errorMsg = SListForAppMsg.Get("CentralPurchasing_Error") != null ? SListForAppMsg.Get("CentralPurchasing_Error") : "Error";
...
function Tblist() {
    ...
    var strVat=SListForAppDisplay.Get("CentralPurchasing_Scripts_PurchaseOrder_js_12")== null ?"Vat":SListForAppDisplay.Get("CentralPurchasing_Scripts_PurchaseOrder_js_12");
            ...
            if (x[i] != "") {
                ...
                tr += "<tr align='left'><td >"
                        ...
                        + "<td class='w-60 a-center'><input name='" + y[0] + "~" + y[1] + "~" + y[2] + "~" + y[3] + "~" + y[4] + "~" + y[5] + "~" + y[6] + "~" + y[7] + "~" + y[8] +
                                                 ...
                                                 "~" + y[17] + "~" + y[18] + "~" + y[19] + "~" + y[20] + "~" + y[21] + "~" + y[22] + units +
...
//    var ddlSupplierList = document.getElementById('<%= ddlSupplierList.ClientID %>');
    ...
    for (s = 0; s < list.length; s++) {
        ...
        if (list[s] != "") {
            ...
            var userMsg = SListForAppMsg.Get("CentralPurchasing_Scripts_PurchaseOrder_js_17") != null ? SListForAppMsg.Get("CentralPurchasing_Scripts_PurchaseOrder_js_17") : "Selected product has been marked as Banned. Do you still wish to use this?";
            if (res[6] == 'Y') {
