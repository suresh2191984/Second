...
public partial class InventoryReports_SupplierAnalysisReport : Attune_BasePage
{
    public InventoryReports_SupplierAnalysisReport()
        : base("InventoryReports_SupplierAnalysisReport_aspx")
   {
    ...
    //List<SupplierProductAnalysis> lstSupplierProductAnalysis = new List<SupplierProductAnalysis>();
    ...
    private void LoadSupplierProduct()
    {
        ...
        {
            ProdCategoryID = Convert.ToInt32(ddlCategory.SelectedValue);
        }
        if (ddlType.SelectedValue != "0")
        {
            ProdTypeID = Convert.ToInt32(ddlType.SelectedValue);
        }
        ...
        new InventoryReports_BL(this.ContextInfo).GetProductSupplierReport(SearchNo, sfromdate, sTodate, SupplierName, ProductName, pOrgID, ILocationID, InventoryLocationID, ProdCategoryID, ProdTypeID, out lstInventoryItemsBasket);
