...
public partial class CommonControls_LeftMenuIP : BaseControl
{
    ...
    public CommonControls_LeftMenuIP()
        : base("CommonControls_LeftMenuIP_ascx")
    {
    }
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (IsPostBack == false)
            {
                ...
                /*
                parentIDIP = Convert.ToInt32(TaskHelper.SearchType.IP);
                long retCodeIP = -1;
