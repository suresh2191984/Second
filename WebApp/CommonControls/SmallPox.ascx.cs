...
public partial class CommonControls_SmallPox : BaseControl 
{
    ...
    public void EditData(List<PatientHistoryAttribute> lstPHA, long ID)
    {
        ...
        for (int j = 0; j < lstEditData.Count(); j++)
        {
            ...
            {
                rdoYes_1114.Checked = true;
                divrdoYes_1114.Style.Add("display", "block");
                txtSmallPox.Text = lstEditData[j].AttributeValueName;
            }
        }
    }
    public long GetData(out List<PatientHistory> attribute, out List<PatientHistoryAttribute> attrvalue)
    {
        ...
        if (rdoYes_1114.Checked == true)
        {
            PatientHistory objpatienthistory = new PatientHistory();
            objpatienthistory.HistoryID = Convert.ToInt32(1114);
            objpatienthistory.HistoryName = rdoYes_1114.Text;
            ...
            if (txtSmallPox.Text != "")
            {
                objpatienthistoryattribute.HistoryID = Convert.ToInt64(1114);
                objpatienthistoryattribute.AttributeID = Convert.ToInt32(0);
                objpatienthistoryattribute.AttributevalueID = Convert.ToInt32(0);
                objpatienthistoryattribute.AttributeValueName = txtSmallPox.Text;
