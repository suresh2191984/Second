...
public partial class CommonControls_LeftMenuMDM : BaseControl
{
    ...
    public CommonControls_LeftMenuMDM()
        : base("CommonControls_LeftMenuMDM_ascx")
    {
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //upRate.Attributes.Add("Class", "MDM");
            ...
            if (IsPostBack == false)
            {
                ...
                /*
                parentIDIP = Convert.ToInt32(TaskHelper.SearchType.MDM);
                long retCodeIP = -1;
