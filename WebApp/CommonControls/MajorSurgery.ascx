<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MajorSurgery.ascx.cs" Inherits="CommonControls_MajorSurgery" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajc" %>
<script language="javascript" type="text/javascript">

</script>
<table cellpadding="0" width="100%">
    <tr class="defaultfontcolor" id="trMajorSurgery" runat="server" style="display: block;">
        <td colspan="2">
            <table cellpadding="0">
                <tr>
                    <td style="width: 200px">
                        <asp:Label ID="lblMajorSurgery_975" runat="server" Text="Major Surgery" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="left" colspan="1">
                        <asp:RadioButton ID="rdoYes_975" Text="Yes" runat="server" GroupName="radioExtend"
                            onclick="javascript:showContentHis(this.id);" />
                        <asp:RadioButton ID="rdoNo_975" Text="No" runat="server" GroupName="radioExtend" onclick="javascript:showContentHis(this.id);" />
                        <asp:RadioButton ID="rdoUnknown_975" Text="Unknown" runat="server" GroupName="radioExtend"
                            onclick="javascript:showContentHis(this.id);" />
                    </td>
                </tr>
            </table>
    ...
    <tr>
        <td>
            <div id="divrdoYes_975" runat="server" style="display: none">
                     ...
                     <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="button" name="btnIPTreatmentPlanAdd" id="btnMajorSurgeryAdd" onclick="onClickAddSurgery('major');"
                                    value="Add" class="btn" />
                            </td>
                        </tr>
                        <tr>
