...
public partial class CommonControls_AdvanceBillPrint : BaseControl
{
	...
	public CommonControls_AdvanceBillPrint()
    ...
    public void BillPrinting(long visitID, long FinalbillID, int pdp)
    {
        try
        {
            ...
            string HideReportDateinBill = string.Empty;
            HideReportDateinBill = GetConfigValue("HideReportDateinBill", OrgID);
            ...
            if (String.IsNullOrEmpty(MedimaBill))
            {
                ...
                lblHeader.Text = "BILL CUM RECEIPT";
            ...
            if (!String.IsNullOrEmpty(OneDiaBill))
            {
                ...
                {
                    lblHeader.Text = "Estimate";
                    Rs_BillDate.Text = "Date";
                    Rs_BillNo.Text = "No.";
                    strbill = "CREATED BY";
                }
                else
 ...
 strDNSURL = GetConfigValue("IsDNSURL", OrgID);
                ...
                if (lstFinalBillDetail[0].TATDate > Convert.ToDateTime("01/01/1900") && HideReportDateinBill != "Y")
                {
