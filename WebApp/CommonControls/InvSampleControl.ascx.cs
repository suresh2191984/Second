...
public partial class CommonControls_InvSampleControl : BaseControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //listINV.Attributes.Add("onClick", "javascript:onClick1('" + listINV.ClientID + "','" + ishdnID + "');");
    ...
    public List<OrderedInvestigations> GetINVListHOSLAB() // This Method is for Order Investigation
    {
        ...
        long id = 0;
        //string hidValue = hdnGRPINV.Value;
        string Drname = string.Empty;
        string Date = string.Empty;
        string iqty = string.Empty;
        string iAmt = string.Empty;
        ...
        foreach (ListItem chkGrpItems in listGRP.Items)
        {
            if (chkGrpItems.Selected == true)
            {
                PatientInves = new OrderedInvestigations();
                PatientInves.ID = Convert.ToInt64(chkGrpItems.Value);
                PatientInves.Name = chkGrpItems.Text;
                PatientInves.Type = "GRP";
                lstpatInves.Add(PatientInves);
        ...
        foreach (ListItem chkInvItems in listINV.Items)
        {
            if (chkInvItems.Selected == true)
            {

                PatientInves = new OrderedInvestigations();
                PatientInves.ID = Convert.ToInt64(chkInvItems.Value);
                PatientInves.Name = chkInvItems.Text;
