<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Uniscanbillprint.ascx.cs"
    Inherits="CommonControls_Uniscanbillprint" %>
...
<style type="text/css">
    ...
    #Uniscanbillprint_tblBillPrint1
    {
        width: 100% !important;
    }
    </style>
            ...
            <table width="100%" id="tblHead1" runat="server" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td colspan="3">
                        <table width="100%" border="0">
                            <tr>
                                <td align="center" valign="top"  id="tdlogoleft" runat="server">
                                    <asp:Image ID="imgBillLogo" runat="server" Visible="true" Width="100px" Height="70px" />
                                </td>
                ...
                <tr>
                    ...
                    <td>
                        <table border="0">
                            <tr>
   <%--                             <td align="left" valign="top"  id="td4" runat="server">
                                    <asp:Image ID="Image1" runat="server" Visible="true" Width="85px" Height="70px" />
                                </td>
                                <td align="center" style="width: 70%;">
                                    
                                    <label style="font-family: Verdana; width: 538px; font-size: 11px; height: auto;"
										id="Label2" runat="server">  </label>
                                </td>--%>
                                   <%-- <td colspan="1" id="tdBarcode" runat="server" visible="true" align="left" style="width: 18%;">
                                </td>--%>
                               
                                
                                <td colspan="5" id="tdBarcode" runat="server" visible="true" align="right" style="width: 18%;">
                                </td>
                              ...
                              <%--  <td>
                                    <asp:Image ID="Image3" runat="server" Width="131px" Height="65px" />
                                </td>--%>
                            </tr>
                        </table>
                    </td>
                            ...
                            <tr valign="top">
                                ...
                                <td align="right" style="width: 70%">
                                    <table cellpadding="0" border="0" style="border-left: none; border-right: none;"
                                        ...
                                        <tr id="trDue" runat="server" style="visibility: hidden">
                                            <td align="right" valign="middle" style="border-right: none; border-left: none;">
    ...
    <tr style="line-height: 15px;" id="trUniscan" runat="server">
        <td align="left" style="width: 100%;">
            <asp:Label ID="Label2" Text="Kindly collect report within 10 Days. " runat="server"></asp:Label>
            
        </td>
    </tr>
    <tr style="line-height: 15px;" id="trUniscan1" runat="server">
        <td align="left" style="width: 100%;">
            <span >Note : Images will not stored ; if necessary, collect CD within 15 days from the date of scan. </span>
        </td>
    </tr>
    <tr style="line-height: 30px;" id="trUniscan2" runat="server">
        <td align="left" style="width: 100%;">
            <span style="border: 2px solid #000;font-weight: bold;">1.5T MRI SCAN ***	MULTISLICE CT SCAN ***ULTRASOUND***X RAY***FULLY AUTOMATED LAB</span>
        </td>
    </tr>
    <tr style="line-height: 15px;" id="trUniscan3" runat="server">
        <td align="right" style="width: 100%;">
            <span style="font-weight: bold;text-align: right; width: 100%">For Uniscan Diagnostics</span>
        </td>
    </tr>
    <tr>
