<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PackageProfileControl.ascx.cs"
    Inherits="CommonControls_PackageProfileControl" %>
...
<script language="javascript" type="text/javascript">
    ...
    function onClickAddSpeciality() {
        ...
        var userMsg = SListForApplicationMessages.Get('CommonControls\\PackageProfileControl.ascx_1');
        if (userMsg != null) {
            alert(userMsg);
        }

        else { alert("Consultation Already Added!"); }
        }
    ...
    function onClickAddHealthCheckup() {
        ...
        var userMsg = SListForApplicationMessages.Get('CommonControls\\PackageProfileControl.ascx_2');
        if (userMsg != null) {
            alert(userMsg);
        } else {
...
<table class="w-100p">
    <tr id="swapTR1" runat="server">
        <td class="v-top w-50p">
            <asp:Table ID="healthPackagesTab" CssClass="dataheaderInvCtrl w-100p" runat="server"   meta:resourcekey="healthPackagesTabResource1">
            </asp:Table>
        </td>
        <td valign="v-top w-50p">
            <asp:Table ID="healthPackagesContentTab" runat="server" CssClass="w-100p"  meta:resourcekey="healthPackagesContentTabResource1">
            </asp:Table>
    ...
    <tr id="swapTR2" runat="server" style="display: none;">
        <td colspan="2">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlSelectType" onchange="javascript:setSelectedType();" runat="server"
                            meta:resourcekey="ddlSelectTypeResource1">
                        ...
                        <table class="w-100p">
                            <tr>
                                ...
                                <td class="w-50p v-top">
                                    ...
                                    <table id="tblSpecialityItems" class="dataheaderInvCtrl" runat="server" cellpadding="4"
                            ...
                            <tr>
                                <td class="w-50p v-top">
                                    <asp:ListBox ID="listProcedure" runat="server" onkeypress="javascript:setItemP(event,this);"
                                        ondblClick="javascript:onClickAddProcedure();" Width="350px" Height="100px" meta:resourcekey="listProcedureResource1">
                                    </asp:ListBox>
                                </td>
                                <td class="w-50p v-top">
                                    <input type="hidden" id="hdnProcedureItems" runat="server" />
                                    <table id="tblProcedureItems" class="dataheaderInvCtrl" runat="server" cellpadding="4"
                                        cellspacing="0" border="0" width="100%">
                                    </table>
                                </td>
                            </tr>
            ...
            <table class="w-100p">
                <tr>
                    <td class="a-center">
                        <asp:HyperLink ID="hypLnkFinish" runat="server" CssClass="pointer bold font14" Text="Finish"
                           Font-Underline="True" onclick="javascript:return showHideSwapBlock();"
