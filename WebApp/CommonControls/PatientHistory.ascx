<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PatientHistory.ascx.cs" Inherits="CommonControls_PatientHistory" %>
<%--<link href="../StyleSheets/style.css" rel="stylesheet" type="text/css" />--%>
<div style="width: 243px;" onload="loadImg()" id="divContent">
    <asp:GridView ID="gvHistory" runat="server" AllowPaging="True" OnPageIndexChanging="gvHistory_PageIndexChanging"
        PageSize="3" Height="48px" Width="239px" CaptionAlign="Top" OnRowDataBound="gvHistory_RowDataBound"
        OnSelectedIndexChanged="gvHistory_SelectedIndexChanged" HorizontalAlign="Left"
        ...
        <Columns>
            ...
            <%--<asp:BoundField DataField="HistoryName" HeaderText="HistoryName" />
            ...
            <asp:TemplateField HeaderText="History" 
                ...
                <ItemTemplate>
                    ...
                    <asp:Label ID="lblDescription" runat="server" 
                        Text='<%# (string) DataBinder.Eval(Container.DataItem,"HistoryName") +" -- "+ (string)DataBinder.Eval(Container.DataItem,"Description") %>' 
