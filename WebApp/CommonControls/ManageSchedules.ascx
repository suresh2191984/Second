<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ManageSchedules.ascx.cs" Inherits="CommonControls_LeftMenuManageRates" %>
    ...
    <div class="arrowlistmenu">
        <div class="menuheader">
            <div class="dropmenutxt" style="padding-right:0px;padding-left:21px;">
                <%=Resources.CommonControls_ClientDisplay.CommonControls_ManageSchedules_ascx_001%>
            </div>
        </div>
