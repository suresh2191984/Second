...
public partial class CommonControls_LeftMenuInventorySales : BaseControl
{
    public CommonControls_LeftMenuInventorySales()
        : base("CommonControls_LeftMenuInventorySales_ascx")
    {
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (IsPostBack == false)
            {
                ...
                /*
                parentIDInventory = Convert.ToInt32(TaskHelper.SearchType.INVENTORY);
                long retCodeIP = -1;
                long retCodeInv = -1;
    ...
    public void LoadMenuItems(List<Alacarte> menuItems)
    {
        ...
        if (menuItems != null && menuItems.Count > 0)
        {
            ...
            List<Alacarte> lstLocationPageMap = new List<Alacarte>();
            RoleMenu_BL rBL = new RoleMenu_BL(base.ContextInfo);
            parentIDInventory = Convert.ToInt32(TaskHelper.SearchType.SalesOrder);
