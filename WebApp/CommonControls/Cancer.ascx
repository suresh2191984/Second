<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Cancer.ascx.cs" Inherits="CommonControls_Cancer" %>
...
<table cellpadding="0" width="100%">
            ...
            <table cellpadding="0" width="100%">
                <tr>
                    <td style="width:200px">
                        <asp:Label ID="lblCancer_372" runat="server" Text="Cancer" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="left" colspan="1">
                        <asp:RadioButton ID="rdoYes_372" Text="Yes" runat="server" GroupName="radioExtend"
                            onclick="javascript:showContentHis(this.id);" />
                        <asp:RadioButton ID="rdoNo_372" Text="No" runat="server" GroupName="radioExtend"
                            onclick="javascript:showContentHis(this.id);" />
                        <asp:RadioButton ID="rdoUnknown_372" Text="Unknown" runat="server" GroupName="radioExtend"
                            onclick="javascript:showContentHis(this.id);" />
                    </td>
                </tr>
            </table>
    ...
    <tr class="defaultfontcolor">
        <td colspan="2">
            <div id="divrdoYes_372" runat="server" style="display: none">
