<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuickBillReferedPhysician.ascx.cs"
    Inherits="CommonControls_QuickBillReferedPhysician" %>
    ...
    <tr id="trDDLPanel" runat="server" style="display: none;">
        ...
        <td nowrap="nowrap" valign="top" align="left">
            ...
            <asp:TextBox ID="txtNew" runat="server" ToolTip="Enter Text Here" onkeyup="FilterItems(this.value,this.id)"
                onblur="AddPhysician(this.id)" Width="120px" CssClass ="Txtboxsmall" meta:resourcekey="txtNewResource1"></asp:TextBox>
