<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CODICDCode.ascx.cs" Inherits="CommonControls_CODICDCode" %>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" id="tbl1" runat="server"
    ...
    <tr>
        ...
        <td>
            <asp:TextBox runat="server" ID="txtICDName" autocomplete="off" OnChange="javascript:GetICDNameCOD(this.value);"
    ...
    <tr class="defaultfontcolor">
        ...
        <td align="left">
            ...
            <asp:HiddenField ID="hdICD" runat="server" />
            <asp:HiddenField ID="hdnFlag" runat="server" />
            <asp:TextBox runat="server" ID="txtCpmlaint" autocomplete="off" OnChange="javascript:GetTextCOD(this.value);"
    ...
    <tr>
        ...
        <td>
            <asp:TextBox runat="server" ID="txtICDCode" autocomplete="off" OnChange="javascript:GetICDCodeCOD(this.value);"
    ...
    <tr>
        <td colspan="2" align="center">
            <asp:Button ID="btnHistoryAdd" OnClientClick="javascript:return onClickAddComplaintCOD();"
                runat="server" Text="Add" CssClass="btn" onmouseover="this.className='btn btnhov'"
...
<script language="javascript" type="text/javascript">
    ...
    function GetTextCOD(pCName) {
        if (pCName != "") {
            ...
            if (Temp[1] == undefined) {
                var userMsg = SListForApplicationMessages.Get('CommonControls\\CODICDCode.ascx_1');
                if (userMsg != null) {
                    alert(userMsg);
                }
                else {
    ...
    function GetICDCodeCOD(pICDName) {
        if (pICDName != "") {
            ...
            if (document.getElementById('<%=hdICD.ClientID %>').value != "undefined" && document.getElementById('<%=txtCpmlaint.ClientID %>').value != "") {
                var userMsg = SListForApplicationMessages.Get('CommonControls\\CODICDCode.ascx_2');
                if (userMsg != null) {
                    alert(userMsg);
                }
                else {
    ...
    function GetICDNameCOD(pICDCode) {
        if (pICDCode != "") {
            document.getElementById('<%=hdICD.ClientID %>').value = "";
    ...
    function onClickAddComplaintCOD() {
        if (document.getElementById('<%=txtCpmlaint.ClientID %>').value.trim() == "") {
            var userMsg = SListForApplicationMessages.Get('CommonControls\\CODICDCode.ascx_3');
            if (userMsg != null) {
                alert(userMsg);
            } else {
        ...
        if (document.getElementById('<%=hdnDiagnosisItems.ClientID %>').value != "") {
            ...
            if (ComplaintName != '') {
                ...
                cell1.innerHTML = "<img id='imgbtn' style='cursor:pointer;' OnClick='ImgOnclickComplaintCOD(" + parseInt(rwNumber) + ");' src='../Images/Delete.jpg' />";
                cell1.width = "6%";
                cell2.innerHTML = ComplaintName;
                cell3.innerHTML = ICDCODE;
                cell4.innerHTML = ICDName;
                cell5.innerHTML = "<input onclick='btnEditCOD_OnClick(name);' name='" + parseInt(rwNumber) + "~" + ComplaintName + "~" + ComplaintID + "~" + ICDCODE + "~" + ICDName + "'  value = '<%=Resources.ClientSideDisplayTexts.Common_Edit %>' type='button' style='background-color:Transparent;color:Red;border-style:none;text-decoration:underline;cursor:pointer'/>";
        ...
        var userMsg = SListForApplicationMessages.Get('CommonControls\\CODICDCode.ascx_4');
        if (userMsg != null) {
            alert(userMsg);
        }
        else {
    ...
    function ImgOnclickComplaintCOD(ImgID) {
    ...
    function LoadComplaintItemsCOD() {
        var HidValue = document.getElementById('<%=hdnDiagnosisItems.ClientID %>').value;
        var list = HidValue.split('^');
        ...
        if (document.getElementById('<%=hdnDiagnosisItems.ClientID %>').value != "") {
            for (var count = 0; count < list.length - 1; count++) {
                ...
                cell5.innerHTML = "<input onclick='btnEditCOD_OnClick(name);' name='" + parseInt(rwNumber) + "~" + CList[1] + "~" + CList[2] + "~" + CList[3] + "~" + CList[4] + "'  value = '<%=Resources.ClientSideDisplayTexts.Common_Edit %>' type='button' style='background-color:Transparent;color:Red;border-style:none;text-decoration:underline;cursor:pointer'/>";
            }
        }
    }
    function btnEditCOD_OnClick(sEditedData) {
