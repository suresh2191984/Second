...
public partial class CommonControls_HL7MessageFileUploader : BaseControl
{
    public CommonControls_HL7MessageFileUploader()
        : base("CommonControls_HL7MessageFileUploader_ascx")
    {
    }
    ...
    long Patientid = 0;
    long visitid = 0;
    public event HL7MultipleFileUploadClick Click;
    ...
    {
        // Fire the event.
        Click(this, new HL7FileUploadCollectionEventArgs(this.Request));
    }
...
/// </summary>
public class HL7FileUploadCollectionEventArgs : EventArgs
{
    ...
    public HL7FileUploadCollectionEventArgs(HttpRequest oHttpRequest)
    {
...
public delegate void HL7MultipleFileUploadClick(object sender, HL7FileUploadCollectionEventArgs e);
