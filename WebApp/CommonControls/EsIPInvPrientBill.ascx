<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EsIPInvPrientBill.ascx.cs" Inherits="CommonControls_EsIPInvPrientBill" %>
...
<body>
    ...
    <div id="divLaser" runat="server" style="padding-left: 0px; font-size: 12px;">
        <asp:Table ID="billLaser" runat="server" Width="65%">
            ...
            <asp:TableRow>
                <asp:TableCell ID="tdSoldByLaser" Style="padding-right: 0px; padding-left: 0px;"
