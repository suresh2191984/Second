    ...
    <html>
      <body>
        ...
        <div id="divCreditCardSettlement" style="margin-top:10px;">
          <h3 align="center" style="line-height:0%">Cheque Deposit Slip</h3>
          ...
          <div id="divChequeDepositBody" style="margin:1;padding:0">
            <table  cellpadding="0.5" cellspacing="0.5" width="100%">
              <tr>
                <td align="left">
                  <table border="1" cellpadding="0.5" cellspacing="0.5" width="100%" style="table-layout:fixed">
                    <tr>
                      <th align="center" >Serial No.</th>
                      <th align="center" >Cheque/DD No</th>
                      <th align="center">Date</th>
                      <th align="center" >Bank Name</th>
                      <th align="center" >Bank Branch</th>
                    ...
                    <xsl:for-each select="Deposit/Body">
                      <tr>
                        ...
                        <td >
                          <xsl:value-of select="@ChequeorCardNumber"/>&#160;
                        </td>
                        <td >
                          <xsl:value-of select="@ChequeValidDate"/>&#160;
                        </td>
                        <td >
                          <xsl:value-of select="@BankNameorCardType"/>&#160;
                        </td>
                        <td>
                          <xsl:value-of select="@BankBranch"/>&#160;
                        </td>
                        <td  align="right">
                ...
                <tr>
                  <td colspan="2">
                    ...
                    *IN CASE DEPOSIT FORM SPILLS OVER TO ANOTHER PAGE TOTAL WOULD BE SHOWN AS TOTAL C/F
                    ...
                    <br></br>
                    <br></br>
                    ** Generate separate slip for LCC/ UCC-->
