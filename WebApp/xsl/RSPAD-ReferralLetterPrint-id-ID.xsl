                                        ...
                                        <td colspan="6" Width="100%" align="left">
                                            <table Width="100%">
                                                <tr>
                                                    ...
                                                    <td  nowrap="nowrap">
                                                        : <xsl:value-of select="ReferralLetter/RefPhysicanname" />
                                                    </td>
                                                    <td nowrap="nowrap">Dari</td>
                                                    <td  nowrap="nowrap">
                                                        : <xsl:value-of select="ReferralLetter/Physicanname" />
                                    ...
                                    <tr>
                                        <td colspan="6" align="left" Width="100%">
                                            <table Width="100%">
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        1.Di bagian kami pasien ini diobati untuk &#160;
                                                        <xsl:value-of select="ReferralLetter/Food" /> &#160;
                                                        Telah ditemukan kelainan-kelainan dan keadaan pasien saat ini&#160;
                                                        <xsl:value-of select="ReferralLetter/Abnormalities" />
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        ...
                                                        <xsl:value-of select="ReferralLetter/Treatment" />
                                                    </td>
                                                </tr>
                                                <td colspan="2" align="center">
                                                    <br/>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        ...
                                                        <xsl:value-of select="ReferralLetter/Attention" />
                                                ...
                                                <tr>
                                                    <td>
                                                        dr.  <xsl:value-of select="ReferralLetter/dr3" />
                                                    </td>
                                                    <td>
                                                        dr.  <xsl:value-of select="ReferralLetter/dr4" />
                                                    </td>
                                                </tr>
                                                <td colspan="2" align="center">
                                                    <br/>
                                                ...
                                                <tr>
                                                    <td colspan="2" align="center">
                                                        ...
                                                        dr.<xsl:value-of select="ReferralLetter/dr5" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
