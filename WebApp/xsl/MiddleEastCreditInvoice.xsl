...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt"
  ...
  <xsl:template match="/">
    ...
    <html>
      ...
      <body>
        <div id="div" class="printfont" style="margin:0 auto;height:21cm; width:15cm;">
                  ...
                  <tr>
                    <td width="73%">
                      <table width="100%">
                        ...
                        <xsl:if test="CreditBill/Insurance !=''">
                        <tr>
                        ...
                        <xsl:if test="CreditBill/SubInsurance !=''">
                        <tr>
                          ...
                          <td>
                            <xsl:value-of select="CreditBill/SubInsurance"/>
                          </td>
                        </tr>
                        </xsl:if>
                        <tr>
